...
namespace Impulse.Pages.Accounts.MakerShortTermLoan
{
    public partial class MakerShortTermLoan : ComponentBase
    {
        [Inject] private IMakerShortTermLoanService MakerLoanService { get; set; } = default!;
        ...
        private async Task<bool> SaveAsync()
        {
            ...
            try
            {
                var dto = new MakerShortTermLoanDto
                {
                ...
                NotificationService.Notify(new NotificationMessage
                {
                    ...
                    Detail = string.IsNullOrWhiteSpace(vchrNo)
                        ? "Maker Short Term Loan recorded successfully."
