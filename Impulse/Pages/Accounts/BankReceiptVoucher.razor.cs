...
{
    public partial class BankReceiptVoucher : ComponentBase, IDisposable
    {
        ...
        {
            voucherViewModel.VchrNo = await VoucherService.GetNextVchrNo(selectedDate,"BRV");
        }
        ...
        private async Task SaveVoucherMain()
        {
            ...
            try
            {
                ...
                if (!bClearInputFile)
                {
                    await UploadFileAsync(strReturnVchrNo);
                }
        ...
        private async Task UploadFileAsync(string primaryKey)
        {
            ...
            if (selectedFile != null)
            {
                ...
                string uniqueFileName = $"BRV_{primaryKey}{extension}";
