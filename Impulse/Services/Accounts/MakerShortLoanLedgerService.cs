...
{
    public class MakerShortLoanLedgerService : IMakerShortLoanLedgerService
    {
        private readonly IMakerShortLoanLedgerDataAccess _dataAccess;

        public MakerShortLoanLedgerService(IMakerShortLoanLedgerDataAccess dataAccess)
        {
        ...
        public async Task<MakerShortLoanLedgerResultModel> GetLedgerDataAsync(string accNo, string makerName, DateTime fromDate, DateTime toDate)
        {
            var result = new MakerShortLoanLedgerResultModel
            {
                AccNo = accNo,
                MakerName = makerName,
                FromDate = fromDate,
