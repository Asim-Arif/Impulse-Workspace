...
Begin VB.Form frmSteelVends 
   ...
   Begin VB.PictureBox PicEdit 
      ...
      Begin VB.ComboBox cmbCrDr 
         ...
         ForeColor       =   &H00800000&
         Height          =   315
         ItemData        =   "frmSteelVends.frx":0000
         Left            =   5250
         List            =   "frmSteelVends.frx":000A
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSteelVends.frx":0016
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSteelVends.frx":046A
            Key             =   "ORD"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSteelVends.frx":08C2
            Key             =   "PARIN"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSteelVends.frx":0D16
            Key             =   "ITMIN"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSteelVends.frx":116A
            Key             =   "CAT"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSteelVends.frx":15BE
            Key             =   "OK"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSteelVends.frx":1A16
            Key             =   "TYPE"
         EndProperty
      EndProperty
   End
   ...
   Begin MSForms.CommandButton cmdOpt 
      ...
      Size            =   "2725;688"
      Picture         =   "frmSteelVends.frx":1E6A
      Accelerator     =   79
      FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmSteelVends"
...
Private Sub FillItems()
    ...
    With rs
        ...
        .Open "Select * From SteelVendors Order By ID", con, adOpenForwardOnly, adLockReadOnly
        
        For i = 0 To .RecordCount - 1
            
            Set ITM = LV.ListItems.add(, ![ID] & "g", ![Name])
            ITM.SubItems(1) = ![Address] & ""
...
Private Sub LV_DblClick()
    ...
    Call frmNewSteelVend.EditCat(Val(LV.SelectedItem.key))
    Exit Sub
...
Private Sub CheckMenu()
   ...
   Else
     ...
     mnuEditItem.Caption = IIf(LV.SelectedItem.SmallIcon Like "ITM*", "Edit This Vendor", "Edit This Vendor")
