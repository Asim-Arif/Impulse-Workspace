...
Begin VB.Form frmMakerNewShortTermLoan_Original 
   ...
   Begin VB.Frame FraBank 
      ...
      Begin VB.CommandButton cmdBank 
         ...
         Height          =   315
         Left            =   6030
         Picture         =   "frmMakerNewShortTermLoan_Original.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   555
         Width           =   360
   ...
   End
End
Attribute VB_Name = "frmMakerNewShortTermLoan_Original"
...
Private Function Saved() As Boolean
    ...
    If chkPost.Value = vbChecked Then
        ...
        If chkPayByCheque.Value = vbUnchecked And cmbCashInHand.MatchFound = False Then
