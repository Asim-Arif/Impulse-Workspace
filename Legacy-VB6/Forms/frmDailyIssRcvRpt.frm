...
Begin VB.Form frmDailyIssRcvRpt 
   ClientHeight    =   9945
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   11880
   ...
   Begin VB.Frame FAcc 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmDailyIssRcvRpt.frx":0000
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "LV"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Receive Detail"
         TabPicture(1)   =   "frmDailyIssRcvRpt.frx":001C
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmDailyIssRcvRpt.frx":0038
         Left            =   4935
         List            =   "frmDailyIssRcvRpt.frx":004E
      ...
      Begin VB.Label Label1 
         Appearance      =   0  'Flat
         BackColor       =   &H00AFBDCB&
         Caption         =   $"frmDailyIssRcvRpt.frx":009F
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
      ...
      Begin MSForms.CommandButton cmdPrint 
         ...
         PicturePosition =   327683
         Size            =   "2355;661"
         Picture         =   "frmDailyIssRcvRpt.frx":0149
         Accelerator     =   80
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
      ...
      Begin MSForms.CommandButton cmdClose 
         ...
         PicturePosition =   327683
         Size            =   "2355;661"
         Picture         =   "frmDailyIssRcvRpt.frx":025B
         Accelerator     =   67
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmDailyIssRcvRpt"
...
Private Sub cmbProcess_matched()
    ...
    If cmbProcess.ID = "0" Then
        cmbVend.AddVals con, "VenderName", "Venders", "VendID1"
    Else
        cmbVend.AddVals con, "VenderName", "Venders", "VendID1", " Where PhaseID=" & cmbProcess.ID
    End If
End Sub
...
Private Sub NewRefreshLV()
    ...
    With cmd
        ...
        .CommandText = "SP_DailyIssRcvRpts"
    ...
    With rs
        ...
        .Open "Select * From PrintIssRcvRpts Where IssEntry=1 Order By ItemCode,DT", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        'LV.Sorted = False
        Do Until .EOF
            ...
            If ![ItemCode] & "" <> strPrevItem And strPrevItem <> "" Then
                ...
                ITM.ListSubItems.Add
                ITM.ListSubItems.Add
                ITM.ListSubItems.Add(, , "*************** Total ***************").ForeColor = vbRed
                ITM.ListSubItems.Add(, , lSubTotal).ForeColor = vbRed
        ...
        .Close
        .Open "Select * From PrintIssRcvRpts Where IssEntry=0 Order By ItemCode,DT", con, adOpenForwardOnly, adLockReadOnly
        ...
        Do Until .EOF
            ...
            Set ITM = LVRcvd.ListItems.Add(, , LVRcvd.ListItems.Count + 1)
