...
Begin VB.Form frmVendRcvItemsOld1 
   ClientHeight    =   9945
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   11880
   ...
   Begin VB.Frame FALL 
      ...
      Begin MSForms.Label Label2 
         ...
         ForeColor       =   4194304
         BackColor       =   12504280
         Caption         =   $"frmVendRcvItemsOld1.frx":0000
         Size            =   "19976;397"
   ...
   End
End
Attribute VB_Name = "frmVendRcvItemsOld1"
...
Private Sub cmbVend_matched()
    ...
    With rs
        If cmbProcess.Tag = "Lot No" Then
            ...
            End If
        Else
            Sql = "SELECT OrderNo,ItemCode,ItemDescription,SUM(IssQty-RcvdQty)-dbo.F_AuthQtyForIss(ItemCode,null,null,null," & cmbVend.ID & ") AS Quantity FROM VMakerIssItems1 WHERE IssQty-RcvdQty>0 AND VendID=" & cmbVend.ID & " AND RcvProcessID=" & cmbProcess.ID & " AND ISNULL(ReqAuth,0)=0 GROUP BY OrderNo,ItemCode,ItemDescription"
        End If
...
Private Sub txtQty_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        Else
            ...
            End If
        End If
        dRate = Val(con.Execute("Select Rate From VendAssItems Where VendID=" & cmbVend.ID & " AND ItemID='" & LV.SelectedItem.SubItems(2) & "'").Fields(0).value & "")
        If dRate = 0 Then
