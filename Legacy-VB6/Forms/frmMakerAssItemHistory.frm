...
Begin VB.Form frmMakerAssItemHistory 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Maker Assigned Item"
   ClientHeight    =   6795
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   8100
   ...
   Begin MSForms.CommandButton cmdOk 
      ...
      Size            =   "4048;661"
      Picture         =   "frmMakerAssItemHistory.frx":0000
      Accelerator     =   83
      FontName        =   "Tahoma"
   ...
   Begin MSForms.CommandButton cmdCancel 
      ...
      PicturePosition =   327683
      Size            =   "2990;661"
      Picture         =   "frmMakerAssItemHistory.frx":044E
      Accelerator     =   67
      FontName        =   "Tahoma"
      FontEffects     =   1073741825
      FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmMakerAssItemHistory"
...
Public Sub ViewHistory(p_lEntryID As Long)
    ...
    With rs
        .Open "SELECT VenderName,Remarks,ItemID,ItemName,Description,Rate FROM VMakerAssItems WHERE EntryID=" & lEntryID, con, adOpenForwardOnly, adLockReadOnly
        TBox(2) = !VenderName & ""
        TBox(0) = !Description
        TBox(1) = !ITemID & ""
        TBox(3) = !Remarks & ""
        ...
        .Open "SELECT * FROM VendAssItems_Revisions WHERE VAI_RefID=" & lEntryID & " ORDER BY EntryID", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
...
Private Sub cmdOK_Click()
    con.Execute "UPDATE VendAssItems SET Remarks='" & TBox(3) & "' WHERE EntryID=" & lEntryID
End Sub
...
Private Sub txtRemarksEdit_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        con.Execute "UPDATE VendAssItems_Revisions SET Remarks='" & txtRemarksEdit & "' WHERE EntryID=" & Val(LV.SelectedItem.key)
