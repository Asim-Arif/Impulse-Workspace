...
Begin VB.Form frmSROList 
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSROList.frx":0000
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSROList.frx":01BC
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   2
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSROList.frx":0378
            Key             =   "Active"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSROList.frx":07CC
            Key             =   "Inactive"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu mnupop 
      ...
      Begin VB.Menu mnuPrintDetail 
         Caption         =   "Print SRO List"
         Visible         =   0   'False
      End
   End
End
Attribute VB_Name = "frmSROList"
...
Private Sub mnuInActive_Click()
    ...
    If mnuInActive.Tag = "Active" Then
        ...
        con.Execute "Update ShippingAgents Set Active=0 Where EntryID=" & Val(LV.SelectedItem.key)
        
    Else
        con.Execute "Update ShippingAgents Set Active=1 Where EntryID=" & Val(LV.SelectedItem.key)
    End If
...
Private Sub mnuedit_Click()
    ...
    Load frmNewSRO
    Call frmNewSRO.EditAgent(Val((LV.SelectedItem.key)))
...
Private Sub RefreshList(Optional Cond As String)
    ...
    With rs
        ...
        .Open "Select * From SROs", con, adOpenForwardOnly, adLockReadOnly
        
        LV.ListItems.Clear
        
        For i = 0 To .RecordCount - 1
            
            Set ITM = LV.ListItems.add(, ![EntryID] & "'", ![SRONo], , TheTag)
            ITM.Tag = TheTag
            
            ITM.SubItems(1) = ![CompleteNo] & ""
            ITM.SubItems(2) = Format(![SRODT] & "", "dd-MMM-yyyy")
            ITM.SubItems(3) = ![CRebate] & ""
            ITM.SubItems(4) = ![STax] & ""
            ITM.SubItems(5) = ![EDuty] & ""
            ITM.SubItems(6) = ![Description] & ""
            .MoveNEXT
        Next
        .Close
    End With
