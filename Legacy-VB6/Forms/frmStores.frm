   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmStores.frx":0644
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmStores.frx":0800
            Key             =   "Up"
         EndProperty
      EndProperty
   End
...
Private Sub cmdAdd_Click()
    ...
    con.Execute "INSERT INTO RMStorewiseOpeningStocks(StoreName,RMID,OpeningBalance)" & _
        "SELECT StoreName,RMID,0 FROM Stores CROSS JOIN RM WHERE EntryID=" & lEntryID
