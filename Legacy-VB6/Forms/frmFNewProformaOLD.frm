...
Begin VB.Form frmFNewProformaOLD 
   ClientHeight    =   9735
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   12195
   ...
   Begin VB.Frame FAll 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmFNewProformaOLD.frx":0000
         ...
         TabPicture(1)   =   "frmFNewProformaOLD.frx":001C
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "cmbInsurAgent"
         Tab(1).Control(0).Enabled=   0   'False
         Tab(1).Control(1)=   "cmbShipAgent"
         ...
         Tab(1).Control(5)=   "txtDeclaration"
         ...
         Begin VB.CommandButton cmdDelete 
            ...
            Height          =   285
            Left            =   11490
            Picture         =   "frmFNewProformaOLD.frx":0038
            Style           =   1  'Graphical
            TabIndex        =   38
         ...
         Begin MSForms.CommandButton cmdAddItem 
            ...
            Size            =   "2672;609"
            Picture         =   "frmFNewProformaOLD.frx":056A
            FontName        =   "Tahoma"
      ...
      Begin VB.Frame Frame6 
         ...
         Begin MSForms.CommandButton cmdCancel 
            ...
            PicturePosition =   327683
            Size            =   "2937;635"
            Picture         =   "frmFNewProformaOLD.frx":088C
            Accelerator     =   67
            FontName        =   "Tahoma"
            FontEffects     =   1073741825
            FontHeight      =   165
         ...
         Begin MSForms.CommandButton cmdSClose 
            ...
            PicturePosition =   327683
            Size            =   "2937;635"
            Picture         =   "frmFNewProformaOLD.frx":099E
            Accelerator     =   83
            FontName        =   "Tahoma"
            FontEffects     =   1073741825
            FontHeight      =   165
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00C5D1DC&
         BorderStyle     =   1  'Fixed Single
         Caption         =   $"frmFNewProformaOLD.frx":0DEC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00C5D1DC&
         BorderStyle     =   1  'Fixed Single
         Caption         =   $"frmFNewProformaOLD.frx":0E9A
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmFNewProformaOLD"
...
Public Sub EditProforma(TempProforma As String)
    ...
    With rs
        ...
        Do Until .EOF
            ...
            ITM.ListSubItems.Add , , Format(![Price] & "", "#0.00")
...
Private Sub cmdAddItem_Click()
    ...
    With rs
        ...
        Do Until .EOF
            ...
            Set ITM = LV.ListItems.Add(, ![OrderItemID] & "'", iSno)
...
Private Function Saved() As Boolean
    ...
    If strProforma <> "" Then
        ...
        " Qty From FProformaOrders Where PInvoice='" & _
        strProforma & "' And OrderEntryID=ID),0) " ')"
    ...
    con.Execute "Insert into FPInvoice (PInvoice,DT,CustCode,Country,SMethod," & _
     ...
     "Carton,PartialShipment,TransShipment,DeliveryDT,ShippingAgent,InsuranceAgent,BatchNo,Declarations) Values('" & txtPInvoice & "','" & _
     OrderDT & "','" & cmbCust.Text & "','" & _
     cmbCountry.Text & "','" & cmbSMethod.Text & "'," & iLoadID & _
     "," & iDisID & ",'" & _
     txtShipment & "','" & cmbTradeTerms.Text & "','" & cmbPayment & "','" & txtLC & "'," & _
     iBankID & ",'" & txtPackaging & "','" & txtCarton & "','" & _
     cmbPartial & "','" & cmbTrans & "','" & _
     DeliveryDT & "'," & Val(cmbShipAgent.ID) & "," & Val(cmbInsurAgent.ID) & ",'" & txtBatchNo & "','" & txtDeclaration & "')"
    ...
    For i = 1 To LV.ListItems.Count Step 2
        ...
        con.Execute "Insert Into FProformaOrders(PInvoice,OrderEntryID,Qty) " & _
         "Values('" & txtPInvoice & "'," & Val(LV.ListItems(i).Key) & "," & _
