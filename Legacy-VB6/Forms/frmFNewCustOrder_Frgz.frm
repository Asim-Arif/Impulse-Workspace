...
Begin VB.Form frmFNewCustOrder_Frgz 
   ClientHeight    =   9285
   ClientLeft      =   -120
   ClientTop       =   -120
   ClientWidth     =   14100
   ...
   Begin VB.Frame FAll 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmFNewCustOrder_Frgz.frx":0000
         ...
         TabPicture(1)   =   "frmFNewCustOrder_Frgz.frx":001C
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "txtPackagingWeight"
         ...
         TabPicture(2)   =   "frmFNewCustOrder_Frgz.frx":0038
         ...
         Begin VB.TextBox txtPackagingWeight 
            Appearance      =   0  'Flat
            BackColor       =   &H00FFFFFF&
            Height          =   2205
            Left            =   -68115
         ...
         Begin VB.CommandButton cmdAddItem 
            ...
            Height          =   555
            Left            =   3660
            Picture         =   "frmFNewCustOrder_Frgz.frx":0054
            Style           =   1  'Graphical
            TabIndex        =   51
         ...
         Begin VB.CommandButton cmdDelete 
            ...
            Height          =   285
            Left            =   13335
            Picture         =   "frmFNewCustOrder_Frgz.frx":0586
            Style           =   1  'Graphical
            TabIndex        =   40
         ...
         Begin VB.Frame FNew 
            ...
            Begin VB.Label Label1 
               ...
               Caption         =   $"frmFNewCustOrder_Frgz.frx":0AB8
               BeginProperty Font 
                  Name            =   "Tahoma"
                  Size            =   8.25
                  Charset         =   0
            ...
            Begin VB.Label Label1 
               ...
               BackColor       =   &H00C5D1DC&
               BorderStyle     =   1  'Fixed Single
               Caption         =   $"frmFNewCustOrder_Frgz.frx":0B91
               BeginProperty Font 
                  Name            =   "Tahoma"
                  Size            =   8.25
                  Charset         =   0
      ...
      Begin VB.Label lblQuality 
         ...
         Height          =   210
         Left            =   4560
         MouseIcon       =   "frmFNewCustOrder_Frgz.frx":0C85
      ...
      Begin VB.Label lblPymtTerms 
         ...
         Height          =   165
         Left            =   1815
         MouseIcon       =   "frmFNewCustOrder_Frgz.frx":0DD7
         MousePointer    =   99  'Custom
         TabIndex        =   89
         Top             =   1770
         Width           =   1335
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00C5D1DC&
         BorderStyle     =   1  'Fixed Single
         Caption         =   $"frmFNewCustOrder_Frgz.frx":0F29
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00C5D1DC&
         BorderStyle     =   1  'Fixed Single
         Caption         =   $"frmFNewCustOrder_Frgz.frx":1009
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00C5D1DC&
         BorderStyle     =   1  'Fixed Single
         Caption         =   $"frmFNewCustOrder_Frgz.frx":10E5
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmFNewCustOrder_Frgz"
...
Public Sub EditOrder(TempOrdNo As String, Optional p_bCopyOrder As Boolean)
    ...
    If bCopyOrder = False Then
        'Check IF PO or Lots are associated with this po then don't allow order no. edit
        Dim lCount_Rcv As Long, lCount_Iss As Long
        lCount_Rcv = GetSingleLongValue("COUNT(*)", "VendRcvdDetail", " WHERE OrderNo='" & strOrderNo & "'")
        lCount_Iss = GetSingleLongValue("COUNT(*)", "VendIssdDetail", " WHERE OrderNo='" & strOrderNo & "'")
        
        If lCount_Rcv > 0 Or lCount_Iss > 0 Then
    ...
    With rs
        ...
        txtPackagingWeight = !Packaging_Weight & ""
...
'        End If
        ...
        Do Until .EOF
            ...
            ITM.ListSubItems.add , , !IW_OrderNo & ""
            ITM.ListSubItems.add , , !IW_BatchNo & ""
    ...
    cmbItemSearchOrder.AddVals con_ServerSide, "CompItemCode + ' ' + ItemName +  ' ' + ItemCode + ' {' + CAST(ID AS VARCHAR(50)) + '}'", "VrptOrders", "ID", "WHERE OrderNo='" & strOrderNo & "' " & strOrderBy
...
Private Sub cmbCountry_Click()
    ...
    If cmbCountry.Tag = cmbCust.ID & "|" & cmbCountry.Text Then
        Exit Sub
    End If
    
    cmbCountry.Tag = cmbCust.ID & "|" & cmbCountry.Text
...
Private Sub cmbItemFinishingType_Click()
    ...
    If cmbItemFinishingType.ListIndex > 0 Then
        ...
        If strFieldName <> "" Then
            Dim dRate As Double
            dRate = GetSingleDoubleValue(strFieldName, "FCustomerCatalog", " WHERE CustCode='" & cmbCust.ID & "' AND Country='" & cmbCountry.Text & "' AND CompItemID='" & cmbItems.Text & "'")
...
Private Sub cmbItems_Change()
    ...
    Dim rs As New ADODB.Recordset
    With rs
        .Open "SELECT FinQuality,StampInstructions,SpecialInstructions FROM VFCustomerCatalog WHERE CompItemID='" & cmbItems.Text & "' AND CustCode='" & cmbCust.ID & "' AND Country='" & cmbCountry.Text & "'", con, adOpenForwardOnly, adLockReadOnly
        If .EOF = False Then
...
'        End If
        ...
        'dPrice = GetSingleDoubleValue("Price", "FOrderItems", " WHERE ID IN(SELECT MAX(ID) FROM FOrderItems INNER JOIN FCustomerOrders ON FCustomerOrders.OrderNo=FOrderItems.OrderNo WHERE CompItemCode='" & cmbItems.Text & "' AND CustCode='" & cmbCust.ID & "')")
...
Private Sub cmdAddItem_Click()
    ...
    ITM.ListSubItems.add , , txtIWOrderNo
    ITM.ListSubItems.add , , txtIWBatchNo
...
'        .CalendarTitleBackColor = &H98&      'RGB(200, 150, 150)
...
Private Function GetInternalRefNo() As String
    ...
    If strCompany = "IAA" Or strCompany = "Kami" Then
        If cmbCompany.ID = 1 Then
            lRefNo = GetSingleLongValue("MAX(CAST(SUBSTRING(InternalRefNo,5,LEN(InternalRefNo)-3) AS INT))", "FCustomerOrders", " WHERE LEFT(InternalRefNo,3)='INT'")
        Else
            lRefNo = GetSingleLongValue("MAX(CAST(SUBSTRING(InternalRefNo,5,LEN(InternalRefNo)-4) AS INT))", "FCustomerOrders", " WHERE LEFT(InternalRefNo,4)='MED/'")
        End If
        lRefNo = lRefNo + 1
    Else
        lRefNo = GetSingleLongValue("MAX(CAST(InternalRefNo AS INT))", "FCustomerOrders")
        If lRefNo = 0 Then
    ...
    strInternalRefNo = "INT" & Format(lRefNo, "0000")
...
Private Sub lblQuality_Click()

    Dim f As New frmMiscS_New
    f.ShowForm "FCO_Qualities", "Quality", "Quality", "EntryID", "Qualities"
    
    cmbQuality.Clear
    Call AddToCombo(cmbQuality, "Quality", "FCO_Qualities", " ORDER BY Quality")
...
'        End If
    ...
    ElseIf iColNo = 12 Or iColNo = 16 Or iColNo = 17 Then
        With txtEditQty
            .Move LV.Left + LV.ColumnHeaders(iColNo).Left, LV.SelectedItem.Top + LV.Top, LV.ColumnHeaders(iColNo).Width
            .Text = LV.SelectedItem.SubItems(iColNo - 1)
            .SelStart = 0
...
''''''''Show Picture
    ...
    If chkShowPicture.Value = vbChecked Then
        ...
        With rs
            .Open "SELECT ItemPic FROM Items WHERE ItemID='" & Item.SubItems(2) & "'", con, adOpenForwardOnly, adLockReadOnly
            If Not IsNull(![ItemPic]) Then
                Set ImgProduct.DataSource = rs
                ImgProduct.DataField = "ItemPic"
            Else
...
Private Sub LV_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    ElseIf strRet = "View PDF" Then
        If LV.SelectedItem.ListSubItems(12).Tag = "Added" Then
            Call ShowTechDrawing("FOrderItems_PDF", "PDF", " WHERE FOI_RefID=" & Val(LV.SelectedItem.ListSubItems(7).Tag), "Sample Attached", Me.CD1)
        Else
    ...
    If Not cmbCust.Text = "HICO" Then
        If strOrderNo <> "" Then
            con.Execute "UPDATE FCustomerOrders SET OrderNo='" & txtOrderNo & "',DT='" & _
             ...
             "',OrderRcvdVia='" & txtOrderRcvdvia & "',OrderType='" & cmbOrderType.Text & "',OrderRevisionNo=" & Val(txtOrderRevision) & ",OrderRevisionDT='" & dtRevision & "',ShippingMode='" & cmbSMethod.Text & "',Packaging_Weight='" & txtPackagingWeight & "' WHERE OrderNo='" & strOrderNo & "'"
        ...
        Else
            ...
            con.Execute "INSERT INTO FCustomerOrders (CustCode,Country," & _
             ...
             "TransShipment,Packaging,DeliveryDT,CompanyRefID,StampDT,Quality,InternalRefNo,OrderRcvdVia,OrderType,OrderRevisionNo,OrderRevisionDT,ShippingMode,Packaging_Weight) VALUES('" & _
             cmbCust.ID & "','" & cmbCountry & "','" & txtOrderNo & "','" & OrderDT & "','" & cmbTradeTerms & "','" & cmbPartial & _
             "','" & cmbPayment & "','" & cmbTrans & "','" & txtPackaging & "','" & myOrderDeliveryDT & "'," & cmbCompany.ID & ",'" & txtStamps & "','" & _
             cmbQuality & "','" & txtInternalRefNo & "','" & txtOrderRcvdvia & "','" & cmbOrderType.Text & "'," & Val(txtOrderRevision) & ",'" & dtRevision & "','" & cmbSMethod.Text & "','" & txtPackagingWeight & "')"
             
            If bAutoProforma Then   'Create Auto Proforma...
                con.Execute "INSERT INTO FPInvoice(CustCode,Country,PInvoice,DT,SMethod,TradeTerms,PaymentTerms,CompanyRefID,DeliveryDT,BatchNo" & _
                 ",Discount_Description,Insurance_Description,Insurance_Description_II,CIF_Description,Total_Description) VALUES('" & cmbCust.ID & "','" & _
                 cmbCountry & "','" & txtOrderNo & "','" & OrderDT & "','" & cmbSMethod.Text & "','" & cmbTradeTerms & "','" & cmbPayment & _
                 "'," & cmbCompany.ID & ",'" & myOrderDeliveryDT & "','" & txtOrderRcvdvia & "','Discount','Insurance & Freight Charges','Insurance Charges','CIF Value','FOB Value')"
            End If
        End If
    End If
...
'SaveNewItem:
            ...
            If Val(.ListSubItems(7).Tag) = 0 Then
                ...
                con.Execute "INSERT INTO FOrderItems(OrderNo,ItemCode,CompItemCode," & _
                 "Price,Qty,InvQty,CustomPrice,SortNo,DeliveryDT,Quality,Stamps,DeliveryStatus,Remarks,Weight,Item_Finishing_Type,IW_OrderNo,IW_BatchNo) VALUES('" & txtOrderNo & "','" & _
                 strItemCode & "','" & .Tag & "'," & Val(.SubItems(5)) & "," & Val(.SubItems(6)) & "," & _
                 Val(.SubItems(6)) & "," & Val(.ListSubItems(5).Tag) & "," & Val(.SubItems(8)) & ",'" & _
                 strDelivery & "','" & .SubItems(10) & "','" & .SubItems(11) & "'," & Val(.ListSubItems(9).Tag) & ",'" & .SubItems(12) & "'," & Val(.SubItems(13)) & "," & Val(.ListSubItems(14).Tag) & ",'" & .SubItems(15) & "','" & .SubItems(16) & "')"
                ...
                If .ListSubItems(12).Tag <> "" Then
                    lFOI_RefID = GetSingleLongValue("MAX(ID)", "FOrderItems")
                    If .ListSubItems(12).Tag = "Remove" Then
                        con.Execute "DELETE FROM FOrderItems_PDF WHERE FOI_RefID=" & lFOI_RefID
            ...
            Else
                ...
                con.Execute "UPDATE FOrderItems SET Qty=" & Val(.SubItems(6)) & ",InvQty=" & Val(.SubItems(6)) - Val(.ListSubItems(6).Tag) & _
                 ...
                 Val(.ListSubItems(14).Tag) & ",IW_OrderNo='" & .SubItems(15) & "',IW_BatchNo='" & .SubItems(16) & "' WHERE ID=" & Val(.ListSubItems(7).Tag)
                
                If Val(.SubItems(6)) <> Val(.ListSubItems(10).Tag) Or Val(.SubItems(5)) <> Val(.ListSubItems(11).Tag) Then
                    con.Execute "UPDATE FOrderItems SET Item_Edited=1 WHERE ID=" & Val(.ListSubItems(7).Tag)
                End If
    ...
    With rs
        ...
        If 0 = 1 Then
            'If strCompany = "All Seas" Then
                ...
                .Open "SELECT ItemID,ItemID AS CompItemID,ItemName AS Description,0 AS PackingMode,FOB,ExWorks" & _
                 ",CIFAir,CIFSea,CnFAir,CnFSea,CnIAir,CnISea,1 AS CustomFOB,1 AS CustomExWorks,1 AS CustomCIFAir,1 AS CustomCIFSea,1 AS CustomCnFAir,1 AS CustomCnFSea,1 AS CustomCnIAir,1 AS CustomCnISea FROM Items", con_ServerSide, adOpenForwardOnly, adLockReadOnly
            'Else
                '.Open "SELECT * FROM VFCustomerCatalog WHERE CustCode+Country='" & cmbCust.Text & cmbCountry.Text & "' AND InActive=0", con_ServerSide, adOpenForwardOnly, adLockReadOnly
            'End If
        Else
            If strCompany = "All Seas" Then
...
Private Sub AttachPDF(p_lEntryID As Long, strPDFPath As String)
    ...
    On Error Resume Next
    con.Execute "DELETE FROM FOrderItems_PDF WHERE FOI_RefID=" & p_lEntryID
    con.Execute "INSERT INTO FOrderItems_PDF(FOI_RefID) VALUES(" & p_lEntryID & ")"
    
    If strPDFPath <> "" Then
        Dim Rec As New ADODB.Recordset
        Dim rsPic As New ADODB.Stream
        Rec.Open "SELECT EntryID,PDF FROM FOrderItems_PDF WHERE FOI_RefID=" & p_lEntryID, con, adOpenStatic, adLockOptimistic
