...
Begin VB.Form frmNewCustomInvoice_Adv_Original 
   AutoRedraw      =   -1  'True
   ClientHeight    =   9570
   ClientLeft      =   60
   ClientTop       =   60
   ...
   Begin VB.Frame FAll 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmNewCustomInvoice_Adv_Original.frx":0000
         ...
         Tab(0).Control(9)=   "txtDTRENo"
         Tab(0).ControlCount=   10
         TabCaption(1)   =   "Other Info."
         TabPicture(1)   =   "frmNewCustomInvoice_Adv_Original.frx":001C
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "chkCIFTerms"
         Tab(1).Control(1)=   "chkNoSRO"
         Tab(1).Control(2)=   "txtGatePassNo"
         Tab(1).Control(3)=   "txtLC"
         Tab(1).Control(4)=   "Frame2"
         Tab(1).Control(5)=   "Frame4"
         Tab(1).Control(6)=   "Frame3"
         Tab(1).Control(7)=   "Frame5"
         Tab(1).Control(8)=   "DTLC"
         Tab(1).Control(9)=   "DTGatePass"
         Tab(1).Control(10)=   "txtDTREDesc"
         Tab(1).Control(11)=   "Label1(32)"
         Tab(1).Control(12)=   "Label1(31)"
         Tab(1).Control(13)=   "Label1(22)"
         Tab(1).Control(14)=   "cmbBankAccNo"
         Tab(1).Control(15)=   "Label1(30)"
         Tab(1).Control(16)=   "txtInvoiceof"
         Tab(1).Control(17)=   "Label1(24)"
         Tab(1).Control(18)=   "cmbBank"
         Tab(1).Control(19)=   "Label1(23)"
         Tab(1).Control(20)=   "Label1(21)"
         Tab(1).Control(21)=   "cmbSMethod"
         Tab(1).ControlCount=   22
         TabCaption(2)   =   "Proforma Items"
         TabPicture(2)   =   "frmNewCustomInvoice_Adv_Original.frx":0038
         Tab(2).ControlEnabled=   -1  'True
         Tab(2).Control(0)=   "cmdAddItem"
         Tab(2).Control(0).Enabled=   0   'False
         Tab(2).Control(1)=   "Label1(8)"
         Tab(2).Control(1).Enabled=   0   'False
         Tab(2).Control(2)=   "lblGoTo(0)"
         Tab(2).Control(2).Enabled=   0   'False
         Tab(2).Control(3)=   "Label1(35)"
         Tab(2).Control(3).Enabled=   0   'False
         Tab(2).Control(4)=   "LV2"
         Tab(2).Control(4).Enabled=   0   'False
         Tab(2).Control(5)=   "txtQty1"
         ...
         Tab(2).Control(12)=   "txtQtyToAdd"
         Tab(2).Control(12).Enabled=   0   'False
         Tab(2).Control(13)=   "cmbItems"
         Tab(2).Control(13).Enabled=   0   'False
         Tab(2).Control(14)=   "cmbProformas"
         Tab(2).Control(14).Enabled=   0   'False
         Tab(2).Control(15)=   "txtLotNo"
         Tab(2).Control(15).Enabled=   0   'False
         Tab(2).Control(16)=   "txtEditPLQty"
         Tab(2).Control(16).Enabled=   0   'False
         Tab(2).ControlCount=   17
         TabCaption(3)   =   "Commercial Invoice"
         TabPicture(3)   =   "frmNewCustomInvoice_Adv_Original.frx":0054
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "Frame1"
         Tab(3).Control(1)=   "Frame7"
         Tab(3).ControlCount=   2
         TabCaption(4)   =   "Other Charges"
         TabPicture(4)   =   "frmNewCustomInvoice_Adv_Original.frx":0070
         ...
         Begin VB.Frame Frame1 
            ...
            Begin VB.Label Label3 
               ...
               Height          =   255
               Left            =   60
               MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":008C
               TabIndex        =   84
               Top             =   1650
               Width           =   5730
            End
            Begin VB.Label Label2 
               ...
               Height          =   255
               Left            =   60
               MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":01DE
               TabIndex        =   83
               Top             =   720
               Width           =   5730
            End
         ...
         Begin VB.CommandButton Command1 
            ...
            Height          =   285
            Left            =   12105
            Picture         =   "frmNewCustomInvoice_Adv_Original.frx":0330
            Style           =   1  'Graphical
            TabIndex        =   24
         ...
         Begin VB.CommandButton cmdDelete 
            ...
            Height          =   285
            Left            =   -63345
            Picture         =   "frmNewCustomInvoice_Adv_Original.frx":0862
            Style           =   1  'Graphical
            TabIndex        =   16
            ToolTipText     =   "Remove This Entry From Voucher"
            Top             =   1305
         ...
         Begin VB.Frame Frame7 
            ...
            Begin VB.Label lblSwapAddresses 
               ...
               Height          =   195
               Left            =   75
               MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":0D94
            ...
            Begin VB.Label Label4 
               ...
               Height          =   255
               Left            =   7380
               MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":0EE6
               TabIndex        =   86
               Top             =   150
               Width           =   4215
            End
         ...
         Begin VB.Label Label1 
            ...
            BackStyle       =   0  'Transparent
            BorderStyle     =   1  'Fixed Single
            Caption         =   $"frmNewCustomInvoice_Adv_Original.frx":1038
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VB.Label Label1 
            ...
            BackStyle       =   0  'Transparent
            BorderStyle     =   1  'Fixed Single
            Caption         =   $"frmNewCustomInvoice_Adv_Original.frx":1103
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.Label Label1 
         ...
         BackStyle       =   0  'Transparent
         BorderStyle     =   1  'Fixed Single
         Caption         =   $"frmNewCustomInvoice_Adv_Original.frx":11AD
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.Label lblGlovesComDecs 
         ...
         Height          =   255
         Left            =   315
         MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":1269
         MousePointer    =   99  'Custom
         TabIndex        =   117
         Top             =   5670
         Width           =   5730
      ...
      Begin VB.Label lblGarmentsComDecs 
         ...
         Height          =   255
         Left            =   315
         MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":13BB
         MousePointer    =   99  'Custom
         TabIndex        =   116
         Top             =   4860
         Width           =   5730
      ...
      Begin VB.Label lblBallComDecs 
         ...
         Height          =   255
         Left            =   315
         MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":150D
         MousePointer    =   99  'Custom
         TabIndex        =   115
         Top             =   4050
         Width           =   5730
      ...
      Begin VB.Label lblGlovesDecs 
         ...
         Height          =   255
         Left            =   45
         MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":165F
         MousePointer    =   99  'Custom
         TabIndex        =   111
         Top             =   1815
         Width           =   5805
      ...
      Begin VB.Label lblGarmentsDecs 
         ...
         Height          =   255
         Left            =   45
         MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":17B1
         MousePointer    =   99  'Custom
         TabIndex        =   110
         Top             =   1050
         Width           =   5805
      ...
      Begin VB.Label lblBallDecs 
         ...
         Height          =   255
         Left            =   45
         MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":1903
         MousePointer    =   99  'Custom
         TabIndex        =   109
         Top             =   285
         Width           =   5805
      ...
      Begin VB.Label Label5 
         ...
         Height          =   255
         Left            =   120
         MouseIcon       =   "frmNewCustomInvoice_Adv_Original.frx":1A55
         MousePointer    =   99  'Custom
         TabIndex        =   105
         Top             =   2595
         Width           =   1875
   ...
   End
End
Attribute VB_Name = "frmNewCustomInvoice_Adv_Original"
...
Private Sub cmbitems_matched()
    ...
    cmbProformas.AddVals con_ServerSide, "PInvoice+' {'+OrderNo+'}-{'+CAST(InternalRefNo AS VARCHAR(255))+'} {'+CAST(InvQty AS VARCHAR(50))+'}'", "VFProformas", "EntryID", " WHERE ItemID='" & cmbItems.ID & "' AND CustCode='" & cmbCust.ID & "' AND Country='" & cmbCountry.Text & "'"
...
Private Sub txtLotNo_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        Dim rs As New ADODB.Recordset
        rs.Open "SELECT EntryID,OrderNo,PInvoice,ItemID,ItemName,Qty,InvQty,Price,CustomPrice FROM VFProformas WHERE EntryID=" & cmbProformas.ID, con, adOpenForwardOnly, adLockReadOnly
            
        Dim ITM As ListItem
        Set ITM = LV2.ListItems.add(, , Val(txtCartonNo))
        
        ITM.ListSubItems.add(, , rs!PInvoice & "").Tag = Val(rs!EntryID & "")
        ITM.ListSubItems.add(, , rs!OrderNo & "").Tag = Val(rs!Price & "")
        ITM.ListSubItems.add(, , rs!ITemID & " - " & rs!ItemName).Tag = Val(rs!CustomPrice & "")
        ITM.ListSubItems.add , , Val(txtQtyToAdd)
