...
Begin VB.Form frmSupplierEvaluationList 
   ClientHeight    =   8385
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11970
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSupplierEvaluationList.frx":0000
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSupplierEvaluationList.frx":01BC
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   Begin VB.Frame FAcc 
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmSupplierEvaluationList.frx":0378
         Left            =   4440
         List            =   "frmSupplierEvaluationList.frx":0391
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   $"frmSupplierEvaluationList.frx":03F0
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmSupplierEvaluationList"
...
Private Sub cmdRefresh_Click()
    ...
    strCondition = " WHERE EntryDT BETWEEN '" & DtFrom.Value & "' AND '" & DtTo.Value & "'"
    ...
    With rs
        .Open "SELECT * FROM VSupplierEvaluation " & strCondition, con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
...
Private Sub mnuEdit_Click()
    ...
    Dim f As New frmSupplierEvaluationAE
    Load f
    Call f.EditEntry(LV.SelectedItem.ListSubItems(1).Tag)
End Sub
