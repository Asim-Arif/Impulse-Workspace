...
Begin VB.Form frmVendRcvItems_PO 
   ClientHeight    =   9945
   ClientLeft      =   60
   ClientTop       =   360
   ClientWidth     =   11880
   ...
   Begin VB.Frame FALL 
      ...
      Begin MSForms.Label Label2 
         ...
         ForeColor       =   4194304
         BackColor       =   12504280
         Caption         =   $"frmVendRcvItems_PO.frx":0000
         Size            =   "19976;397"
   ...
   End
End
Attribute VB_Name = "frmVendRcvItems_PO"
...
Private Sub cmbVend_matched()
    ...
    With rs
        ...
        Do Until .EOF
            ...
            ITM.ListSubItems.add(, , Val(!Quantity & "")).ForeColor = FColor
...
'    End If
    ...
    con.Execute "INSERT INTO VendReceived(VendID,DT,RecieptID,UserID,ProcessID,Issuance_RefID,OverTime,UserName,MachineName,TemperValue) Values(" & cmbVend.ID & _
     ",'" & DTPicker1 & " " & ServerTime & "',''," & UserID & "," & cmbProcess.ID & "," & Val(txtID.Tag) & "," & chkOverTime.Value & ",'" & CurrentUserName & "','" & strComputerName & "','" & txtTemperValue & "')"
