...
Begin VB.Form frmAuthManRcv 
   ...
   Begin VB.Frame FAcc 
      ...
      Begin MSForms.CommandButton cmdClose 
         ...
         PicturePosition =   327683
         Size            =   "3360;661"
         Picture         =   "frmAuthManRcv.frx":0000
         Accelerator     =   67
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmAuthManRcv"
...
Private Sub DeleteRcvd()
    ...
    For i = 1 To LVRcv.ListItems.Count
        ...
        If LVRcv.ListItems(i).Checked Then
            ...
            con.Execute "Update  VendPurchOrdDetail Set VendPurchOrdDetail.QtyRcvd=VendPurchOrdDetail.QtyRcvd-" & Val(LVRcv.ListItems(i).SubItems(6)) & _
             ...
             "VendRcvdDetail.EntryID Where VendRcvdDetail.EntryID=" & Val(LVRcv.ListItems(i).Key)
            'Update Rcving Detail Entry....
            con.Execute "Delete From VendPORcvdDetail Where RcvdRefID=" & Val(LVRcv.ListItems(i).Key)
'            con.Execute "Update VendPORcvdDetail Set VendPORcvdDetail.Qty=VendPORcvdDetail.Qty-" & Val(LVRcv.ListItems(i).SubItems(7)) & _
'            " From VendPORcvdDetail Inner JOIN VendRcvdDetail ON VendPORcvdDetail.RcvdRefID=VendRcvdDetail.EntryID " & _
'            " Where VendRcvdDetail.EntryID=" & Val(LVRcv.ListItems(i).Key)
'
        End If
...
Private Sub UpdateRcvEntries()
    ...
    For i = 1 To LVRcv.ListItems.Count
        If LVRcv.ListItems(i).Checked Then
            ...
            'Update The Order's Rcvd Quantity.....
            con.Execute "Update  VendPurchOrdDetail Set VendPurchOrdDetail.QtyRcvd=VendPurchOrdDetail.QtyRcvd-" & Val(LVRcv.ListItems(i).SubItems(7)) & _
             " From VendPurchOrdDetail Inner JOIN VendPORcvdDetail ON VendPORcvdDetail.OrderRefID" & _
             "=VendPurchOrdDetail.ID Inner JOIN VendRcvdDetail ON VendPORcvdDetail.RcvdRefID = " & _
             "VendRcvdDetail.EntryID Where VendRcvdDetail.EntryID=" & Val(LVRcv.ListItems(i).Key)
            'Update Rcving Detail Entry....
