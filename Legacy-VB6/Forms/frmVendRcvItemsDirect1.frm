...
Begin VB.Form frmVendRcvItemsDirect1 
   ClientHeight    =   9945
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   11880
   ...
   Begin VB.Frame FALL 
      ...
      Begin VB.Frame FraCash 
         ...
         Begin MSForms.Label Label2 
            ...
            ForeColor       =   4194304
            BackColor       =   12504280
            Caption         =   $"frmVendRcvItemsDirect1.frx":0000
            Size            =   "16642;397"
      ...
      Begin MSForms.Label Label2 
         ...
         ForeColor       =   4194304
         BackColor       =   12504280
         Caption         =   $"frmVendRcvItemsDirect1.frx":00B0
         Size            =   "18177;397"
         BorderColor     =   10860487
         BorderStyle     =   1
         FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmVendRcvItemsDirect1"
...
'    Else
        Call cmbVend.AddVals(con, "VenderName", "Venders", "VendID", " Where PhaseID=" & cmbProcess.ID & " AND VendType=0")
'    End If
...
Private Sub cmdAdd_Click()
    ...
    If cmbProcess.ID >= 7 Then
        ...
        End If
        If GotRcvID = 0 Then
            GotRcvID = Val(con.Execute("Select Max(Cast(right(RecieptID,Len(RecieptID)-9) As Int)) From VVendRcvdItems Where Convert(varchar,DT,6)='" & Format(DTPicker1, "dd MMM yy") & "' and UPPER(Left(RecieptID,2))='HS' AND ProcessID=7 AND Left(RecieptID,3)<>'HSR'").Fields(0).value & "") + 1
        Else
            GotRcvID = GotRcvID + 1
        End If
        ITM.ListSubItems.Add(, , "HS-" & Format(DTPicker1, "ddMMyy") & GotRcvID).Tag = lLotNo
    Else
        If GotRcvID = 0 Then
        ...
        Else
            GotRcvID = GotRcvID + 1
        End If
        ITM.ListSubItems.Add , , "RCV-" & Format(DTPicker1, "ddMMyy") & GotRcvID
    End If
...
Private Sub cmdSave_Click()
    If Saved Then
        FormProcessID = cmbProcess.ID
        Unload Me
        Call ShowRcvDirectForm(FormProcessID)
    End If
End Sub
    ...
    For i = 1 To LV.ListItems.Count
            ...
            If Val(LV.ListItems(i).SubItems(3)) > 0 Then
                ...
                With cmd
                    ...
                    If cmbProcess.ID >= 7 Then
                        .Parameters("@LotNo").value = LV.ListItems(i).ListSubItems(5).Tag
                    End If
                    '.Parameters("@UserID").value = UserID
                    .Execute
                End With
