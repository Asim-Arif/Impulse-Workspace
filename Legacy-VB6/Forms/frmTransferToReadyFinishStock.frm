...
Begin VB.Form frmTransferToReadyFinishStock 
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00AFBDCB&
         BackStyle       =   0  'Transparent
         Caption         =   $"frmTransferToReadyFinishStock.frx":0286
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransferToReadyFinishStock.frx":0341
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransferToReadyFinishStock.frx":04FD
            Key             =   "Up"
         EndProperty
      EndProperty
   End
...
Private Sub cmdPost_Click()
    ...
    Dim strMaterialID As String, lRISD_EntryID As Long
    Dim lTTRFD_EntryID As Long
    ...
    For i = 1 To LV.ListItems.count
        With LV.ListItems(i)
            If .Checked Then
                ...
                lTTRFD_EntryID = GetSingleLongValue("MAX(EntryID)", "TransferredToReadyFinishLotsDetail")
'                con.Execute "UPDATE Items SET InHand=ISNULL(InHand,0)+" & dQty & " WHERE ItemID='" & .SubItems(5) & "'"
                ...
                con.Execute "INSERT INTO RcvItemsSimpleDetail(RcvNo,ItemID,Qty,InHand,LedgerRefID,OrderNo,Location,Remarks,TTRFLD_RefID,LotNo_Manual,BatchNo_Manual,Mill_Certificate_No) VALUES('" & _
                 strRcvNo & "','" & strMaterialID & "'," & dQty & "," & dBal + dQty & "," & lRefID & _
                 ",'" & strPOs & "','" & cmbLocation.Text & "','" & strLots & "'," & lTTRFD_EntryID & ",'" & .SubItems(8) & "','" & .SubItems(9) & "','" & .SubItems(10) & "')"
    ...
    For i = 1 To LV.ListItems.count
        With LV.ListItems(i)
            If .Checked Then
                ...
                con.Execute "INSERT INTO RcvItemsSimpleDetail(RcvNo,ItemID,Qty,InHand,LedgerRefID,OrderNo,Location,TTRFLD_RefID,LotNo) VALUES('" & _
                 strRcvNo & "','" & strMaterialID & "'," & dQty & "," & dBal & "," & lRefID & ",'" & strLots & "','" & _
                 strLocation & "'," & lTTRFD_EntryID & ",'" & .SubItems(8) & "')"
...
'            ITM.ListSubItems.add(, , IIf(!ReqAuth, "Under Auth.", "Authorized")).Tag = !LotNo & ""
            ...
            ITM.ListSubItems.add , , Val(!Batch_No & "")
            ITM.ListSubItems.add , , Val(!Mill_Certificate_No & "")
SKIPEntry:
            .MoveNEXT
        Loop
        .Close
