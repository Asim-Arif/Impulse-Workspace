...
Begin VB.Form frmTotalExport 
   ...
   Begin VB.Frame FAll 
      ...
      Begin VB.ComboBox cmbRange 
         Height          =   315
         ItemData        =   "frmTotalExport.frx":0000
         Left            =   2445
         List            =   "frmTotalExport.frx":0016
      ...
      Begin MSForms.CommandButton cmdPrint 
         ...
         Size            =   "2937;635"
         Picture         =   "frmTotalExport.frx":0066
         Accelerator     =   80
         FontName        =   "Tahoma"
      ...
      Begin MSForms.CommandButton cmdCancel 
         ...
         PicturePosition =   327683
         Size            =   "2937;635"
         Picture         =   "frmTotalExport.frx":0178
         Accelerator     =   67
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmTotalExport"
...
Private Sub RefreshLV()
    ...
    Cond = Cond & " AND ISNULL(GatePassNo,'')<>''"
    ...
    With rs
        .Open "SELECT * FROM VTotalExport" & Cond, con, adOpenForwardOnly, adLockReadOnly
        dTotal = 0
        Do Until .EOF
            
            If chkCustom.Value Then
                Amt = Val(![TotalCustomAmt] & "")
            Else
                Amt = Val(![TotalAmt] & "")
            End If
...
Private Sub cmdPrint_Click()
    ...
    strSelection = strSelection & " AND {VTotalExport.GatePassNo}<>''"
    strSelection = strSelection & " AND ({VTotalExport.CustCode}<>'HMP')"
    If cmbCust.ID <> "0" Then
