...
Begin VB.Form frmEditItem_VC 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmEditItem_VCx.frx":0000
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Other Info."
      TabPicture(1)   =   "frmEditItem_VCx.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame2"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Barcode"
      TabPicture(2)   =   "frmEditItem_VCx.frx":0038
   ...
   Begin MSForms.CommandButton cmdOk 
      ...
      Size            =   "2990;661"
      Picture         =   "frmEditItem_VCx.frx":0054
      Accelerator     =   83
      FontName        =   "Tahoma"
   ...
   Begin MSForms.CommandButton cmdCancel 
      ...
      PicturePosition =   327683
      Size            =   "2990;661"
      Picture         =   "frmEditItem_VCx.frx":04A2
      Accelerator     =   67
      FontName        =   "Tahoma"
      FontEffects     =   1073741825
      FontHeight      =   165
