...
Begin VB.Form frmUserInfo_Old 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image1 
         Height          =   675
         Left            =   135
         Picture         =   "frmUserInfo_Old.frx":0000
         Top             =   195
         Width           =   540
      End
      Begin VB.Label lbls 
      ...
      Begin VB.Label Label1 
         Caption         =   $"frmUserInfo_Old.frx":04D0
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin MSForms.CommandButton cmdCancel 
      ...
      Size            =   "2196;661"
      Picture         =   "frmUserInfo_Old.frx":0564
      Accelerator     =   67
      FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmUserInfo_Old"
...
'         Allow All Options.....
         Dim lUserID As Long
         lUserID = GetSingleLongValue("MAX(UserID)", "Users")
         con.Execute "UPDATE Users SET ExportMainLink=1,FinancialMainLink=1,PayrollMainLink=1" & _
         ",ProductionMainLink=1,StockMainLink=1,CompanyMainLink=1 WHERE UserID=" & lUserID
         
         con.Execute "INSERT INTO UserMenuOptions SELECT " & lUserID & ",OptionID FROM MenuOptions"
   End Select
...
Private Sub Form_Activate()
    ...
    If Show_Option = Opt_ChangeUserPassword Then
       Label1.Caption = "Enter Your Old Password, Then Enter New Password, Confirm It And Press OK Button To Change You Password"
