...
Private Sub cmdSave_Click()
    ...
    Case Opt_ChangeUserPassword
        Dim strOldPassword As String, strNewPassword As String
        strOldPassword = GetSingleStringValue("Password", "Users", " WHERE UserName='" & Me.Tag & "'")
        strOldPassword = CryptRC4(FromHexDump(strOldPassword), "AwmWrangler")
         If txts(0) & "" <> strOldPassword Then
         ...
         ElseIf txts(1) <> txts(2) Then
            ...
            Exit Sub
         End If
         strNewPassword = txts(1)
         strNewPassword = ToHexDump(CryptRC4(strNewPassword, "AwmWrangler"))
         con.Execute "UPDATE Users SET [Password]='" & strNewPassword & "' WHERE [UserName]='" & Me.Tag & "'"
         PlaySaveSound
   ...
   Case Opt_NewUser
         ...
         strNewPassword = txts(1)
         strNewPassword = ToHexDump(CryptRC4(strNewPassword, "AwmWrangler"))
         con.Execute "INSERT INTO Users([UserName],[Password]) VALUES('" & txts(0) & "','" & strNewPassword & "')"
   End Select
