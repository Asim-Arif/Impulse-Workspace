...
Begin VB.Form frmVendRcvRepairWaste 
   ClientHeight    =   7425
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   11040
   ...
   Begin VB.Frame FALL 
      ...
      Begin MSForms.Label Label2 
         ...
         ForeColor       =   4194304
         BackColor       =   12504280
         Caption         =   $"frmVendRcvRepairWaste.frx":0000
         Size            =   "18177;397"
   ...
   End
End
Attribute VB_Name = "frmVendRcvRepairWaste"
    ...
    For i = 1 To LV.ListItems.Count
            ...
            If Val(LV.ListItems(i).SubItems(4)) > 0 Then
                ...
                With cmd
                    ...
                    .Parameters("@Wastage").value = Val(LV.ListItems(i).SubItems(4))
