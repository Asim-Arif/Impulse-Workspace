...
Begin VB.Form frmVendIssItemsByItemOriginal 
   ClientHeight    =   10125
   ClientLeft      =   1110
   ClientTop       =   60
   ClientWidth     =   11805
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmVendIssItemsByItemOriginal.frx":0000
      ...
      TabPicture(1)   =   "frmVendIssItemsByItemOriginal.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "LVMaker"
      Tab(1).Control(1)=   "txtRate"
      Tab(1).ControlCount=   2
      TabCaption(2)   =   "Issued Items"
      TabPicture(2)   =   "frmVendIssItemsByItemOriginal.frx":0038
   ...
   Begin VB.CommandButton cmdPost 
      ...
      Height          =   510
      Left            =   6495
      Picture         =   "frmVendIssItemsByItemOriginal.frx":0054
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   5010
      UseMaskColor    =   -1  'True
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByItemOriginal.frx":0156
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByItemOriginal.frx":0312
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   2
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByItemOriginal.frx":04CE
            Key             =   "Active"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByItemOriginal.frx":0922
            Key             =   "Inactive"
         EndProperty
      EndProperty
   End
   ...
   Begin MSForms.Label Label2 
      ...
      Width           =   9600
      BackColor       =   11517387
      Caption         =   $"frmVendIssItemsByItemOriginal.frx":0D76
      Size            =   "16933;423"
      BorderColor     =   16512
      BorderStyle     =   1
      FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmVendIssItemsByItemOriginal"
...
Private Sub LV_ItemClick(ByVal Item As MSComctlLib.ListItem)
    ...
    txtQty = LV.SelectedItem.ListSubItems(3)
...
'                 UserID & "," & cmbProcess.ID & ")"
            ...
            Else
                con.Execute "Insert Into VendIssdDetail(RefID,RecieptID,ItemCode" & _
                 ",Rate,IssQty,ReqAuth,OrderNo) Values(" & lRefID & ",'" & _
                 .SubItems(2) & "','" & .SubItems(3) & "'," & _
                 Val(.SubItems(5)) & "," & Val(.SubItems(6)) & "," & UserReqAuth & ",'" & cmbOrderNo.Text & "')"
                 ...
                 If UserReqAuth = 0 Then
                    With cmd
                        ...
                        .Parameters("@ItemCode").value = LVIssued.ListItems(i).SubItems(3)
                        .Parameters("@ProcessID").value = cmbProcess.ID
                        .Parameters("@Qty").value = Val(LVIssued.ListItems(i).SubItems(6))
                        .Parameters("@OrderNo").value = cmbOrderNo.Text
                        .Execute
