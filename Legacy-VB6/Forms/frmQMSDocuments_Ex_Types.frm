...
Begin VB.Form frmQMSDocuments_Ex_Types 
   ...
   Begin VB.Frame FLV 
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   285
         Left            =   5400
         Picture         =   "frmQMSDocuments_Ex_Types.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin MSForms.CommandButton cmdClose 
         ...
         PicturePosition =   327683
         Size            =   "2514;635"
         Picture         =   "frmQMSDocuments_Ex_Types.frx":0532
         Accelerator     =   67
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSDocuments_Ex_Types.frx":0644
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSDocuments_Ex_Types.frx":0800
            Key             =   "Up"
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmQMSDocuments_Ex_Types"
...
Dim strMasterDocType As String

Public Sub ShowForm(sTableName As String, sColName As String, sColText As String, sEntryCol As String, Optional strFormCaption As String = "", Optional p_strMasterDocType As String)
    strMasterDocType = p_strMasterDocType
...
Private Sub cmdAdd_Click()
    ...
    con.Execute "INSERT INTO " & TableName & "(" & ColName & ",MasterDocumentType) " & _
                "VALUES('" & txtDesc & "','" & strMasterDocType & "')", Affect
...
Private Sub FillList()
    ...
    Sql = "SELECT * FROM " & TableName & " WHERE MasterDocumentType='" & strMasterDocType & "' ORDER BY " & ColName
