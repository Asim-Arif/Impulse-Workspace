...
Private Sub MDIForm_Load()
    ...
    With Toolbar1
        Set Toolbar1.ImageList = ImageList2
        For i = 1 To .Buttons.Count
            '.Buttons(i).Image = ImageList2.ListImages(.Buttons(i).Tag).Key
            'If Not .Buttons(i).Style = tbrSeparator Then
            .Buttons(i).Image = ImageList2.ListImages(i).Key
        Next i
    End With
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    If Button.Index = 1 Then
        Toolbar1.Buttons("a").Visible = True
        Toolbar2.Visible = True
    Else
        Toolbar1.Buttons("a").Visible = False
