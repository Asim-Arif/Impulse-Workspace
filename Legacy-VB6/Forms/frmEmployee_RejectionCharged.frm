...
Begin VB.Form frmEmployee_RejectionCharged 
   ClientHeight    =   9870
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   13230
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmEmployee_RejectionCharged.frx":0000
         Left            =   4455
         List            =   "frmEmployee_RejectionCharged.frx":0016
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmEmployee_RejectionCharged.frx":0066
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00AFBDCB&
         BackStyle       =   0  'Transparent
         Caption         =   $"frmEmployee_RejectionCharged.frx":0082
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEmployee_RejectionCharged.frx":0118
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEmployee_RejectionCharged.frx":02D4
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmEmployee_RejectionCharged"
...
Private Sub cmdMarkAsAudited_Click()
    ...
    For i = 1 To LVRepair.ListItems.count
        With LVRepair.ListItems(i)
            If .Checked Then
                con.Execute "UPDATE MakerRepair SET VchrNo='Gratuity' WHERE EntryID=" & Val(.key)
            End If
        End With
    Next
    Call RefreshLV
...
Private Sub AddRepairDetail()
    ...
    strCondition = " WHERE VchrNo IS NULL AND ShowInBilling=1 AND DeductFromBilling=1 AND DT BETWEEN '" & DtFrom.Value & "' AND '" & DtTo.Value & "' "
