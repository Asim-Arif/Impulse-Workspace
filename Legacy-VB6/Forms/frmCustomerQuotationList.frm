...
Begin VB.Form frmCustomerQuotationList 
   ClientHeight    =   9135
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11970
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbfield 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmCustomerQuotationList.frx":0000
            Left            =   60
            List            =   "frmCustomerQuotationList.frx":0010
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmCustomerQuotationList.frx":003C
         Left            =   4440
         List            =   "frmCustomerQuotationList.frx":0055
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   1065
         Width           =   2010
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00AFBDCB&
         BackStyle       =   0  'Transparent
         Caption         =   $"frmCustomerQuotationList.frx":00B4
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCustomerQuotationList.frx":014E
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCustomerQuotationList.frx":030A
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   Begin VB.Menu mnuPop 
      ...
      Begin VB.Menu mnuEdit 
         Caption         =   "&Edit This Quotation"
      End
      Begin VB.Menu mnuDelete 
         Caption         =   "Delete Quotation"
      End
      Begin VB.Menu d1 
         Caption         =   "-"
      End
      ...
      End
      Begin VB.Menu mnuPrintQuotationDiscount 
         Caption         =   "Print Quotation (Discount)"
      End
   ...
   End
End
Attribute VB_Name = "frmCustomerQuotationList"
...
'    End If
    ...
    With rs
        ...
        .Open "SELECT * FROM VCustomerQuotationsList " & Cond & " ORDER BY DT", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        'LV.Sorted = False
        Do Until .EOF
            Set ITM = LV.ListItems.add(, ![QuotationNo] & "'", .AbsolutePosition)
            ITM.Tag = ![Curr] & ""
            ITM.ListSubItems.add(, , ![CustCode] & "").Tag = ""
...
Private Sub LV_DblClick()
    ...
    Dim f As New frmNewCustomerQuotation
    Load f
    Call f.EditQuotation(Val(LV.SelectedItem.key))
...
Private Sub ShowMenus(vis As Boolean)
    ...
    mnuAdd.Caption = "&Add New Quotation"
...
Private Sub mnuDelete_Click()
    ...
    con.Execute "DELETE FROM CustomerQuotations WHERE QuotationNo=" & Val(LV.SelectedItem.key)
...
Private Sub mnuPrintList_Click()
    ...
    Dim rpt As CRAXDDRT.Report
    Set rpt = rptApp.OpenReport(RptPath & "\CustomerQuotationsList.rpt")
    Dim strSelection As String
    strSelection = "{VCustomerQuotationsList.DT}=#" & DtFrom.Value & "# TO #" & DtTo.Value & "#"
    If cmbCust.id <> "0" Then
        strSelection = strSelection & " AND {VCustomerQuotationsList.CustCode}='" & cmbCust.id & "'"
    End If
    
    If cmbCountry.ListIndex > 0 Then
        strSelection = strSelection & " AND {VCustomerQuotationsList.Country}='" & cmbCountry.Text & "'"
    End If
...
Private Sub mnuPrintQuotationDiscount_Click()
...
Private Sub PrintQuotation(Optional dDiscount As Double = 0)
    ...
    Set rpt = rptApp.OpenReport(RptPath & "\CustomerQuotation.rpt")
    rpt.FormulaFields.GetItemByName("Discount").Text = dDiscount
    Dim f As New frmPrevRpt
    Load f
    f.ShowReport "{VrptCustomInvoiceDetail.QuotationNo}=" & Val(LV.SelectedItem.key), rpt
