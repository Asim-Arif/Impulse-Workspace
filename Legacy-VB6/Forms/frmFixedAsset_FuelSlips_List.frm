...
Begin VB.Form frmFixedAsset_FuelSlips_List 
   ClientHeight    =   8385
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11970
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmFixedAsset_FuelSlips_List.frx":0000
         Left            =   4440
         List            =   "frmFixedAsset_FuelSlips_List.frx":0019
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   $"frmFixedAsset_FuelSlips_List.frx":0078
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAsset_FuelSlips_List.frx":0121
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAsset_FuelSlips_List.frx":02DD
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmFixedAsset_FuelSlips_List"
...
Private Sub cmdRefresh_Click()
    ...
    With rs
        .Open "SELECT * FROM VFixedAssets_FuelSlips " & strCondition, con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
...
Private Sub mnuAdd_Click()
    Dim f As New frmFixedAssets_FuelSlip_AE
    Load f
    f.AddNew
End Sub
...
Private Sub mnuPrintSlip_Click()
    ...
    Set rpt = rptApp.OpenReport(RptPath & "\FixedAssets_FuelSlip.rpt")
