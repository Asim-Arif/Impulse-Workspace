...
Begin VB.Form frmRMPOrdList 
   ...
   Begin VB.Frame FAcc 
      ...
      Begin MSComctlLib.ImageList ImageList2 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmRMPOrdList.frx":0000
               Key             =   "Down"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmRMPOrdList.frx":01BC
               Key             =   "Up"
            EndProperty
         EndProperty
      End
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmRMPOrdList.frx":0378
         Left            =   2520
         List            =   "frmRMPOrdList.frx":038B
      ...
      Begin MSForms.CommandButton cmdClose 
         ...
         Size            =   "2355;661"
         Picture         =   "frmRMPOrdList.frx":03D3
         Accelerator     =   67
         FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmRMPOrdList"
...
Private Sub RefreshLV()
    ...
    If cmbRange.ListIndex = 0 Then
        DTRange = " OrderDT Between '" & DateAdd("d", -15, ServerDate) & "' and '" & ServerDate & "'"
    ElseIf cmbRange.ListIndex = 1 Then
        DTRange = " OrderDT Between '" & DateAdd("d", -30, ServerDate) & "' and '" & ServerDate & "'"
    ElseIf cmbRange.ListIndex = 2 Then
        DTRange = " OrderDT Between '" & DateAdd("d", -60, ServerDate) & "' and '" & ServerDate & "'"
    ElseIf cmbRange.ListIndex = 3 Then
        DTRange = " OrderDT Between '" & DateAdd("d", -90, ServerDate) & "' and '" & ServerDate & "'"
    ElseIf cmbRange.ListIndex = 4 Then
        DTRange = " OrderDT Between '" & DtFrom & "' and '" & DtTo & "'"
    End If
    ...
    With rs
        ...
        .Open "Select * From VRMPOrderList " & Cond & " Order By OrderDT", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        'LV.Sorted = False
        Do Until .EOF
            ...
            ITM.ListSubItems.add , , Format(![OrderDT] & "", "dd-MMM-yyyy")
            'ITM.SubItems(4) = Format(![Dt] & "", "dd-MMM-yyyy")
            ITM.ListSubItems.add(, , "Rs " & Val(![OrderAmt] & "")).Tag = Val(![OrderAmt] & "")
...
Private Sub LV_DblClick()
    ...
    Load frmRMPurchOrd
    Call frmRMPurchOrd.EditOrder(Left(LV.SelectedItem.key, Len(LV.SelectedItem.key) - 1))
