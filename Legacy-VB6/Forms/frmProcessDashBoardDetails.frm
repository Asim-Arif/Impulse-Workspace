...
Begin VB.Form frmProcessDashBoardDetails 
   ClientHeight    =   8835
   ClientLeft      =   60
   ClientTop       =   45
   ClientWidth     =   13860
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cmbfield 
            Height          =   315
            ItemData        =   "frmProcessDashBoardDetails.frx":0000
            Left            =   60
            List            =   "frmProcessDashBoardDetails.frx":0019
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProcessDashBoardDetails.frx":0060
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProcessDashBoardDetails.frx":021C
            Key             =   "Up"
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmProcessDashBoardDetails"
...
Private Sub RefreshLV(lMakerID As Long, lProcessID As Long)
    ...
    Cond = " WHERE VendID=" & lMakerID & " AND ProcessID=" & lProcessID
    
    'Cond = Cond & " AND (LotNo<>'0' AND VVendIssued.EntryID NOT IN(SELECT Issuance_RefID FROM VendReceived))"
    Cond = Cond & " AND IssQty>ISNULL(RcvdQty,0)"
    ...
    With rs
        ...
        .Open "SELECT * FROM VVendIssdDetail " & Cond & " ORDER BY DT", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        'LV.Sorted = False
        Do Until .EOF
...
'                lForeColor = RGB(59, 59, 59)
            ...
            ITM.ListSubItems.add(, , !ReturnDT & "").ForeColor = vbRed
...
Private Sub LV_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    If strRet = "Print PTC" Then
        ...
        strLotNo = LV.SelectedItem.SubItems(8)
...
Public Sub ShowIssuanceList(p_lMakerID As Long, p_lProcessID As Long)
    
    Call RefreshLV(p_lMakerID, p_lProcessID)
    Me.Show
