...
Begin VB.Form frmItemGroups_ECommerce 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Groups for E-Commerce"
   ClientHeight    =   7620
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6090
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmItemGroups_ECommerce.frx":0000
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmItemGroups_ECommerce.frx":01BC
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmItemGroups_ECommerce"
...
Private Sub cmdAdd_Click()
    ...
    con.Execute "INSERT INTO ItemGroups_ECommerce(ECommerceGroupName,GrpColor) VALUES('" & txtDesc & "'," & Picture1.BackColor & ")", Affect
...
Private Sub FillList()
    ...
    SQL = "SELECT * FROM ItemGroups_ECommerce ORDER BY ECommerceGroupName"
    ...
    With rsList
        ...
        For i = 0 To .RecordCount - 1
            ...
            ITM.SubItems(1) = !ECommerceGroupName & ""
...
Private Sub LV_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 46 Then
        If MsgBox("Do You Want To Delete This Entry?", vbQuestion + vbYesNo) = vbYes Then
            ...
            con.Execute "DELETE FROM ItemGroups_ECommerce WHERE ID=" & Val(LV.SelectedItem.key), Affect
            If Affect = 1 Then
...
Private Sub txtDescription_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        Dim iAffect As Integer
        con.Execute "UPDATE ItemGroups_ECommerce SET ECommerceGroupName='" & txtDescription & "' WHERE ID=" & Val(LV.SelectedItem.key), iAffect
        If iAffect = 1 Then
