...
Begin VB.Form frmVendIssItemsByMaker 
   ClientHeight    =   10140
   ClientLeft      =   1110
   ClientTop       =   360
   ClientWidth     =   11805
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmVendIssItemsByMaker.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "txtTotal"
      Tab(0).Control(1)=   "LVBal"
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "Vender History"
      TabPicture(1)   =   "frmVendIssItemsByMaker.frx":001C
      ...
      TabPicture(2)   =   "frmVendIssItemsByMaker.frx":0038
      ...
      TabPicture(3)   =   "frmVendIssItemsByMaker.frx":0054
   ...
   Begin VB.CommandButton cmdPost 
      ...
      Height          =   510
      Left            =   10695
      Picture         =   "frmVendIssItemsByMaker.frx":0070
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   5520
      UseMaskColor    =   -1  'True
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByMaker.frx":0172
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByMaker.frx":032E
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   2
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByMaker.frx":04EA
            Key             =   "Active"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByMaker.frx":093E
            Key             =   "Inactive"
         EndProperty
      EndProperty
   End
   ...
   Begin MSForms.Label Label3 
      ...
      Width           =   10230
      BackColor       =   11517387
      Caption         =   $"frmVendIssItemsByMaker.frx":0D92
      Size            =   "18045;423"
      BorderColor     =   16512
      BorderStyle     =   1
      FontName        =   "Tahoma"
   ...
   Begin MSForms.Label Label2 
      ...
      Width           =   10770
      BackColor       =   11517387
      Caption         =   $"frmVendIssItemsByMaker.frx":0E34
      Size            =   "18997;423"
      BorderColor     =   16512
      BorderStyle     =   1
      FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmVendIssItemsByMaker"
