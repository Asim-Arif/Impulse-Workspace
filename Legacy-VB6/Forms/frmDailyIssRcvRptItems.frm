...
Begin VB.Form frmDailyIssRcvRptItems 
   ClientHeight    =   9945
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   11880
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "Daily Issue Receive Report"
         BeginProperty Font 
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.TextBox txtTotal 
         ...
         Width           =   1845
      End
      Begin ComboList.Usercontrol1 cmbItemCode 
         Height          =   285
         Left            =   75
         TabIndex        =   15
         TabStop         =   0   'False
      ...
      Begin VB.ComboBox cmbIssRcv 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmDailyIssRcvRptItems.frx":0000
         Left            =   2475
         List            =   "frmDailyIssRcvRptItems.frx":000A
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmDailyIssRcvRptItems.frx":0020
         Left            =   4515
         List            =   "frmDailyIssRcvRptItems.frx":0036
         Style           =   2  'Dropdown List
         TabIndex        =   10
         Top             =   435
         Width           =   2010
      ...
      Begin MSComctlLib.ImageList ImageList2 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmDailyIssRcvRptItems.frx":0087
               Key             =   "Down"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmDailyIssRcvRptItems.frx":0243
               Key             =   "Up"
            EndProperty
         EndProperty
      End
      ...
      Begin VB.Label Label1 
         Appearance      =   0  'Flat
         BackColor       =   &H00AFBDCB&
         Caption         =   $"frmDailyIssRcvRptItems.frx":03FF
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
      ...
      Begin MSForms.CommandButton cmdPrint 
         ...
         PicturePosition =   327683
         Size            =   "2355;661"
         Picture         =   "frmDailyIssRcvRptItems.frx":049E
         Accelerator     =   80
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
      ...
      Begin MSForms.CommandButton cmdClose 
         ...
         PicturePosition =   327683
         Size            =   "2355;661"
         Picture         =   "frmDailyIssRcvRptItems.frx":05B0
         Accelerator     =   67
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmDailyIssRcvRptItems"
...
Private Sub cmbItemCode_matched()
    cmbItemName.ID = cmbItemCode.ID
End Sub

Private Sub cmbItemName_matched()
    cmbItemCode.ID = cmbItemName.ID
End Sub
...
Private Sub Form_Load()
    ...
    cmbItemCode.ListHeight = 2800
    cmbItemName.ListHeight = 2800
    cmbProcess.AddItem "<All Processes>", "0"
    cmbProcess.AddVals con, "Description", "Processes", "ProcessID", " Order By SNo"
    
    cmbItemCode.AddItem "< All Items >", "0"
    cmbItemCode.AddVals con, "ItemID", "VItems1", "ItemID"
...
Private Sub NewRefreshLV()
    ...
    With cmd
        ...
        .CommandText = "SP_DailyIssRcvItems"
        Set .ActiveConnection = con
        .Parameters("@FromDate").value = DtFrom
        .Parameters("@ToDate").value = DtTo
        If cmbProcess.ID <> "0" Then
            .Parameters("@ProcessID").value = cmbProcess.ID
        End If
        If cmbItemCode.ID <> "0" Then
            .Parameters("@ItemID").value = cmbItemCode.ID
        End If
        If cmbIssRcv.ListIndex <> 0 Then
            .Parameters("@IssEntry").value = 0
        End If
    ...
    With rs
        ...
        .Open "Select * From PrintIssRcvRpts Order By DT", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        'LV.Sorted = False
        lTotal = 0
        Do Until .EOF
            Set ITM = LV.ListItems.Add(, , .AbsolutePosition)
            'itm.Tag = ![UserID] & ""
            ITM.SubItems(1) = ![RecieptID] & ""
            ITM.SubItems(2) = "[" & ![VendID1] & "] " & ![VenderName] & ""
            ITM.SubItems(3) = ![Process] & ""
            ITM.SubItems(4) = "[" & ![ItemCode] & "] " & ![ItemDescription] & ""
            ITM.SubItems(5) = ![Qty] & ""
            lTotal = lTotal + Val(![Qty] & "")
            .MoveNext
        Loop
        .Close
        txtTotal = lTotal
