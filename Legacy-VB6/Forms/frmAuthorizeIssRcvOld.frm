...
Begin VB.Form frmAuthorizeIssRcvOld 
   ClientHeight    =   9510
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   11910
   ...
   Begin VB.Frame FAcc 
      ...
      Begin MSComctlLib.ImageList ImageList2 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAuthorizeIssRcvOld.frx":0000
               Key             =   "Down"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAuthorizeIssRcvOld.frx":01BC
               Key             =   "Up"
            EndProperty
         EndProperty
      End
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmAuthorizeIssRcvOld.frx":0378
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "LVIss"
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Authorize Received"
         TabPicture(1)   =   "frmAuthorizeIssRcvOld.frx":0394
         ...
         TabCaption(2)   =   "Authorize PO Items"
         TabPicture(2)   =   "frmAuthorizeIssRcvOld.frx":03B0
         Tab(2).ControlEnabled=   -1  'True
         Tab(2).Control(0)=   "LVPO"
   ...
   End
End
Attribute VB_Name = "frmAuthorizeIssRcvOld"
...
Private Sub RefreshLV()
    ...
    With rs
        'rptSQL = "Select * From " & TableName & Cond & " Order By DT"
