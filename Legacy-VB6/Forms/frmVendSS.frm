   ...
   Begin VB.Frame FLV 
      ...
      Begin VB.Frame fButs2 
         ...
         Begin VB.CommandButton cmdAccounts 
            ...
            Width           =   1275
         End
         Begin MSForms.CommandButton cmdSaveChanges 
            Height          =   360
            Left            =   2610
            TabIndex        =   27
            Top             =   450
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendSS.frx":0000
            Key             =   "Present"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendSS.frx":0452
            Key             =   "Absent"
         EndProperty
      EndProperty
   End
...
Private Sub cmbdept_matched()
    ...
    If cmbDept.Text = "<All Processes>" Then
        cmbEmp.AddVals con, "VenderName", "Makers", "VendID"
    Else
...
NEXT_EMPLOYEE:
        ...
        Next
        .Close
        .Open "Select * From VendMonthlyPayments Where Month(DT)=" & cmbMonth.ListIndex + 1 & " AND Year(DT)=" & cmbYear & " AND AdvSalary=0", con, adOpenForwardOnly, adLockReadOnly
        Do Until .EOF
...
Private Sub GetTotals()
    ...
    Dim dTotalPaid As Double
    dTotalPaid = 0
    For i = 1 To LV.ListItems.count
        If LV.ListItems(i).Checked Then
            dTotalPaid = dTotalPaid + Val(LV.ListItems(i).SubItems(7))
        End If
    Next
    lblDebit = dTotalPaid
...
Private Sub PrintCheques(Optional bPrintVoucher As Boolean = False)
    ...
    Dim myDT As Date
    With rs
        .Open "Select * From ChequePrintingDates Where Year(SalaryDT)=" & cmbYear & " AND Month(SalaryDT)=" & cmbMonth.ListIndex + 1 & " AND AdvSalary=0", con, adOpenForwardOnly, adLockReadOnly
        If .EOF = False Then
            myDT = !DT
        Else
            myDT = Date
    ...
    If bPrintVoucher = False Then
        ...
        con.Execute "Delete From ChequePrintingDates Where Year(SalaryDT)=" & cmbYear & " AND Month(SalaryDT)=" & cmbMonth.ListIndex + 1 & " AND AdvSalary=0"
        con.Execute "Insert Into ChequePrintingDates(SalaryDT,DT,AdvSalary) Values('" & DateSerial(cmbYear, cmbMonth.ListIndex + 2, 0) & "','" & myDT & "',0)"
    End If
    '******************************************************************
