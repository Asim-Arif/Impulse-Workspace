...
Begin VB.Form frmQMSMeetings 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSMeetings.frx":0000
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSMeetings.frx":0454
            Key             =   "ORD"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSMeetings.frx":08AC
            Key             =   "UNLOCK"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSMeetings.frx":1636
            Key             =   "CAT1"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSMeetings.frx":1A8A
            Key             =   "ITMIN"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSMeetings.frx":1EDE
            Key             =   "LOCK"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSMeetings.frx":2C68
            Key             =   "CAT"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSMeetings.frx":30BC
            Key             =   "OK"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSMeetings.frx":3514
            Key             =   "TYPE"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu mnupop 
      ...
      Begin VB.Menu mnuPrint 
         Caption         =   "Print Meeting"
      End
   End
End
Attribute VB_Name = "frmQMSMeetings"
...
Private Sub Form_Load()
    ...
    Call cmbItem.AddVals(con, "'{' + Code + '} ' + Type", "QMS_Meetings", "EntryID", " ORDER BY Code")
...
Private Sub LV_DblClick()
    ...
    If LV.SelectedItem.SubItems(7) = "Attached" Then
        Call ShowTechDrawing("QMS_Meetings", "PDF", " WHERE EntryID=" & Val(LV.SelectedItem.key), LV.SelectedItem.Text, CD1)
    Else
...
Private Sub MnuEditItem_Click()
    ...
    Load frmQMSMeeting_AE
    Call frmQMSMeeting_AE.EditItem(Val(LV.SelectedItem.key))
...
Private Sub mnuPrint_Click()
    ...
    Load frmPrevRpt
    Dim rpt As CRAXDDRT.Report
    Set rpt = rptApp.OpenReport(RptPath & "\QMS_Meeting.rpt") '
    frmPrevRpt.ShowReport "{QMS_Meetings.EntryID}=" & Val(LV.SelectedItem.key), rpt
...
Public Sub AddHeads(Optional strOrderCond As String)
    ...
    With rs
        .Open "SELECT * FROM QMS_Meetings", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
            ...
            ITM.ListSubItems.add , , !Place & ""
            ITM.ListSubItems.add , , !Duration & ""
            ITM.ListSubItems.add , , !Agenda & ""
            ITM.ListSubItems.add , , !Discussion & ""
