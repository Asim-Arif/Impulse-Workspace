...
Begin VB.Form frmFCustFDBCNo 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   " Bank Name                         Branch                                  Acc No."
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   435
      Left            =   5220
      Picture         =   "frmFCustFDBCNo.frx":0000
      Top             =   1470
      Width           =   480
   End
   Begin MSForms.CommandButton cmdClose 
      ...
      Size            =   "3096;688"
      Picture         =   "frmFCustFDBCNo.frx":05EF
      Accelerator     =   67
      FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmFCustFDBCNo"
...
Private Sub cmbCust_matched()
    ...
    Dim rs As New ADODB.Recordset
    With rs
        .Open "Select CustomInvoice,FormE From CustomInvoice Where CustCode='" & cmbCust.ID & "' And CustomInvoice Not In(Select CustomInvoice From CustomInvoiceFDBCNo) Order By CustomInvoice", con, adOpenForwardOnly, adLockReadOnly
...
Private Sub cmdGenerate_Click()
    ...
    con.Execute "Insert Into CustomInvoiceFDBCNo(CustomInvoice,FDBCNo,FDBCDT,BankID) Values('" & _
     cmbCustomInvoice.Text & "','" & txtFDBC & "','" & DT1 & " '," & cmbBranch.List(cmbBranch.ListIndex, 2) & ")"
