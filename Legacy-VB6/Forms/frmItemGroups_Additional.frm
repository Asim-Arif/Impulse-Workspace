...
Begin VB.Form frmItemGroups_Additional 
   ...
   Begin VB.Frame FLV 
      ...
      Top             =   705
      Width           =   8250
      Begin ComboList.Usercontrol1 cmbPurchaserE 
         Height          =   285
         Left            =   3570
         TabIndex        =   15
         Top             =   1140
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmItemGroups_Additional.frx":0000
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmItemGroups_Additional.frx":01BC
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmItemGroups_Additional"
...
Private Sub cmbPurchaserE_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 13 Then
        con.Execute "UPDATE ItemGroups SET EmpID_Purchaser='" & cmbPurchaserE.ID & "' WHERE ID=" & Val(LV.SelectedItem.key)
        LV.SelectedItem.SubItems(3) = cmbPurchaserE.Text
        LV.SelectedItem.ListSubItems(3).Tag = cmbPurchaserE.ID
        cmbPurchaserE.Visible = False
...
Private Sub cmdAdd_Click()
    ...
    If cmbPurchaser.MatchFound Then
        strEmpID = cmbPurchaser.ID
    Else
        strEmpID = ""
    End If
    con.Execute "INSERT INTO ItemGroups(Description,GrpColor,EmpID_Purchaser) VALUES('" & txtDesc & "'," & Picture1.BackColor & ",'" & strEmpID & "')", Affect
...
Private Sub FillList()
    ...
    SQL = "SELECT * FROM VItemGroups ORDER BY Description"
    ...
    With rsList
        ...
        For i = 0 To .RecordCount - 1
            ...
            ITM.ListSubItems.add(, , !EmpID_Purchaser & " - " & !Name & "").Tag = !EmpID_Purchaser & ""
...
Private Sub Form_Load()
    ...
    cmbPurchaser.ListHeight = 3000
    cmbPurchaser.AddVals con, "Name+' {'+EmpID+'}'", "VEmp", "EmpID", " WHERE Active=1"
    
    cmbPurchaserE.AddVals con, "Name+' {'+EmpID+'}'", "VEmp", "EmpID", " WHERE Active=1"
...
Private Sub LV_DblClick()
    ...
    If iColNo = 4 Then
        With cmbPurchaserE
            ...
            .ID = LV.SelectedItem.ListSubItems(3).Tag
            .Visible = True
            .SetFocus
        End With
    Else
