...
Begin VB.Form frmFinancialBudgeting 
   ClientHeight    =   8520
   ClientLeft      =   120
   ClientTop       =   180
   ClientWidth     =   13905
   ...
   End
End
Attribute VB_Name = "frmFinancialBudgeting"
...
Private Sub cmbFinYear_Click()
    ...
    With rs
        .Open "SELECT * FROM Accounts WHERE Parent=0 AND Active=1 ORDER BY AccNo", con, adOpenForwardOnly, adLockReadOnly
