...
Begin VB.Form frmMakerNewLongTermLoan 
   ...
   Begin VB.Frame FraBank 
      ...
      Begin VB.CommandButton cmdBank 
         ...
         Height          =   315
         Left            =   6030
         Picture         =   "frmMakerNewLongTermLoan.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   555
         Width           =   360
   ...
   End
End
Attribute VB_Name = "frmMakerNewLongTermLoan"
...
Private Function Saved() As Boolean
    ...
    bPOMaker = True 'GetSingleBooleanValue("POMaker", "Makers", " WHERE AccNo='" & cmbAccNo.ID & "'")
    If bPOMaker Then
    
        If cmbMasterPONo.MatchFound = False Then
            If MsgBox("Do you want to continue without Master PO No.", vbQuestion + vbYesNo) = vbNo Then
                Exit Function
            End If
        Else
...
'    End If
    ...
    SQL = "INSERT INTO MakerAdvances(AccNo,DT,Type,Description," & _
     "Amount,DAmount,AmountCleared,AccVoucherNo,MasterPONo) Values('" & cmbAccNo.ID & _
     "','" & DTPicker1 & "',1,'" & txtDesc & _
     "'," & Val(txtAmt) & "," & Val(txtDeduct) & ",0,'" & strVchrNo & "','" & cmbMasterPONo.ID & "')"
...
Private Function SaveTransForCheque() As String
    ...
    theDesc = "Long Term Advance Paid To " & cmbAccName.Text & " Amount Paid :" & Val(txtAmt) & " Ded. Amt : " & Val(txtDeduct)
    
    'Start New Transaction
    'con.BeginTrans
    'bankDesc = Right(lblBankAcc, Len(lblBankAcc) - InStr(lblBankAcc, "]")) & " Chq # :" & Tbox(2)
    bankDesc = theDesc & " " & "Chq # :" & TBox(2)
    ...
    AccNo & "','" & bankDesc & "'," & Val(txtAmt) & "," & lblBankAcc.Tag & ",'" & _
...
Private Function AddVoucher() As String
    ...
    strDesc = "Long Term Advance Paid To " & cmbAccName.Text & " Amount Paid :" & Val(txtAmt) & " Ded. Amt : " & Val(txtDeduct)
    If cmbMasterPONo.MatchFound Then
...
'    objVchr.LastPaymentAccNo = cmbAccNo.Text
    ...
    objVchr.AddVoucherHead strVenderAccNo, dValue, strDesc
