...
Begin VB.Form frmFixedAssets 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAssets.frx":0000
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAssets.frx":0454
            Key             =   "ORD"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAssets.frx":08AC
            Key             =   "UNLOCK"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAssets.frx":1636
            Key             =   "CAT1"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAssets.frx":1A8A
            Key             =   "ITMIN"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAssets.frx":1EDE
            Key             =   "LOCK"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAssets.frx":2C68
            Key             =   "CAT"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAssets.frx":30BC
            Key             =   "OK"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFixedAssets.frx":3514
            Key             =   "TYPE"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu mnupop 
      ...
      End
      Begin VB.Menu mnuPrintAssetSlip 
         Caption         =   "Print Asset Slip"
      End
   End
End
...
Private Sub MnuEditItem_Click()
    ...
    If LV.SelectedItem.Bold Then
        Load frmNewMasterFixedAsset
        Call frmNewMasterFixedAsset.EditCat(Val(LV.SelectedItem.key))
    Else
        Load frmNewFixedAsset
        Call frmNewFixedAsset.EditItem(Val(LV.SelectedItem.key))
    End If
...
Private Sub mnuPrintAssetSlip_Click()

    If LV.ListItems.count = 0 Then Exit Sub
    
    Dim rpt As CRAXDDRT.Report
    Set rpt = rptApp.OpenReport(RptPath & "\AssetSlip.rpt")
    Dim f As New frmPrevRpt
    f.ShowReport "{FixedAssets.EntryID}=" & Val(LV.SelectedItem.key), rpt
...
Public Sub AddHeads_Old(Optional strOrderCond As String)
...
'    f.Show
    ...
    With rs
        .Open "SELECT COUNT(*) FROM VFixedAssets GROUP BY MasterFA_RefID", con, adOpenForwardOnly, adLockReadOnly
        If .EOF Then
            iTotalMasters = 0
        Else
            iTotalMasters = .RecordCount
            ReDim lAddedMasters(iTotalMasters)
        End If
        iIndex = 0
        .Close
        .Open "SELECT * FROM VFixedAssets", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        For i = 0 To .RecordCount - 1
            bAdded = False
            For j = 0 To iTotalMasters - 1
                If Val(!MasterFA_RefID & "") = lAddedMasters(j) Then
                    bAdded = True
                    Exit For
                End If
            Next
            
            If bAdded = False And Val(!MasterFA_RefID & "") > 0 Then
                'Call AddMaster(Val(!MasterFA_RefID & ""))
                Set ITM = LV.ListItems.add(, Val(!MasterFA_RefID & "") & " Master")
                ITM.ListSubItems.add , , !FixedAssets_MasterDescription & ""
                lAddedMasters(iIndex) = Val(!MasterFA_RefID & "'")
                iIndex = iIndex + 1
                ITM.Bold = True
                ITM.ListSubItems(1).Bold = True
                'iTotalMasters = iTotalMasters + 1
            End If
            
            lColor = vbBlack
            Set ITM = LV.ListItems.add(, Val(!EntryID & "") & "'", !AssetID & "")
...
'    f.Show
    ...
    Dim i As Integer, j As Integer, bAdded As Boolean
    With rs
        .Open "SELECT * FROM FixedAssets_Master ORDER BY EntryID", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
            Set ITM = LV.ListItems.add(, Val(!EntryID & "") & " Master")
            ITM.ListSubItems.add(, , !Description & "").Bold = True
            ITM.Bold = True
            
            Call FillFixedAssets(Val(!EntryID & ""))
            .MoveNEXT
        Loop
        .Close
    End With
...
Private Sub FillFixedAssets(lMasterEntryID As Long)
    
    Dim rs As New ADODB.Recordset
    With rs
        .Open "SELECT * FROM VFixedAssets_WOPic WHERE MasterFA_RefID=" & lMasterEntryID & " ORDER BY EntryID", con, adOpenForwardOnly, adLockReadOnly
        Do Until .EOF
