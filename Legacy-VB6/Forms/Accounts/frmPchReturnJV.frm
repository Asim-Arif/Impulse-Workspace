...
Begin VB.Form frmPchReturnJV 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.Frame Frame6 
            ...
            Begin MSForms.CommandButton cmdCancel 
               ...
               PicturePosition =   327683
               Size            =   "2937;635"
               Picture         =   "frmPchReturnJV.frx":0000
               Accelerator     =   67
               FontName        =   "Tahoma"
               FontEffects     =   1073741825
               FontHeight      =   165
         ...
         Begin VB.CommandButton cmdSave 
            ...
            Height          =   555
            Left            =   9690
            Picture         =   "frmPchReturnJV.frx":0112
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.CommandButton cmdDelete 
            ...
            Height          =   285
            Left            =   9690
            Picture         =   "frmPchReturnJV.frx":0644
            Style           =   1  'Graphical
            TabIndex        =   10
         ...
         Begin VB.Label Label1 
            ...
            BackColor       =   &H00C5D1DC&
            BorderStyle     =   1  'Fixed Single
            Caption         =   $"frmPchReturnJV.frx":0B76
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   8.25
               Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmPchReturnJV"
...
Private Sub cmdSClose_Click()
    If SaveTrans Then
        If MsgBox("Do You Want To Enter The Return Amount ?", vbQuestion + vbYesNo) = vbYes Then
            With frmCashRV
                .cmbAccNo = cmbVendAccNo
                .Show
                .SetFocus
...
PermissionDenied = Not UserHasAccess("PurchaseReturnVoucher")
...
Private Sub FillAccCmbs()
    ...
    With AccRec
        ...
        .Open "Select AccNo,AccTitle from Accounts as Acc1 Where AccNo Like '" & PRTACC & "%' AND  Parent=0 AND Active=1", con, adOpenForwardOnly, adLockReadOnly
...
Private Function SaveTrans() As Boolean
   ...
   Call adjustLedger(cmbVendAccNo, DTPicker1.value, INextSno, Val(lblTotal))
    ...
    'For i = 1 To LVPymt.ListItems.Count
    '    If LVPymt.ListItems(i).Checked Then Con.Execute "Insert into VoucherDetail Values (" & SnoToUse & "," & Val(LVPymt.ListItems(i).key) & ")"
    'Next
   ...
   Call adjustFakeLedger(cmbVendAccNo, DTPicker1.value, INextSno, Val(lblTotal))
    ...
    For i = 1 To LView.ListItems.Count
        ...
        con.Execute "insert into FakeVouchers Values(" & INextSno & ",'" & Format(DTPicker1.value, "dd-MMM-yyyy") & "','" & _
         VNo & "','" & LView.ListItems(i).Text & "','" & LView.ListItems(i).ListSubItems(2).Text & "',0," & _
         Val(LView.ListItems(i).ListSubItems(3).Text) & "," & _
         Bal & ",'',0)"
