   ...
   Begin VB.Frame fFrom 
      ...
      Begin VB.Frame fBankAcc 
         ...
         Begin VB.CommandButton cmdBank 
            ...
            Height          =   315
            Left            =   4050
            Picture         =   "frmBankAccounts.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   21
            Top             =   315
            Width           =   360
   ...
   Begin VB.Frame fTo 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CommandButton cmdToBank 
            ...
            Height          =   315
            Left            =   4050
            Picture         =   "frmBankAccounts.frx":0372
            Style           =   1  'Graphical
            TabIndex        =   22
            Top             =   330
            Width           =   360
...
Private Sub getFromBal()
    ...
    If fFrom.Tag <> "" Then
        If FakeAccounts Then
            lblFromBal.Tag = getFakeBalance(fFrom.Tag, DTPicker1)
        Else
...
Private Sub getToBal()
    ...
    If FakeAccounts Then
        lblToBal.Tag = getFakeBalance(fTo.Tag, DTPicker1)
    Else
...
If FakeAccounts Then Call FakeFundsTransfered
...
Dim INextSno As Double, VchrNo As String, DescFrom As String, DescTo As String
 ...
 con.BeginTrans
        ...
        VchrNo = getNextVchrNo(DTPicker1, "PV")
  ...
  '''''''''Cheque Entry
        ...
        If OptFromBank Then
             ...
             CSNo = INextSno
             con.Execute "insert into Cheque Values(" & INextSno & ",'" & DTPicker1 & "','" & _
             fFrom.Tag & "','Amount Transfered To " & DescTo & "'," & Val(txtAmt) & "," & lblFromBankAcc.Tag & ",'" & _
             txtChqNo & "'," & txtChqNo.Tag & ",'Open','" & DTPicker1 & "',True,True,False)"
        ...
        VchrNo & "','" & fFrom.Tag & "','Amount Transfered To " & DescTo & "', 0," & Val(txtAmt) & "," & Bal & ",''," & CSNo & ")"
        ...
        con.Execute "insert into Vouchers Values(" & INextSno & ",'" & DTPicker1 & "','" & _
         VchrNo & "','" & fTo.Tag & "','Amount Transfered From " & DescFrom & "', " & Val(txtAmt) & ",0," & Bal & ",'" & SlipNo & "'," & CSNo & ")"
        ...
        'Print If To Be Printed
               If chkPrint = vbChecked Then Call PrintVoucher(frmMain.cr1, VchrNo, True)
...
Private Function FakeFundsTransfered(Optional ChqSNo) As Boolean
...
Dim INextSno As Double, VchrNo As String, DescFrom As String, DescTo As String
 ...
 con.BeginTrans
         ...
         VchrNo = getNextFakeVchrNo(DTPicker1, "PV")
  ...
  '''''''''Cheque Entry
   ...
   '''''Credit Entry
        ...
        con.Execute "insert into FakeVouchers Values(" & INextSno & ",'" & DTPicker1 & "','" & _
        VchrNo & "','" & fFrom.Tag & "','Amount Transfered To " & DescTo & "', 0," & Val(txtAmt) & "," & Bal & ",''," & ChqSNo & ")"
        
        
      
        Call adjustFakeLedger(fFrom.Tag, DTPicker1, INextSno, -Val(txtAmt))
        ...
        con.Execute "insert into FakeVouchers Values(" & INextSno & ",'" & DTPicker1 & "','" & _
         VchrNo & "','" & fTo.Tag & "','Amount Transfered From " & DescFrom & "', " & Val(txtAmt) & ",0," & Bal & ",'" & SlipNo & "'," & ChqSNo & ")"
        
        
        
        Call adjustFakeLedger(fTo.Tag, DTPicker1, INextSno, Val(txtAmt))
