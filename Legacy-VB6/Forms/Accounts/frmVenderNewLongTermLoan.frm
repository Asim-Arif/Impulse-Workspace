...
Begin VB.Form frmVenderNewLongTermLoan 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Vender Long Term Loan"
   ClientHeight    =   6975
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6705
   ...
   Begin VB.Frame FraBank 
      ...
      Begin VB.CommandButton cmdBank 
         ...
         Height          =   315
         Left            =   6030
         Picture         =   "frmVenderNewLongTermLoan.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   555
         Width           =   360
   ...
   End
End
Attribute VB_Name = "frmVenderNewLongTermLoan"
...
Private Sub cmbAccName_matched()
    ...
    With rs
        .Open "SELECT VendID FROM VVenders WHERE AccNo='" & cmbAccName.id & "'", con, adOpenForwardOnly, adLockReadOnly
