...
Begin VB.Form frmPRC_Old 
   ...
   Begin VB.PictureBox PicWC 
      ...
      Begin VB.Image Image1 
         Height          =   960
         Left            =   15
         Picture         =   "frmPRC_Old.frx":272F
         Top             =   60
         Width           =   960
      End
   End
End
Attribute VB_Name = "frmPRC_Old"
...
Public Sub ShowMe(m_lPymtEntryID As Long, strInvoiceNo As String, dValue As Double, strBillNo As String, dExchRate As Double)
    ...
    cmbCust.AddVals con, "Distinct CustCode", "ForeignCustomers", "CustCode", " Order By CustCode"
