...
Begin VB.Form frmTransaction 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransactoin.frx":0000
            Key             =   "PND"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransactoin.frx":0458
            Key             =   "CLR"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransactoin.frx":08AC
            Key             =   "DUE"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransactoin.frx":0D04
            Key             =   "BNC"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Frame FAcc 
      ...
      Top             =   -90
      Width           =   10365
      Begin VB.CheckBox chkFilterByPosted 
         Caption         =   "Filter by Posted Date"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   178
      ...
      Begin VB.ComboBox cmbRange 
         Height          =   315
         ItemData        =   "frmTransactoin.frx":1158
         Left            =   4275
         List            =   "frmTransactoin.frx":116B
      ...
      Begin VB.Label Label4 
         ...
         Width           =   720
      End
      Begin MSForms.ComboBox cmbPostedBy 
         Height          =   315
         Left            =   75
         TabIndex        =   36
         Top             =   915
      ...
      Begin VB.Label Label5 
         ...
         Width           =   870
      End
      Begin MSForms.ComboBox cmbPostedFrom 
         Height          =   315
         Left            =   4275
         TabIndex        =   34
         Top             =   915
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00AFBDCB&
         BackStyle       =   0  'Transparent
         Caption         =   $"frmTransactoin.frx":11AD
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Menu mnupop 
      ...
      End
      Begin VB.Menu mnuPrintVoucher2 
         Caption         =   "Print This Voucher 2"
      End
      ...
      End
      Begin VB.Menu mnuOpenLedger 
         Caption         =   "Open Detailed Account Ledger"
      End
...
Public Sub ShowMe(Trans_DT As Date, dSNo As Double)

    cmbRange.ListIndex = 4
    DtFrom.Value = Trans_DT
    DtTo.Value = Trans_DT
    ...
    'Now Goto the entry
    LV.ListItems(dSNo & "'").Selected = True
    
    LV.ListItems(dSNo & "'").EnsureVisible
...
Private Sub Form_Load()
    ...
    cmbPostedBy.AddItem "<All Users>"
    Call AddToCombo(cmbPostedBy, "DISTINCT UserName", "VoucherInfo", " ORDER BY UserName", True)
    cmbPostedBy.ListIndex = 0
    
    cmbPostedFrom.AddItem "<All Computers>"
    Call AddToCombo(cmbPostedFrom, "DISTINCT MachineName", "VoucherInfo", " ORDER BY MachineName", True)
    cmbPostedFrom.ListIndex = 0
...
Private Sub Form_Resize()
    ...
    cmdRefresh.Left = FAcc.Left + FAcc.Width + 100
...
Private Sub RefreshLedger()
    ...
    If chkFilterByPosted.Value = vbChecked Then
        strDateField = "CAST(CONVERT(VARCHAR(50),VchrEntryDate,6) AS DATETIME)"
    Else
        strDateField = "VDate"
    End If
    ...
    If cmbRange.ListIndex = 0 Then
        If Chks(j).Tag = "JV" Then
            SQL = "SELECT * FROM VLedger1 WHERE (" & strDateField & "='" & DtFrom & "') AND (VchrNo Like '%" & Chks(j).Tag & "%' OR LEFT(VchrNo,3) NOT IN('BPV','CPV','CRV','BRV'))"
        Else
            SQL = "SELECT * FROM VLedger1 WHERE " & strDateField & "='" & DtFrom & "' AND VchrNo Like '%" & Chks(j).Tag & "%'"
        End If
    ElseIf j = 4 Then
        SQL = "SELECT * FROM VLedger1 WHERE (" & strDateField & " BETWEEN '" & DtFrom & "' AND '" & DtTo & "') AND (VchrNo Like '%" & Chks(j).Tag & "%' OR LEFT(VchrNo,2)='RV')"
    Else
        If Chks(j).Tag = "JV" Then
            SQL = "SELECT * FROM VLedger1 WHERE " & strDateField & " BETWEEN '" & DtFrom & "' AND '" & DtTo & "' AND ((VchrNo Like '%" & Chks(j).Tag & "%') OR LEFT(VchrNo,3) NOT IN('BPV','CPV','CRV','BRV'))"
        Else
            SQL = "SELECT * FROM VLedger1 WHERE (" & strDateField & " BETWEEN '" & DtFrom & "' AND '" & DtTo & "') AND (VchrNo Like '%" & Chks(j).Tag & "%')"
        End If
    End If
     
    If cmbPostedBy.ListIndex > 0 Then
        SQL = SQL & " AND UserName='" & cmbPostedBy.Text & "'"
    End If
    If cmbPostedFrom.ListIndex > 0 Then
        SQL = SQL & " AND MachineName='" & cmbPostedFrom.Text & "'"
    End If
    
    SQL = SQL & " ORDER BY " & strDateField & ",VchrNo,Debit DESC"
...
Private Sub LV_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    If InStr(LV.SelectedItem, "-") > 0 Then
        ...
        If Left(LV.SelectedItem.SubItems(1), 3) = "BPV" Then
...
Private Sub mnuOpenLedger_Click()
    
    With frmLedger
        .cmbAccNo = LV.SelectedItem.ListSubItems(2).Tag
        .cmdRefresh_Click
        .Show
    End With
...
Private Sub mnuPreviewVoucher_Click()
    ...
    Call PrintVoucher(Cr1, LV.SelectedItem.SubItems(1), , False)
...
Private Sub mnuprintOnblank_Click()
    ...
    If LV.ListItems.count = 0 Then Exit Sub
    Call PrintVoucher(Cr1, LV.SelectedItem.SubItems(1), , True)
...
Private Sub mnuPrintVoucher2_Click()
    If LV.ListItems.count = 0 Then Exit Sub
    Call PrintVoucher(Cr1, LV.SelectedItem.SubItems(1), , True, False, 1)
End Sub
