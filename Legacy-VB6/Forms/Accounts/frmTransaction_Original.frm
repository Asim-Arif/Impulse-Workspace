...
Begin VB.Form frmTransaction_Original 
   ClientHeight    =   8175
   ClientLeft      =   60
   ClientTop       =   240
   ClientWidth     =   11880
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransaction_Original.frx":0000
            Key             =   "PND"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransaction_Original.frx":0458
            Key             =   "CLR"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransaction_Original.frx":08AC
            Key             =   "DUE"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTransaction_Original.frx":0D04
            Key             =   "BNC"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.ComboBox cmbRange 
         Height          =   315
         ItemData        =   "frmTransaction_Original.frx":1158
         Left            =   4275
         List            =   "frmTransaction_Original.frx":116B
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00AFBDCB&
         BackStyle       =   0  'Transparent
         Caption         =   $"frmTransaction_Original.frx":11AD
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmTransaction_Original"
...
Private Sub RefreshLedger()
    ...
    If cmbRange.ListIndex = 0 Then
        If Chks(j).Tag = "JV" Then
            SQL = "SELECT * FROM VLedger1 where (VDate = '" & DtFrom & "') AND (VchrNo Like '%" & Chks(j).Tag & "%' OR LEFT(VchrNo,3) NOT IN('BPV','CPV','CRV','BRV')) ORDER BY VDate,VchrNo,Debit DESC"
        Else
    ...
    Else
        If Chks(j).Tag = "JV" Then
            SQL = "SELECT * FROM VLedger1 WHERE VDate BETWEEN '" & DtFrom & "' AND '" & DtTo & "' AND ((VchrNo Like '%" & Chks(j).Tag & "%') OR LEFT(VchrNo,3) NOT IN('BPV','CPV','CRV','BRV')) Order By VDate,VchrNo,Debit DESC"
        Else
