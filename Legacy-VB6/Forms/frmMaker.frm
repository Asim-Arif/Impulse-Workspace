...
Begin VB.Form frmMaker 
   ...
   Begin VB.Frame FAll 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmMaker.frx":0000
         ...
         Tab(0).Control(9)=   "lblCNICPDF"
         Tab(0).Control(9).Enabled=   0   'False
         Tab(0).Control(10)=   "CD2"
         Tab(0).Control(10).Enabled=   0   'False
         Tab(0).Control(11)=   "Frame1"
         Tab(0).Control(11).Enabled=   0   'False
         Tab(0).Control(12)=   "txtUrduFields(0)"
         Tab(0).Control(12).Enabled=   0   'False
         Tab(0).Control(13)=   "cmdBrowseBarcode"
         Tab(0).Control(13).Enabled=   0   'False
         Tab(0).Control(14)=   "txtFilePath"
         Tab(0).Control(14).Enabled=   0   'False
         Tab(0).ControlCount=   15
         TabCaption(1)   =   "Detail"
         TabPicture(1)   =   "frmMaker.frx":001C
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "txtfields(0)"
         Tab(1).Control(1)=   "cmbItemName"
         Tab(1).Control(2)=   "cmbItem"
         Tab(1).Control(3)=   "txtfields(18)"
         Tab(1).Control(4)=   "txtfields(17)"
         Tab(1).Control(5)=   "txtfields(16)"
         Tab(1).Control(6)=   "txtfields(14)"
         Tab(1).Control(7)=   "LV"
         Tab(1).Control(8)=   "cmdAssign"
         Tab(1).Control(9)=   "lblItems"
         Tab(1).Control(10)=   "lblLabels(19)"
         Tab(1).Control(11)=   "chkComp1"
         Tab(1).Control(12)=   "chkComp2"
         Tab(1).Control(13)=   "lblLabels(18)"
         Tab(1).Control(14)=   "cmbProcess1"
         Tab(1).Control(15)=   "cmbProcess"
         Tab(1).Control(16)=   "lblLabels(16)"
         Tab(1).Control(17)=   "cmbType"
         Tab(1).Control(18)=   "lblLabels(15)"
         Tab(1).ControlCount=   19
         TabCaption(2)   =   "Other Info."
         TabPicture(2)   =   "frmMaker.frx":0038
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "TBox(0)"
         Tab(2).Control(1)=   "Label1(10)"
         Tab(2).Control(2)=   "Label1(11)"
         Tab(2).Control(3)=   "TBox(1)"
         Tab(2).Control(4)=   "Label1(8)"
         Tab(2).Control(5)=   "cmbPaymentTerms"
         Tab(2).Control(6)=   "Label1(6)"
         Tab(2).Control(7)=   "cmbShowRate"
         Tab(2).Control(8)=   "Label1(5)"
         Tab(2).Control(9)=   "Label1(4)"
         Tab(2).Control(10)=   "Label1(2)"
         Tab(2).Control(11)=   "FRefInfo"
         Tab(2).Control(12)=   "txtfields(21)"
         Tab(2).Control(13)=   "txtfields(20)"
         Tab(2).Control(14)=   "txtfields(19)"
         Tab(2).ControlCount=   15
         TabCaption(3)   =   "Sub Makers"
         TabPicture(3)   =   "frmMaker.frx":0054
         ...
         TabPicture(4)   =   "frmMaker.frx":0070
         Tab(4).ControlEnabled=   0   'False
         Tab(4).Control(0)=   "LV2"
         Tab(4).Control(1)=   "cmbProcessSearch"
         ...
         Begin VB.Label Label1 
            AutoSize        =   -1  'True
            Caption         =   "Maker Name as Per CNIC"
            ForeColor       =   &H00800000&
            Height          =   195
            Index           =   10
            Left            =   -74730
...
Private Sub cmbProcessSearch_matched()
    ...
    LV2.ListItems(cmbProcessSearch.ID & "'").Selected = True
    LV2.SelectedItem.EnsureVisible
    LV2.SetFocus
...
'        Exit Function
    ...
    Dim lCount As Long
    If VendID = 0 Then
        lCount = GetSingleLongValue("COUNT(NICNo)", "Makers", " WHERE NicNo='" & txtfields(15) & "'")
    Else
        lCount = GetSingleLongValue("COUNT(NICNo)", "Makers", " WHERE VendID<>" & VendID & " AND NicNo='" & txtfields(15) & "'")
    End If
    If lCount > 0 Then
...
'        End If
    ...
    If VendID = 0 Then
        ...
        'strParent = "24-004-006"
        strParent = cmbMasterCat.List(cmbMasterCat.ListIndex, 1)
        If txtfields(1) <> "" Then
            txtfields(2) = GetNextAccno(txtfields(1), Left(Acno, 2), strParent)
        End If
        con.Execute "INSERT INTO Accounts(AccNo,AccTitle,SubAccOf,Type,OpenBal,opendate,Balance,UserName,ComputerName) VALUES('" & _
         txtfields(2) & "','" & txtfields(1) & "','" & strParent & "','" & Left(strParent, 2) & "',0,'" & Now & "',0,'" & CurrentUserName & _
         "','" & strComputerName & "')"
         
        SQL = CreateInsertSQL("Makers")
        
    Else
        SQL = CreateUpdateSQL("Makers")
        con.Execute "UPDATE Accounts SET AccTitle='" & txtfields(1) & "' WHERE AccNo='" & txtfields(2) & "'"
    ...
    con.Execute SQL
    If VendID = 0 Then
        Rec.Open "SELECT Max(VendID) From Makers", con, adOpenForwardOnly, adLockReadOnly
        VendID = Rec.Fields(0) & ""
        Rec.Close
    End If
    Call SaveItems(VendID)
    If bUrduSupported Then
        con.Execute "UPDATE Makers SET MakerNameUrdu=N'" & txtUrduFields(0).Text & "' WHERE VendID=" & VendID
    End If
    Call AttachCNICPDF(VendID)
    ...
    If CopingVender Then
        ...
        NewVendID = Val(con.Execute("Select Max(VendID) From Makers").Fields(0).Value & "")
...
SavePic:
    ...
    Rec.Open "Select VendID,VendPic,VendThumb from Makers Where VendID=" & VendID, con, adOpenStatic, adLockOptimistic
...
'    cmbType.AddItem "Sub Venders"
    Call AddToCombo(cmbType, "DISTINCT MakerType", "Makers", " WHERE MakerType IS NOT NULL")
    ...
    With cmbShowRate
        ...
        .AddItem "Yes"
    End With
    Call AddToCombo(cmbPaymentTerms, "DISTINCT PaymentTerms", "Makers")
    Call AddSubVenders
...
'    cmbItemName.AddVals con, "CompleteItemName", "VItems1", "ItemID", " Order By ItemID"
    ...
    If strCompany = "QEL" Then
        txtfields(12) = GetSingleLongValue("MAX(CAST(VendID1 AS INT))", "Makers", "WHERE ISNUMERIC(VendID1)=1") + 1
    ElseIf strCompany = "Dr-Frgz" Or strCompany = "Banzai" Or strCompany = "IAA" Or strCompany = "Kami" Or strCompany = "Towne" Then
        Dim strVendID As String
        
        'strVendID = (GetSingleLongValue("COUNT(VendID)", "Makers") + 1)
        strVendID = GetSingleLongValue("MAX(CAST(RIGHT(VendID1,4) AS INT))", "Makers", "WHERE ISNUMERIC(RIGHT(VendID1,4))=1") + 1
        strVendID = Format(strVendID, "0000")
        strVendID = "CONT-" & strVendID
...
Private Sub Image2_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    If Image2.Picture = 0 Then Exit Sub
    Dim strRet As String
    strRet = ShowPopUpMenu1("View")
    If strRet = "View" Then
        Dim f As New frmViewPictureFSExt
        Load f
        f.ShowFromPic Image2.Picture
    End If
End Sub
...
Private Sub ShowData()
    ...
    Dim ITM As ListItem
    With rs
        .Open "SELECT * FROM VMakers WHERE VendID=" & VendID & " ORDER BY VendID", con, adOpenForwardOnly, adLockReadOnly
        VendID1 = ![VendID1] & ""
'        cmbProcess = ![Description] & ""
'        If Len(![NICNo]) = 15 Then
'            NIC(0).Value = True
'        Else
'            NIC(1).Value = True
'        End If
        ...
        .Open "SELECT VendPic,VendThumb FROM Makers WHERE VendID=" & VendID, con, adOpenForwardOnly, adLockReadOnly
        ...
        .Close
        .Open "SELECT * FROM MakerProcesses WHERE VendID=" & VendID, con, adOpenForwardOnly, adLockReadOnly
        
        Do Until .EOF
            Set ITM = LV2.ListItems(Val(!ProcessID & "") & "'")
            ITM.Checked = True
            'ITM.Tag = "Added" 'Already Checked
            .MoveNEXT
        Loop
        .Close
    End With
...
Private Sub AddProcesses()
    ...
    cmbProcessSearch.AddVals con, "Description", "Processes", "ProcessID", " ORDER BY SNo"
...
Private Sub AttachCNICPDF(p_lVendID As Integer)
    ...
    If strPDFPath <> "" And txtFilePath.Tag = "" Then
        Dim Rec As New ADODB.Recordset
        Dim rsPic As New ADODB.Stream
        Rec.Open "SELECT VendID,CNIC_PDF,CNIC_PDF_FileName FROM Makers WHERE VendID=" & p_lVendID, con, adOpenStatic, adLockOptimistic
...
Private Sub txtFilePath_DblClick()
    If txtFilePath.Tag <> "" Then
        Call ShowTechDrawing("Makers", "CNIC_PDF", " WHERE VendID=" & VendID, CStr(VendID), CD2)
    End If
End Sub
