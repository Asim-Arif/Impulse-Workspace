...
Begin VB.Form frmNewShippingAgent 
   ...
   Begin VB.Frame FAll 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin MSForms.CommandButton cmdSave 
            ...
            Size            =   "2937;635"
            Picture         =   "frmNewShippingAgent.frx":0000
            Accelerator     =   110
            FontName        =   "Tahoma"
         ...
         Begin MSForms.CommandButton cmdCancel 
            ...
            PicturePosition =   327683
            Size            =   "2937;635"
            Picture         =   "frmNewShippingAgent.frx":0112
            Accelerator     =   67
            FontName        =   "Tahoma"
            FontEffects     =   1073741825
            FontHeight      =   165
         ...
         Begin MSForms.CommandButton cmdSaveClose 
            ...
            PicturePosition =   327683
            Size            =   "2937;635"
            Picture         =   "frmNewShippingAgent.frx":0224
            Accelerator     =   83
            FontName        =   "Tahoma"
            FontEffects     =   1073741825
            FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmNewShippingAgent"
...
Public Sub EditAgent(ID As Long)
    ...
    With rs
        .Open "Select * From ShippingAgents Where EntryID=" & AgentID, con, adOpenForwardOnly, adLockReadOnly
...
Private Function Saved() As Boolean
    ...
    If AgentID = 0 Then
        ...
        Sql = CreateInsertSQL("ShippingAgents")
    Else
       Sql = CreateUpdateSQL("ShippingAgents")
