...
Begin VB.Form frmMiscIssuanceList 
   ClientHeight    =   6795
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   10365
   ...
   Begin VB.ComboBox cmbRange 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmMiscIssuanceList.frx":0000
      Left            =   45
      List            =   "frmMiscIssuanceList.frx":0016
   ...
   Begin MSForms.CommandButton cmdClose 
      ...
      PicturePosition =   327683
      Size            =   "2752;688"
      Picture         =   "frmMiscIssuanceList.frx":006D
      Accelerator     =   67
      FontName        =   "Tahoma"
      FontEffects     =   1073741825
      FontHeight      =   165
   ...
   Begin VB.Menu mnupop 
      ...
      Begin VB.Menu mnuPrintDesignation 
         Caption         =   "Print Designation"
         Visible         =   0   'False
      End
   End
End
Attribute VB_Name = "frmMiscIssuanceList"
...
Private Sub Form_Resize()
    ...
    LV.Move 50, cmbRange.Height + cmbRange.Top, Me.ScaleWidth - 100, Me.ScaleHeight - (cmdClose.Height + 100 + 600)
...
Public Sub mnuAdd_Click()
   ...
   Load frmMiscIssuanceAE
   
   frmMiscIssuanceAE.ShowMe
...
Private Sub mnuEdit_Click()
    ...
    Load frmMiscIssuanceAE
    Call frmMiscIssuanceAE.ShowMe(Val(LV.SelectedItem.Tag))
...
Private Sub mnuPrintDesignation_Click()
    ...
    Set rpt = rptApp.OpenReport(rptPayrollPath & "\Designation.rpt")
...
Private Sub mnuPrintDetail_Click()
    ...
    Dim rpt As CRAXDDRT.Report
    Set rpt = rptApp.OpenReport(RptPath & "\MiscIssuanceList.rpt")
...
Private Sub RefreshList()
    ...
    With rs
        .Open "SELECT * FROM ItemIssuanceMisc WHERE DT BETWEEN '" & DtFrom.Value & "' AND '" & DtTo.Value & "' ORDER BY DT", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
            Set ITM = LV.ListItems.add(, , LV.ListItems.count + 1)
            ITM.Tag = Val(!EntryID & "")
            ITM.ListSubItems.add , , Format(!DT, "dd-MMM-yyyy")
            ITM.ListSubItems.add , , !SentTo & ""
            ITM.ListSubItems.add , , !Country & ""
            ITM.ListSubItems.add , , !SentBy & ""
            ITM.ListSubItems.add , , !Remarks & ""
            ITM.ListSubItems.add , , Val(!Qty & "")
            ITM.ListSubItems.add , , Val(!Weight & "")
            ITM.ListSubItems.add , , !AWBNo & ""
            ITM.ListSubItems.add , , Val(!NetCourierCharges & "")
            ITM.ListSubItems.add , , Val(!ExchRate & "")
            ITM.ListSubItems.add , , Round(Val(!NetCourierCharges & "") * Val(!ExchRate & ""))
            .MoveNEXT
        Loop
        .Close
    End With
