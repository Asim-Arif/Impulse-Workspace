...
Begin VB.Form frmDeisgnationsList 
   ClientHeight    =   6795
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   10365
   ...
   Begin MSForms.CommandButton cmdClose 
      ...
      PicturePosition =   327683
      Size            =   "2752;688"
      Picture         =   "frmDeisgnationsList.frx":0000
      Accelerator     =   67
      FontName        =   "Tahoma"
      FontEffects     =   1073741825
      FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmDeisgnationsList"
...
Public Sub mnuAdd_Click()
   ...
   Load frmAEDesignation
   
   frmAEDesignation.ShowMe
...
Private Sub mnuEdit_Click()
    ...
    Load frmAEDesignation
    Call frmAEDesignation.ShowMe(Val(LV.SelectedItem.Tag))
...
Private Sub mnuPrintDetail_Click()
    ...
    Dim rpt As CRAXDDRT.Report
    Set rpt = rptApp.OpenReport(rptPayrollPath & "\Designations.rpt")
    Dim f As New frmPrevRpt
    f.ShowReport "", rpt
...
Private Sub RefreshList()
    ...
    With rs
        .Open "SELECT * FROM Designations ORDER BY Designation", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
            Set ITM = LV.ListItems.add(, , LV.ListItems.count + 1)
            ITM.Tag = Val(!EntryID & "")
            ITM.ListSubItems.add , , !Designation & ""
            ITM.ListSubItems.add , , !Duties & ""
            ITM.ListSubItems.add , , !RequiredSkills & ""
            ITM.ListSubItems.add , , !RequiredTrainings & ""
            .MoveNEXT
        Loop
        .Close
    End With
