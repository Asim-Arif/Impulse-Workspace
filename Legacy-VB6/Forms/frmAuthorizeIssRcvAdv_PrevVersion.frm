...
Begin VB.Form frmAuthorizeIssRcvAdv_PrevVersion 
   AutoRedraw      =   -1  'True
   ClientHeight    =   9525
   ClientLeft      =   0
   ClientTop       =   285
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbfield 
            Height          =   315
            ItemData        =   "frmAuthorizeIssRcvAdv_PrevVersion.frx":0000
            Left            =   60
            List            =   "frmAuthorizeIssRcvAdv_PrevVersion.frx":0002
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmAuthorizeIssRcvAdv_PrevVersion.frx":0004
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "LVIss"
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Authorize Received"
         TabPicture(1)   =   "frmAuthorizeIssRcvAdv_PrevVersion.frx":0020
         ...
         TabPicture(2)   =   "frmAuthorizeIssRcvAdv_PrevVersion.frx":003C
         ...
         Begin VB.Frame FraAddWastage 
            ...
            Begin MSForms.Label Label9 
               ...
               Width           =   4500
               BackColor       =   11517387
               Caption         =   $"frmAuthorizeIssRcvAdv_PrevVersion.frx":0058
               Size            =   "7937;423"
               BorderColor     =   16512
               BorderStyle     =   1
               FontName        =   "Tahoma"
         ...
         Begin VB.Frame FraAddRework 
            ...
            Begin MSForms.Label Label6 
               ...
               Width           =   6840
               BackColor       =   11517387
               Caption         =   $"frmAuthorizeIssRcvAdv_PrevVersion.frx":0122
               Size            =   "12065;423"
               BorderColor     =   16512
               BorderStyle     =   1
               FontName        =   "Tahoma"
            ...
            Begin MSForms.Label Label4 
               ...
               Width           =   6840
               BackColor       =   11517387
               Caption         =   $"frmAuthorizeIssRcvAdv_PrevVersion.frx":01AD
               Size            =   "12065;423"
               BorderColor     =   16512
               BorderStyle     =   1
               FontName        =   "Tahoma"
         ...
         Begin VB.Frame FraEdit 
            ...
            Begin MSForms.Label lblmine 
               ...
               Width           =   10830
               BackColor       =   11517387
               Caption         =   $"frmAuthorizeIssRcvAdv_PrevVersion.frx":0277
               Size            =   "19103;423"
               BorderColor     =   16512
               BorderStyle     =   1
               FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmAuthorizeIssRcvAdv_PrevVersion"
...
Private Sub UpdateRcvEntries()
    ...
    Dim lTempEntryID As Long, lmyVendID As Long, strmyEmpID As String
    Dim lRepair As Long
    Dim lLost As Long
                ...
                For j = 1 To LVWastageAll.ListItems.count
                    ...
                    With LVWastageAll.ListItems(j)
                        ...
                        If Val(.ListSubItems(1).Tag) = Val(LVRcv.ListItems(i).key) Then
                            ...
                            con.Execute "INSERT INTO VendRcvdDetailWastageDetail(VRD_RefID,Wastage_RefID,Qty,WastageType,ReturnTo_VRD_RefID,VendID) VALUES(" & _
                             Val(LVRcv.ListItems(i).key) & "," & Val(.Tag) & "," & Val(.SubItems(1)) & "," & _
                             lWastageType & "," & lReturnToEntryID & "," & lmyVendID & ")"
...
'                                    strVchrNo = objVchr.PostVoucher(False, True)
                    ...
                    End If
                End If
            ElseIf strCompany = "QEL" Or strCompany = "Dr-Frgz" Then
                ...
                If lWastageCh2Originator > 0 Then
                    ...
                    dmyRate = GetSingleLongValue("Rate", "VendReceived INNER JOIN VendRcvdDetail ON VendReceived.EntryID=VendRcvdDetail.RefID", " WHERE VendRcvdDetail.EntryID=" & lTempEntryID)
                        ...
                        With LVWastageAll.ListItems(j)
                            ...
                            If Val(.ListSubItems(1).Tag) = Val(LVRcv.ListItems(i).key) Then
                                ...
                                If lWastageType = 3 Then
                                    ...
                                    Dim rs As New ADODB.Recordset
                                    With rs
                                        .Open "SELECT * FROM VVendRcvdDetail WHERE LotNo='" & strLotNo & "' AND EntryID<=" & p_lEntryID & " ORDER BY EntryID", con, adOpenForwardOnly, adLockReadOnly
                                        Do Until .EOF
                                            ...
                                            con.Execute "INSERT INTO MakerRepair(VendID,DT,Rcvd_RefID,Qty,Rate,UserName,MachineName,VendIssdDetail_RefID,RepairAmt,Wastage_Originator,ShowInBilling,VRD_RefID_ChargeTo) VALUES(" & _
                                             lmyVendID & ",'" & GetServerDate(False) & "'," & Val(LVRcv.ListItems(i).key) & "," & Val(.SubItems(1)) & _
                                             "," & dmyRate & ",'" & CurrentUserName & "','" & strComputerName & "'," & lmyEntryID & ",0,0," & iShowInBilling & "," & Val(!EntryID & "") & ")"
                                     
                                            .MoveNEXT
                                        Loop
                                    End With
                                    
                                    'I'm not sure about following block of code...if the Wastage Should be Rcvable ...
                                    lMakerRepair_EntryID = GetSingleLongValue("MAX(EntryID)", "MakerRepair")
                                    'Now Stand this Qty for rcving...
...
Private Sub Form_Load()
    ...
    cmbWastage.AddVals con, "WastageName", "WastageTypes", "EntryID"
