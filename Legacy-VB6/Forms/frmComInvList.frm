...
Begin VB.Form frmComInvList 
   ...
   Begin VB.Frame FAll 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmComInvList.frx":030A
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "LV"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Other Info."
         TabPicture(1)   =   "frmComInvList.frx":0326
         ...
         Tab(1).Control(8)=   "cmdSwap"
         Tab(1).Control(9)=   "Label1(14)"
         Tab(1).Control(10)=   "Label1(12)"
         Tab(1).Control(11)=   "cmbPayment"
         Tab(1).Control(12)=   "Label1(3)"
         Tab(1).Control(13)=   "txtAdd1"
         Tab(1).Control(14)=   "AWBDT"
         Tab(1).Control(15)=   "txtAWBNo"
         Tab(1).Control(16)=   "txtLoad"
         Tab(1).Control(17)=   "txtDis"
         Tab(1).Control(18)=   "txtOrders"
         Tab(1).Control(19)=   "txtAdd2"
         Tab(1).Control(20)=   "txtVessel"
         Tab(1).Control(21)=   "txtFormE"
         ...
         Begin VB.Label Label1 
            ...
            BackColor       =   &H00C5D1DC&
            BorderStyle     =   1  'Fixed Single
            Caption         =   $"frmComInvList.frx":0342
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00C5D1DC&
         BorderStyle     =   1  'Fixed Single
         Caption         =   $"frmComInvList.frx":03CC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmComInvList"
...
Public Sub EditProforma(TempProforma As String)
    ...
    With rs
        .Open "Select * From VCustomInvoice Where CustomInvoice='" & strProforma & "'", con, adOpenForwardOnly, adLockReadOnly
        ...
        ReDim ForEdit(.RecordCount, 1)
        '*******************************
        
        Do Until .EOF
            
            ForEdit(.AbsolutePosition, 0) = ![PInvoiceItemID]
            ForEdit(.AbsolutePosition, 1) = ![Qty]
            
            Set ITM = LV.ListItems.Add(, ![PInvoiceItemID] & "'", .AbsolutePosition)
            ...
            ITM.SubItems(6) = Val(![Qty] & "") + Val(![CQty] & "")
            ITM.SubItems(7) = Val(![Qty] & "")
            ITM.SubItems(8) = Val(![Qty] & "") * Val(![Price])
...
Private Sub cmbCountry_Click()
    ...
    With rs
        .Open "Select Distinct PInvoice From VFProformaList Where CustCode+Country='" & cmbCust.Tag & "'", con, adOpenForwardOnly, adLockReadOnly
...
Private Sub cmdedit_Click()
    ...
    Load frmNewComInv
    frmNewComInv.EditProforma cmbCustomInvoice
End Sub
