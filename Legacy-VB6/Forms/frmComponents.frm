...
Begin VB.Form frmComponents 
   ...
   Begin VB.Frame FLV 
      ...
      Begin MSForms.CommandButton cmdPrint 
         ...
         Size            =   "2514;635"
         Picture         =   "frmComponents.frx":0000
         Accelerator     =   80
         FontName        =   "Tahoma"
      ...
      Begin MSForms.CommandButton cmdClose 
         ...
         PicturePosition =   327683
         Size            =   "2514;635"
         Picture         =   "frmComponents.frx":0112
         Accelerator     =   67
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComponents.frx":0224
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComponents.frx":03E0
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   ...
   Begin MSForms.CommandButton cmdAdd 
      ...
      Size            =   "1085;1058"
      Picture         =   "frmComponents.frx":059C
      Accelerator     =   65
      FontName        =   "Tahoma"
      FontEffects     =   1073741825
      FontHeight      =   165
...
Private Sub cmdAdd_Click()
    ...
    con.Execute "insert into Components (" & _
...
Private Sub cmdClose_Click()
    If IsLoaded("frmNewItem") Then
        Call AddToCombo(frmNewItem.cmbComp, "Description", "Components", , , "CompID")
    End If
    Unload Me
End Sub
...
Private Sub FillList()
    ...
    With rsList
        ...
        For i = 0 To .RecordCount - 1
            Set ITM = LV.ListItems.Add(, ![CompID] & "'", i + 1)
