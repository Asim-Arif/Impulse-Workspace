...
Begin VB.Form frmVenderBillingList 
   ClientHeight    =   8385
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11970
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmVenderBillingList.frx":0000
         Left            =   5895
         List            =   "frmVenderBillingList.frx":0016
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00AFBDCB&
         BackStyle       =   0  'Transparent
         Caption         =   $"frmVenderBillingList.frx":0066
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVenderBillingList.frx":0120
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVenderBillingList.frx":02DC
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmVenderBillingList"
...
Private Sub RefreshLV()
    ...
    End If
    strCondition = strCondition & " AND SampleBilling=" & Abs(bSample)
    
    With rs
        .Open "SELECT * FROM VVenderPostedBillsList " & strCondition & " ORDER BY EntryID", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
            Set ITM = LV.ListItems.add(, !EntryID & "'", LV.ListItems.count + 1)
            ITM.ListSubItems.add(, , !AccTitle & "").Tag = !VchrNo & ""
            ITM.ListSubItems.add , , Val(!BillNo & "")
            ITM.ListSubItems.add , , Format(!DT, "dd-MMM-yyyy")
            ITM.ListSubItems.add , , ""
            ITM.ListSubItems.add , , Round(Val(!TotalBillAmount & ""))
            ITM.ListSubItems.add , , Round(Val(!TotalDedAmount & ""))
            ITM.ListSubItems.add , , Round(Val(!TotalBillAmount & "") - Val(!TotalDedAmount & ""))
            .MoveNEXT
        Loop
        .Close
    End With
...
Private Sub mnuPrintBill_Click()
    Call PrintVenderPostedBill(LV.SelectedItem.ListSubItems(1).Tag)
End Sub
