...
Begin VB.Form frmVendIssItemsByItem 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmVendIssItemsByItemOLDg.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "txtRate"
      Tab(0).Control(1)=   "LVMaker"
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "Issued Items"
      TabPicture(1)   =   "frmVendIssItemsByItemOLDg.frx":001C
   ...
   Begin VB.CommandButton cmdPost 
      ...
      Height          =   510
      Left            =   6495
      Picture         =   "frmVendIssItemsByItemOLDg.frx":0038
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   4860
      UseMaskColor    =   -1  'True
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByItemOLDg.frx":013A
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByItemOLDg.frx":02F6
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   2
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByItemOLDg.frx":04B2
            Key             =   "Active"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssItemsByItemOLDg.frx":0906
            Key             =   "Inactive"
         EndProperty
      EndProperty
   End
