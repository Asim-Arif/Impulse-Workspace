...
Begin VB.Form frmMiscGateOutAE 
   ...
   End
End
Attribute VB_Name = "frmMiscGateOutAE"
...
Private Function Saved() As Boolean
    ...
    If lEntryID = 0 Then
        con.Execute "INSERT INTO MiscEntries_GateOut(DT,GatePassNo,PersonName,VehicleNo," & _
        ...
        lmyEntryID = GetSingleLongValue("MAX(EntryID)", "MiscEntries_GateOut")
    Else
        con.Execute "UPDATE MiscEntries_GateOut SET DT='" & DTPicker1 & "',GatePassNo='" & txtGatePassNo & _
         "',PersonName='" & txtName & "',VehicleNo='" & txtVehicleNo & "',Description='" & txtDescription & "' WHERE EntryID=" & lEntryID
        lmyEntryID = lEntryID
        
        con.Execute "DELETE FROM MiscEntries_GateOut_Details WHERE MEGO_RefID=" & lEntryID
    End If
    
    Dim i As Integer
    For i = 1 To LV.ListItems.count
        With LV.ListItems(i)
            con.Execute "INSERT INTO MiscEntries_GateOut_Details(MEGO_RefID,Detail,Unit,Qty,Packing) VALUES(" & _
...
Public Function ShowMe(Optional p_lEntryID As Long) As Boolean
    ...
    If lEntryID > 0 Then
        ...
        With rs
            .Open "SELECT * FROM MiscEntries_GateOut WHERE EntryID=" & lEntryID, con, adOpenForwardOnly, adLockReadOnly
            DTPicker1 = !DT & ""
            ...
            .Open "SELECT * FROM MiscEntries_GateOut_Details WHERE MEGO_RefID=" & lEntryID, con, adOpenForwardOnly, adLockReadOnly
            LV.ListItems.Clear
            Do Until .EOF
