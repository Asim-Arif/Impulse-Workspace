...
Begin VB.Form frmAuthorizeIssRcvAdv_Prev 
   AutoRedraw      =   -1  'True
   ClientHeight    =   9525
   ClientLeft      =   0
   ClientTop       =   285
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbfield 
            Height          =   315
            ItemData        =   "frmAuthorizeIssRcvAdv_Prev.frx":0000
            Left            =   60
            List            =   "frmAuthorizeIssRcvAdv_Prev.frx":0002
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmAuthorizeIssRcvAdv_Prev.frx":0004
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "LVIss"
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Authorize Received"
         TabPicture(1)   =   "frmAuthorizeIssRcvAdv_Prev.frx":0020
         ...
         TabPicture(2)   =   "frmAuthorizeIssRcvAdv_Prev.frx":003C
         ...
         Begin VB.Frame FraAddWastage 
            ...
            Begin MSForms.Label Label9 
               ...
               Width           =   4500
               BackColor       =   11517387
               Caption         =   $"frmAuthorizeIssRcvAdv_Prev.frx":0058
               Size            =   "7937;423"
               BorderColor     =   16512
               BorderStyle     =   1
               FontName        =   "Tahoma"
         ...
         Begin VB.Frame FraAddRework 
            ...
            Begin MSForms.Label Label6 
               ...
               Width           =   6840
               BackColor       =   11517387
               Caption         =   $"frmAuthorizeIssRcvAdv_Prev.frx":0122
               Size            =   "12065;423"
               BorderColor     =   16512
               BorderStyle     =   1
               FontName        =   "Tahoma"
            ...
            Begin MSForms.Label Label4 
               ...
               Width           =   6840
               BackColor       =   11517387
               Caption         =   $"frmAuthorizeIssRcvAdv_Prev.frx":01AD
               Size            =   "12065;423"
               BorderColor     =   16512
               BorderStyle     =   1
               FontName        =   "Tahoma"
         ...
         Begin VB.Frame FraEdit 
            ...
            Begin MSForms.Label lblmine 
               ...
               Width           =   10830
               BackColor       =   11517387
               Caption         =   $"frmAuthorizeIssRcvAdv_Prev.frx":0277
               Size            =   "19103;423"
               BorderColor     =   16512
               BorderStyle     =   1
               FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmAuthorizeIssRcvAdv_Prev"
                            ...
                            If Val(.ListSubItems(1).Tag) = Val(LVRcv.ListItems(i).key) Then
                                ...
                                If lWastageType = 3 Then
                                    ...
                                    con.Execute "INSERT INTO MakerRepair(VendID,DT,Rcvd_RefID,Qty,Rate,UserName,MachineName,VendIssdDetail_RefID,RepairAmt,Wastage_Originator,ShowInBilling,VRD_RefID_ChargeTo) VALUES(" & _
                                     ...
                                     "," & dmyRate & ",'" & CurrentUserName & "','" & strComputerName & "'," & lmyEntryID & ",0,0," & iShowInBilling & "," & lTempEntryID & ")"
