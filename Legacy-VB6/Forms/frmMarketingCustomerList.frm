...
Begin VB.Form frmMarketingCustomerList 
   ClientHeight    =   6792
   ClientLeft      =   1116
   ClientTop       =   348
   ClientWidth     =   10356
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMarketingCustomerList.frx":0000
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMarketingCustomerList.frx":01BC
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   2
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMarketingCustomerList.frx":0378
            Key             =   "Active"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMarketingCustomerList.frx":07CC
            Key             =   "Inactive"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmMarketingCustomerList"
...
Private Sub Form_Load()
    ...
    Call cmbCust.AddVals(con, "CustCode", "ForeignCustomers_Marketing", "CustCode", " Where CustCode<>'HICO'")
    cmbCust.ID = "0"
    
    cmbCustomerName.ListHeight = 3000
    cmbCustomerName.AddItem "<All Customers>", "0"
    Call cmbCustomerName.AddVals(con, "DISTINCT Name", "ForeignCustomers_Marketing", "Name", "")
    cmbCustomerName.ID = "0"
    
    cmbCountry.AddItem "<All Countries>"
    Call AddToCombo(cmbCountry, "DISTINCT Country", "ForeignCustomers_Marketing", , True)
...
If mnuInActive.Tag = "Active" Then
    ...
    'Else
        ...
        con.Execute "Update ForeignCustomers_Marketing Set Active=0 Where CustCode='" & LV.SelectedItem & "'"
    'End If
Else
    con.Execute "Update ForeignCustomers_Marketing Set Active=1 Where CustCode='" & LV.SelectedItem & "'"
End If
...
'End If
    ...
    Load frmMarketingCustomer
    frmMarketingCustomer.EditCustomer (LV.SelectedItem & LV.SelectedItem.SubItems(2))
    Call RefreshList
...
Private Sub mnuPrintList_Click()
    Call PrintMarketingCustomerList
End Sub

Public Sub PrintMarketingCustomerList()
    
    On Error GoTo err
    Screen.MousePointer = vbHourglass
    
    Dim rpt As CRAXDDRT.Report 'New rptCustList
    Set rpt = rptApp.OpenReport(RptPath & "\MarketingCustomerList.rpt") '
    If LV.Sorted Then
        Dim iSortKey As Integer, strFieldName As String
        iSortKey = LV.SortKey
        'strFieldName = "{Customers." & rpt.Database.Tables(1).Fields.GetItemByName(LV.ColumnHeaders(iSortKey).Tag) & "}"
        rpt.RecordSortFields.add rpt.Database.Tables(1).Fields.GetItemByName(LV.ColumnHeaders(iSortKey + 1).Tag), crAscendingOrder
    End If
    Dim f As New frmPrevRpt
    f.ShowReport "", rpt
...
'        End If
        ...
        .Open "Select * From ForeignCustomers_Marketing" & strCondition, con, adOpenForwardOnly, adLockReadOnly
        ...
        For i = 0 To .RecordCount - 1
            ...
            ITM.ListSubItems.add(, , ![City] & "").ForeColor = TheColor
            ITM.ListSubItems.add(, , ![Phone1] & "").ForeColor = TheColor
            ITM.ListSubItems.add(, , ![Email1] & "").ForeColor = TheColor
            .MoveNEXT
        Next
        .Close
    End With
