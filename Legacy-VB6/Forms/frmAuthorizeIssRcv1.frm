...
Begin VB.Form frmAuthorizeIssRcv1 
   ClientHeight    =   9510
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   11910
   ...
   Begin VB.Frame FAcc 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmAuthorizeIssRcv1.frx":0000
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "LVIss"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Authorize Received"
         TabPicture(1)   =   "frmAuthorizeIssRcv1.frx":001C
         ...
         TabPicture(2)   =   "frmAuthorizeIssRcv1.frx":0038
   ...
   End
End
Attribute VB_Name = "frmAuthorizeIssRcv1"
