...
Begin VB.Form frmCustomCovering 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Custom  Covering Letter"
   ClientHeight    =   6255
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7860
   ...
   EndProperty
   Icon            =   "frmCustomCovering.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame FraAdd 
         ...
         Begin MSForms.CommandButton cmdAdd 
            ...
            PicturePosition =   327683
            Size            =   "2937;635"
            Picture         =   "frmCustomCovering.frx":014A
            Accelerator     =   78
            FontName        =   "Tahoma"
            FontEffects     =   1073741825
            FontHeight      =   165
         ...
         Begin MSForms.CommandButton cmdPrint 
            ...
            PicturePosition =   327683
            Size            =   "2937;635"
            Picture         =   "frmCustomCovering.frx":025C
            Accelerator     =   80
            FontName        =   "Tahoma"
            FontEffects     =   1073741825
            FontHeight      =   165
      ...
      Begin VB.Frame FraSave 
         ...
         Begin MSForms.CommandButton cmdSave 
            ...
            PicturePosition =   327683
            Size            =   "2937;635"
            Picture         =   "frmCustomCovering.frx":036E
            Accelerator     =   83
            FontName        =   "Tahoma"
            FontEffects     =   1073741825
            FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmCustomCovering"
...
Private Sub cmbCountry_Click()
    ...
    With rs
        .Open "Select Distinct CustomInvoice,CoveringLetterL From VCustomCoveringLetter Where CustCode+Country='" & cmbCust.ID & cmbCountry.Text & "' Order By CustomInvoice", con, adOpenForwardOnly, adLockReadOnly
        cmbInvNo.Clear
        Do Until .EOF
        ...
        .Open "Select CustomInvoice From CustomInvoice Where CustomInvoice Not In (Select CustomInvoice From CustomCoveringLetter) and CustCode+Country='" & cmbCust.ID & cmbCountry.Text & "' Order By CustomInvoice", con, adOpenForwardOnly, adLockReadOnly
        cmbInvNoNew.Clear
        Do Until .EOF
...
Private Sub cmbInvNoNew_Click()
    ...
    With rs
        .Open "Select * From VrptCustomInvoiceComplete Where CustomInvoice='" & cmbInvNoNew & "'", con, adOpenForwardOnly, adLockReadOnly
          ...
          Set ITM = LV.ListItems.Add(, , "INVOICE # " & ![CustomInvoice] & "")
        ITM.SubItems(1) = "12 Copies"
        
        Set ITM = LV.ListItems.Add(, , "PACKING LIST")
        ITM.SubItems(1) = "03 Copies"
        
        Set ITM = LV.ListItems.Add(, , "VALUATION FORM (A)")
        ITM.SubItems(1) = "01 Copies"
        
        Set ITM = LV.ListItems.Add(, , "FORM (E) # " & ![FormE] & "")
        'Set ITM = LV.ListItems.Add(, , "FORM (E) " & "")
        ITM.SubItems(1) = "01 SET"
...
Private Sub cmbinvno_click()
    ...
    Dim ITM As ListItem
    With rs
        .Open "Select * From VCustomCoveringLetter Where CustomInvoice='" & cmbInvNo & "' Order By EntryID", con, adOpenForwardOnly, adLockReadOnly
...
Private Sub cmdPrint_Click()
    ...
    Dim rpt As CRAXDDRT.Report 'New rptCustomCoveringLetter
    Set rpt = rptApp.OpenReport(RptPath & "\rptCustomCoveringLetter.rpt") '
    Load frmPrevRpt
    frmPrevRpt.ShowReport "{VCustomCoveringLetter.CustomInvoice}='" & cmbInvNo.Text & "' ", rpt
...
Private Sub cmdSave_Click()
    ...
    If PInvoice <> "" Then
        con.Execute "Delete From CustomCoveringLetter Where CustomInvoice='" & PInvoice & "'"
    End If
    
    For i = 1 To LV.ListItems.Count - 1
        con.Execute "Insert Into CustomCoveringLetter(CustomInvoice,EntryText,EntryDetail) Values('" & _
