...
Begin VB.Form frmGetSingleComboValue 
   ...
   EndProperty
   Icon            =   "frmGetSingleComboValue.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3495
   ...
   End
End
Attribute VB_Name = "frmGetSingleComboValue"
...
Public Function getComboValue(ByRef strValue As String, Optional strLabelCaption As String = "Comments", Optional strFormCaption As String = "Comments") As Boolean
