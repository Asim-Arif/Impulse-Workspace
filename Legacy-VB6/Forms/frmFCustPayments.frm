...
Begin VB.Form frmFCustPayments 
   ClientHeight    =   9090
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   12225
   ...
   Begin VB.Frame FAll 
      ...
      Begin VB.ComboBox cmbStatus 
         Height          =   315
         ItemData        =   "frmFCustPayments.frx":0000
         Left            =   2430
         List            =   "frmFCustPayments.frx":0002
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Label Label1 
            ...
            Caption         =   " Customer Payment Status"
            BeginProperty Font 
      ...
      Begin MSForms.CommandButton cmdCancel 
         ...
         PicturePosition =   327683
         Size            =   "2937;635"
         Picture         =   "frmFCustPayments.frx":0004
         Accelerator     =   67
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmFCustPayments"
...
Private Sub RefreshLV()
    ...
    With cmd
        ...
        .Parameters("@CustomPayments").Value = 0
    ...
    With rs
        ...
        Do Until .EOF
            If ![EntryType] = 0 Then
                ...
                ITM.ListSubItems.add , , Val(![CommercialAmtToRcv] & "")
...
Private Sub cmdShowAllCustomers_Click()
    ...
    If Frame2.Visible = False Then
        ...
        With rs
            .Open "SELECT Curr,SUM(TotalCommercialAmtToRcv) AS TotalAmt FROM VrptCustomInvoice GROUP BY Curr", con, adOpenForwardOnly, adLockReadOnly
...
Private Sub LV_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    ElseIf Val(LV.SelectedItem.ListSubItems(8).Tag) > 0 Then
        ...
        Else
            strRet = ShowPopUpMenu1("&Refresh", "-", "&Receive Payments For This Invoice", "-", "&Print Payment Status For This Invoice", "&Print Payment Status Of All")
        End If
    Else
        strRet = ShowPopUpMenu1("&Refresh", "-", "&Print Payment Status For This Invoice", "-", "&Print Payment Status Of All")
    End If
    ...
    Select Case strRet
        ...
        Case "&Receive Payments For This Invoice"
            ...
            Load f
            Call f.ShowForm(LV.SelectedItem.Tag, LV.SelectedItem.ListSubItems(1).Tag, False)
        ...
        Case "&Print Payment Status For This Invoice"
            ...
            rpt.FormulaFields(1).Text = False
            Load frmPrevRpt
