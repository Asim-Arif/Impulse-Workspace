...
Begin VB.Form frmIssItemsSimple 
   ClientHeight    =   7560
   ClientLeft      =   1110
   ClientTop       =   60
   ClientWidth     =   11805
   ...
   Begin MSForms.Label Label2 
      ...
      Width           =   10740
      BackColor       =   11517387
      Caption         =   $"frmIssItemsSimple.frx":0000
      Size            =   "18944;423"
      BorderColor     =   16512
      BorderStyle     =   1
      FontName        =   "Tahoma"
   ...
   Begin MSForms.Label Label3 
      ...
      Width           =   10740
      BackColor       =   11517387
      Caption         =   $"frmIssItemsSimple.frx":00C3
      Size            =   "18944;423"
      BorderColor     =   16512
      BorderStyle     =   1
      FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmIssItemsSimple"
...
Private Sub cmbMaterial_matched()
    ...
    With rs
        .Open "SELECT Unit FROM Items Where ItemID='" & cmbMaterial.ID & "'", con, adOpenForwardOnly, adLockReadOnly
        txtUnit = !Unit & ""
    ...
    Dim lQty As Long
    lQty = GetSingleLongValue("SUM(NetQty)", "VItemsWithLocationWiseStock", " WHERE ItemID='" & cmbMaterial.ID & "'")
    txtUnit.Tag = lQty
    txtInHand = lQty
