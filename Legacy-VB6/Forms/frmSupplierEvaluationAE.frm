...
Begin VB.Form frmSupplierEvaluationAE 
   ...
   End
End
Attribute VB_Name = "frmSupplierEvaluationAE"
...
Public Sub EditEntry(strAccNo As String)
    Dim i As Integer
    For i = 0 To cmbSupplier.ListCount - 1
        If cmbSupplier.List(i, 1) = strAccNo Then
