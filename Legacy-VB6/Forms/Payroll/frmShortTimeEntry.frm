...
Begin VB.Form frmShortTimeEntry 
   Caption         =   "Gate Pass"
   ClientHeight    =   8685
   ClientLeft      =   60
   ClientTop       =   450
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmShortTimeEntry.frx":0000
            Key             =   "Present"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmShortTimeEntry.frx":0452
            Key             =   "Absent"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmShortTimeEntry"
    ...
    For i = 1 To LV.ListItems.count
        With LV.ListItems(i)
                ...
                If .Checked = True Then
                    ...
                    con.Execute "UPDATE EmpGPHrs SET GPHrs=" & Val(.SubItems(4)) & ",Time1='" & .SubItems(2) & "',Time2='" & .SubItems(3) & "',Remarks='" & .SubItems(5) & "' WHERE EntryID=" & Val(.Tag), iRowAffect
                    If iRowAffect = 0 Then
                        con.Execute "INSERT INTO EmpGPHrs(EmpID,DT,GPHrs,Time1,Time2,Remarks) VALUES('" & _
                         .Text & "','" & DTAttend & "'," & Val(.SubItems(4)) & ",'" & .SubItems(2) & "','" & .SubItems(3) & "','" & .SubItems(5) & "')"
                    End If
                Else
...
Private Sub FillList()
    ...
    strCond = " WHERE EmpID IN(SELECT EmpID FROM AttendanceSheet WHERE Attendance=1 AND DT='" & DTAttend.Value & "')"
...
'        Else
            .Open "SELECT EmpID,DeptID,Name,FName,Rel,StartingSalary FROM Employees " & strCond, con, adOpenForwardOnly, adLockReadOnly
'        End If
        LV.ListItems.Clear
        Do Until .EOF
        ...
        Do Until .EOF
            ...
            With LV.ListItems(!EmpId & "")
                ...
                .Tag = rsList!EntryID
                .Checked = True
                .SubItems(2) = rsList!Time1 & ""
                .SubItems(3) = rsList!Time2 & ""
                
                '.SubItems(4) = getHrsMin(Val(rsList!GPHrs & ""))
                '.ListSubItems(4).Tag = Val(rsList!GPHrs & "")
                .SubItems(4) = Val(rsList!GPHrs & "")
                .SubItems(5) = rsList!Remarks & ""
            End With
MoveNEXT:
            .MoveNEXT
        Loop
...
Private Sub LV_DblClick()
    ...
    PicEdit.Move LV.Left + LV.ColumnHeaders(3).Left + 50, LV.Top + LV.SelectedItem.Top
...
Private Sub TFrom_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 13 Then
        If TTo.Visible Then TTo.SetFocus
...
Private Sub txtRemarks_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        ...
        With LV.SelectedItem
            ...
            .SubItems(4) = Round(DateDiff("n", TFrom, TTo) / 60, 2)
            .SubItems(5) = txtRemarks
            PicEdit.Visible = False
            LV.SetFocus
        End With
