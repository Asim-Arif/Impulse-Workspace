...
Con.CursorLocation = adUseClient
    On Error Resume Next
     ...
     ConnectStr = "DSN=DSN_Payroll"
     Con.Open ConnectStr
    
          
    If ERR.Number = -2147467259 Then 'File Not Found Err#
        MsgBox "Could not Connect to the Database.", vbCritical
        Call ReOpen
        Exit Sub
    End If
...
''''''''''''''''''' PerForm Only if Accounts Are Linked '''''''''''''
   ...
   If Not AccountsLinked Then Exit Sub

    'Open Connection To Accounts
    
    If Not ConAccOpened Then
      Unload MainForm
      End
    End If
