   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTempEOBI.frx":0000
            Key             =   "Present"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTempEOBI.frx":0452
            Key             =   "Absent"
         EndProperty
      EndProperty
   End
...
Private Sub cmdSave_Click()
    ...
    con.Execute "Delete From TempOldAgeMonthly Where Month(dt)=" & Month(Dated) & " and Year(dt)=" & year(Dated) & Cond
    
    With LV
        For i = 1 To .ListItems.Count
            If .ListItems(i).Checked Then
                con.Execute "insert into TempOldAgeMonthly(EmpID,DT,EmpStatus,Salary," & _
...
Private Sub FillList()
    ...
    With rs
        .Open "Select * From  VTempOldAge Where Month(DT)=" & (cmbMonth.ListIndex + 1) & _
    ...
    With cmd
        ...
        .CommandText = "SP_TempOldAgeMonthly"
...
Private Sub mnuPrintEOBISheet_Click()
    ...
    Dim rpt As CRAXDDRT.Report
    Set rpt = rptApp.OpenReport(rptPayrollPath & "\rptTempOldAge.rpt")
    Dim f As New frmPrevRpt
    Dim SelFormula As String
