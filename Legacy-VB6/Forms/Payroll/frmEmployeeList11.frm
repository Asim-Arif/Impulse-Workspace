...
Begin VB.Form EmployeesList11 
   ...
   Begin VB.PictureBox PicEdit 
      ...
      Begin VB.ComboBox cmbCrDr 
         ...
         ForeColor       =   &H00800000&
         Height          =   315
         ItemData        =   "frmEmployeeList11.frx":0000
         Left            =   5220
         List            =   "frmEmployeeList11.frx":000A
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEmployeeList11.frx":0016
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEmployeeList11.frx":046A
            Key             =   "ORD"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEmployeeList11.frx":08C2
            Key             =   "PARIN"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEmployeeList11.frx":0D16
            Key             =   "ITMIN"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEmployeeList11.frx":116A
            Key             =   "CAT"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEmployeeList11.frx":15BE
            Key             =   "OK"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEmployeeList11.frx":1A16
            Key             =   "TYPE"
         EndProperty
      EndProperty
   End
   ...
   Begin MSForms.CommandButton cmdOpt 
      ...
      Size            =   "2725;688"
      Picture         =   "frmEmployeeList11.frx":1E6A
      Accelerator     =   79
      FontName        =   "Tahoma"
   ...
   Begin MSForms.CommandButton cmdClose 
      ...
      PicturePosition =   327683
      Size            =   "2725;688"
      Picture         =   "frmEmployeeList11.frx":21EC
      Accelerator     =   67
      FontName        =   "Tahoma"
      FontEffects     =   1073741825
      FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "EmployeesList11"
...
LV.Sorted = False
    ...
    'If Not ShowAll Then Cnd = " Where Active " Else Cnd = ""
    
    With rs
        .CursorLocation = adUseClient
        .Open "Select * From Employees ", Con, adOpenForwardOnly, adLockReadOnly
        ...
        For i = 0 To .RecordCount - 1
            ...
            Set itm = LV.ListItems.Add(, ![ItemID], ![ItemID], , IIf(![Active], "ITM", "ITMIN"))
                ...
                itm.ListSubItems.Add(, , Format(Val(![PchPrice] & ""), "#0.00"), , "Item Purchase Price").ForeColor = clr
                itm.ListSubItems.Add(, , Format(Val(![SalePrice] & ""), "#0.00"), , "Item Sale Price").ForeColor = clr
                itm.ListSubItems.Add(, , ![InHand], , "Quantity in Stock").ForeColor = clr
...
With rs
   '.CursorLocation = adUseClient
      ...
      .Open "Select * from VItemCatagories", Con, adOpenForwardOnly, adLockReadOnly
