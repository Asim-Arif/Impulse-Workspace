...
Begin VB.Form PrintSalarySummary 
   ...
   Begin VB.Image Image2 
      Height          =   435
      Left            =   2880
      Picture         =   "PrintSalarySummary.frx":0000
      Top             =   1200
      Width           =   480
   End
   Begin VB.Image Image1 
      Height          =   495
      Left            =   3480
      Picture         =   "PrintSalarySummary.frx":05EF
      Top             =   1200
      Width           =   765
   End
   Begin MSForms.CommandButton cmdClose 
      ...
      Size            =   "2514;635"
      Picture         =   "PrintSalarySummary.frx":0E40
      Accelerator     =   67
      FontName        =   "Tahoma"
      FontEffects     =   1073741825
      FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "PrintSalarySummary"
...
With cr1
   .ReportFileName = RptPRPath & "\MonthSalSumm.rpt"
   .Formulas(0) = "FromTo='From " & cmbMonth & ", " & cmbYear & " To " & cmbMonthTo & ", " & cmbYearTo & "'"
   
   .SelectionFormula = "{VSalarySummary.Dt}=date(" & Format(FromDate, "yyyy,MM,dd") & ") to Date(" & Format(ToDate, "yyyy,MM,dd") & ")"
