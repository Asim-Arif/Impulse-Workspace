...
Begin VB.Form frmEmpWorkDone 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Employee's Daily Work Done"
   ClientHeight    =   2100
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5100
   ...
   Begin MSForms.CommandButton cmdOk 
      ...
      Size            =   "3016;635"
      Picture         =   "frmEmpWorkDone.frx":0000
      Accelerator     =   83
      FontName        =   "Tahoma"
   ...
   Begin MSForms.CommandButton cmdNext 
      ...
      PicturePosition =   327683
      Size            =   "2805;635"
      Picture         =   "frmEmpWorkDone.frx":015E
      Accelerator     =   78
      FontName        =   "Tahoma"
      FontEffects     =   1073741825
      FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmEmpWorkDone"
...
Private Sub cmbdept_matched()
    ...
    If cmbDept.Text = "<All Departments>" Then
        cmbEmp.AddVals con, "Name", "Employees", "EmpID", " Where isnull(OTByQty,0)=1 and Active=1"
    Else
        cmbEmp.AddVals con, "Name", "Employees", "EmpID", "Where DeptID='" & cmbDept.ID & "' and isnull(OTByQty,0)=1 and Active=1"
    End If
...
Private Function Saved() As Boolean
    ...
    If a = 0 Then
        con.Execute "Insert Into EmpWork(EmpID,DT,QtyWorked) Values ('" & cmbEmp.ID & "','" & Format(DTPicker1, "dd-MMM-yyyy") & "'," & Val(txtOT) & ")"
    End If
