...
Begin VB.Form frmPrintMissingOutTimes 
   ...
   EndProperty
   Icon            =   "frmPrintMissingOutTimes.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2790
   ...
   End
End
Attribute VB_Name = "frmPrintMissingOutTimes"
...
Private Sub OKButton_Click()
    ...
    rpt.GroupSelectionFormula = "ISNULL({EmpTimes.OutTime})=TRUE  OR COUNT({EmpTimes.EmpID},{Employees.empid})=1"
    Dim frm As New frmPrevRpt
    Dim strSelection As String
    strSelection = "{EmpTimes.DT}=#" & DtFrom & "# TO #" & DtTo & "#"
    If strDeptID <> "0" Then
        strSelection = strSelection & " AND {Employees.DeptID}='" & strDeptID & "'"
    End If
    rpt.FormulaFields.GetItemByName("MainHeading").Text = "'" & Format(DtFrom, "dd-MMM-yyyy") & " to " & Format(DtTo, "dd-MMM-yyyy") & "'"
    
    Me.Hide
    frm.ShowReport strSelection, rpt, , , , Me
