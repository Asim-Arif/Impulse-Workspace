      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmatt.frx":0000
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmatt.frx":0454
               Key             =   "ORD"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmatt.frx":08AC
               Key             =   "PARIN"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmatt.frx":0D00
               Key             =   "ITMIN"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmatt.frx":1154
               Key             =   "CAT"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmatt.frx":15A8
               Key             =   "OK"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmatt.frx":1A00
               Key             =   "TYPE"
            EndProperty
         EndProperty
      End
...
Private Sub TakeRegularAtt()
    ...
    With rs
        ...
        .Open "Select DeptID,EmpID,JoinDate From Employees Where EmpID In('Vision-000660') Order By EmpID", con, adOpenForwardOnly, adLockReadOnly
        Do Until .EOF
            rs1.Find "DeptID='" & !DeptID & "'", , adSearchForward, 1
            If !JoinDate > #3/1/2008# Then
                'DTPicker1.value = DateSerial(2008, 3, Day(!JoinDate))
                j = Day(!JoinDate)
            Else
                j = 1
            End If
            ...
            For i = j To 28
                ...
                DTPicker1.Value = DateSerial(2008, 3, i)
                If Format(DTPicker1.Value, "ddd") = "Sun" Or i = 21 Then GoTo LeaveIT
...
Private Function Saved() As Boolean
    ...
    If Not IsNull(DtFrom) Then
        Call TakeAttendance(cmbEmp.ID, DTPicker1, Format(DtFrom, "HH:NN"))
    End If
    con.CommitTrans
    
    Call StartTrans(con)
    If Not IsNull(DtTo) Then
        Call TakeAttendance(cmbEmp.ID, DTPicker1, Format(DtTo, "HH:NN"))
    End If
    con.CommitTrans
    Call RefreshList
