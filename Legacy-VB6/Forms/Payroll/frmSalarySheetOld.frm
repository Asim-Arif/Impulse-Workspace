...
Begin VB.Form frmSalarySheetOld 
   BorderStyle     =   0  'None
   ClientHeight    =   7785
   ClientLeft      =   15
   ClientTop       =   195
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalarySheetOld.frx":0000
            Key             =   "Present"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalarySheetOld.frx":0452
            Key             =   "Absent"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmSalarySheetOld"
...
'            End If
           ...
           ' itm.SubItems(15) = IIf((Exempt), "0", Format((LateHours * (Rate / Val(!WorkingHrs & ""))), "0.00"))
            ...
            If ![DeptID] = "VDRS" Or !Designation & "" = "Security Guard" Then EOBIAmt = 0 Else EOBIAmt = 30
