...
Object = "{EA44C4CA-EE86-4744-8E3A-57DBF72764D4}#1.0#0"; "BFLexOcx.dll"
Begin VB.Form frmEmpLedger_BioMetrics_Electro 
   ...
   Begin BFLEXOCXLibCtl.BFLex BFLex1 
      Height          =   570
      Left            =   7755
      OleObjectBlob   =   "frmEmpLedger_BioMetrics_Electro.frx":0000
      TabIndex        =   20
      Top             =   540
      Visible         =   0   'False
      Width           =   570
   ...
   Begin vbalIml6.vbalImageList ilsIcons 
      ...
      _ExtentY        =   953
      Size            =   4592
      Images          =   "frmEmpLedger_BioMetrics_Electro.frx":0024
      Version         =   131072
      KeyCount        =   4
      Keys            =   "ÿÿÿ"
   End
   ...
   End
End
Attribute VB_Name = "frmEmpLedger_BioMetrics_Electro"
...
Private Sub ReadAllData_Type2(mMachineNumber As Long)
    ...
    For i = id To Glogs + id - 1
        ...
        ElseIf strCompany = "PHF" Then
            strEmpID = "PHF-" & Format(lEnrollNumber, "00000")
