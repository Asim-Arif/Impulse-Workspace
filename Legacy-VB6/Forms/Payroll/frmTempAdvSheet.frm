...
Begin VB.Form frmTempAdvSheet 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTempAdvSheet.frx":0000
            Key             =   "Present"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTempAdvSheet.frx":0452
            Key             =   "Absent"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmTempAdvSheet"
...
Private Sub cmdPrint_Click()
    ...
    Set rpt = rptApp.OpenReport(rptPayrollPath & "\rptTempAdvAppSheet.rpt")
    ...
    For Each FormulaField In FormulaFields
        ...
        ElseIf FormulaField.Name = "{@FromTo}" Then
            FormulaField.Text = "' For " & cmbMonth.Tag & "-" & cmbYear.Tag & "'"
        ElseIf FormulaField.Name = "{@MonthDays}" Then
            FormulaField.Text = lWHrs * 8 'Val(txtTotalHrs)
        End If
    Next
    Cond = ""
'    On Error Resume Next
...
'            End If
            ...
            ITM.SubItems(9) = Round(SalHrs * Rate)
...
'            End If
           ...
           ' itm.SubItems(15) = IIf((Exempt), "0", Format((LateHours * (Rate / Val(!WorkingHrs & ""))), "0.00"))
            ...
            ITM.SubItems(17) = 0 'Round(getTaxAmt((EmpSalary * 12) / 1.5) / 12, 0)
            ...
            ITM.SubItems(18) = Total - Val(ITM.SubItems(17))
            If IsNull(![Payed]) Then Payed = 0 Else Payed = ![Payed]
            ITM.SubItems(19) = Payed
            ...
            ''''''''''''''''''''''''''''''''''''''''''
                ...
                If Not IsNull(![Lunch]) Then
                    LunchDed = (TotalSalDays) * 10  'Val(![LunchAmt] & "")
                    lWHrs = TotalSalDays
                Else
                    LunchDed = 0
                End If
            ...
            If ![DeptID] = "VDRS" Then EOBIAmt = 0 Else EOBIAmt = 20
            ...
            ITM.SubItems(27) = Round((Val(ITM.SubItems(18)) - (LongLoan + LunchDed + Payed)))
            
            ITM.SubItems(28) = Round(Val(ITM.SubItems(27)) * 0.75)
...
con.Execute "Delete from PrintTempAdvAppSheet"

Dim rs As New ADODB.Recordset
With rs
    .Open "Select * from PrintTempAdvAppSheet", con, adOpenStatic, adLockOptimistic
    For i = 1 To LV.ListItems.Count
        .AddNew
        ![EmpId] = LV.ListItems(i).Text & ""
        ...
        ![MaternityLeaves] = Val(ArrLeaves(5))
        ![HrsPerDay] = Val(LV.ListItems(i).ListSubItems(3).Tag)
        ![LunchAmt] = Val(LV.ListItems(i).SubItems(25))
        .Update
    Next i
