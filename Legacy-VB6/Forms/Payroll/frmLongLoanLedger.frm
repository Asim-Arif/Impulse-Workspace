...
Begin VB.Form frmLongLoanLedger 
   ClientHeight    =   6825
   ClientLeft      =   60
   ClientTop       =   240
   ClientWidth     =   11550
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLongLoanLedger.frx":0000
            Key             =   "Present"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLongLoanLedger.frx":0452
            Key             =   "Absent"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Frame FLV 
      ...
      Begin VB.Frame fButs2 
         ...
         Begin MSForms.CommandButton cmdNewST 
            ...
            PicturePosition =   327683
            Size            =   "4762;661"
            Picture         =   "frmLongLoanLedger.frx":0564
            Accelerator     =   78
            FontName        =   "Tahoma"
            FontEffects     =   1073741825
            FontHeight      =   165
   ...
   Begin VB.Label lbl 
      ...
      Caption         =   $"frmLongLoanLedger.frx":0676
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image1 
      Height          =   375
      Left            =   10200
      Picture         =   "frmLongLoanLedger.frx":070A
      Top             =   840
      Width           =   465
   End
   ...
   End
End
Attribute VB_Name = "frmLongLoanLedger"
...
Private Sub RefreshLedger()
    ...
    SQL = "SELECT * FROM VLoanLedger WHERE EmpID='" & cmbEmp.ID & "' AND Dt BETWEEN '" & Format(DtFrom, "dd-MMM-yyyy") & "' AND '" & Format(DtTo, "dd-MMM-yyyy") & "' ORDER BY EmpID,DT ASC"
    ...
    With rsLedger
        ...
        SQL = "(SELECT ISNULL(SUM(AmtClrd),0) Balance FROM AmtCleared WHERE DT<'" & Format(DtFrom, "dd-MMM-yyyy") & "' AND EmpID='" & cmbEmp.ID & "')"
        
        Balance = Val(con.Execute("SELECT SUM(Amount)-" & SQL & "  FROM Advances WHERE EmpID='" & cmbEmp.ID & "' AND Type=1 AND Dt<'" & Format(DtFrom, "dd-MMM-yyyy") & "'").Fields(0) & "")
