...
Begin VB.Form frmOverTimeAuth 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOverTimeAuth.frx":0000
            Key             =   "Present"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOverTimeAuth.frx":0452
            Key             =   "Absent"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmOverTimeAuth"
    ...
    For i = 1 To LV.ListItems.count
        With LV.ListItems(i)
                ...
                If .Checked = True Then
                    ...
                    con.Execute "UPDATE EmpOTHrs SET OTHrs=" & Val(.SubItems(3)) & " WHERE EntryID=" & Val(.Tag), iRowAffect
                    If iRowAffect = 0 Then
                        con.Execute "INSERT INTO EmpOTHrs(EmpID,DT,OTHrs) VALUES('" & _
                         .Text & "','" & DTAttend & "'," & Val(.SubItems(3)) & ")"
                    End If
                Else
                    con.Execute "DELETE FROM EmpOTHrs WHERE EntryID=" & Val(.Tag)
                End If
...
Private Sub FillList()
    ...
    iMonthDays = Day(DateSerial(DTAttend.year, DTAttend.Month + 1, 0))
    With rsList
        ...
        Do Until .EOF
            ...
            ITM.ListSubItems.add , , Round((Val(!StartingSalary & "") / iMonthDays / 8) * 2, 4)
        ...
        .Open "SELECT EmpID,PayableHrs FROM EmpTimes WHERE DT='" & DTAttend.Value & "' ORDER BY EmpID", con, adOpenForwardOnly, adLockReadOnly
        Do Until .EOF
            'txtWorkToDo = !WorkToBeDone & ""
            On Error Resume Next
            With LV.ListItems(!EmpId & "")
                If err.Number = 35601 Then GoTo SkipIt
                .Tag = rsList!EntryID
                .Checked = True
                .SubItems(3) = Val(rsList!PayableHrs & "")
                .SubItems(4) = Val(rsList!PayableHrs & "") * Val(.SubItems(2))
            End With
SkipIt:
            .MoveNEXT
        Loop
        ...
        txtWorkToDo = ""
        .Open "SELECT * FROM EmpOTHrs WHERE DT='" & DTAttend & "' ORDER BY EmpID", con, adOpenForwardOnly, adLockReadOnly
