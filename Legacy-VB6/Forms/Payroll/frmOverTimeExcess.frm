...
Begin VB.Form frmOverTimeExcess 
   BorderStyle     =   0  'None
   ClientHeight    =   8685
   ClientLeft      =   15
   ClientTop       =   15
   ...
   Begin VB.Frame FLV 
      ...
      Begin VB.Frame FButs1 
         ...
         Begin MSForms.CommandButton cmdSave 
            ...
            PicturePosition =   327683
            Size            =   "2302;635"
            Picture         =   "frmOverTimeExcess.frx":0000
            Accelerator     =   83
            FontName        =   "Tahoma"
            FontEffects     =   1073741825
            FontHeight      =   165
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOverTimeExcess.frx":0112
            Key             =   "Present"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOverTimeExcess.frx":0564
            Key             =   "Absent"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmOverTimeExcess"
    ...
    For i = 1 To LV.ListItems.Count
        With LV.ListItems(i)
            If .Checked = True Then
                con.Execute "Insert Into EmpExcessOverTime(EmpID,DT,ExcessHrs) Values('" & .Text & "','" & DTAttend.value & "'," & Val(.SubItems(3)) & ")"
            Else
                con.Execute "Delete From EmpExcessOverTime Where EmpID='" & .Text & "' AND DT='" & DTAttend.value & "'"
            End If
        End With
    Next i
    con.CommitTrans
...
Private Sub FillList()
    ...
    With rsList
        .Open "Select VEmployees.EmpID,Name,Rel,FName,StartingSalary,Tab1.ExcessHrs From VEmployees LEFT OUTER JOIN (Select EmpID,SUM(ExcessHrs)" & _
        " As ExcessHrs From EmpExcessOverTime Where DT='" & DTAttend.value & "' Group By EmpID) Tab1 ON VEmployees.EmpID=Tab1.EmpID " & _
        "Where DeptID='" & cmbDept.ID & "' AND Active=1 And OverTimePaid=1", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
            Set ITM = LV.ListItems.add(, !EmpId, !EmpId & "")
            ITM.ListSubItems.add , , !Name & " " & !Rel & " " & !FName
            ITM.ListSubItems.add , , Round((Val(!StartingSalary & "") / iWorkingHrs) * 1.5, 4)
