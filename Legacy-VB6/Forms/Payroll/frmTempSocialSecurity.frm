...
Begin VB.Form frmTempSocialSecurity 
   BorderStyle     =   0  'None
   ClientHeight    =   7110
   ClientLeft      =   390
   ClientTop       =   5850
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTempSocialSecurity.frx":0000
            Key             =   "Present"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTempSocialSecurity.frx":0452
            Key             =   "Absent"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu mnupop 
      Caption         =   "mnupop"
      Begin VB.Menu muuPrintSSSheet 
         Caption         =   "Print Social Security Sheet"
      End
      Begin VB.Menu mnuPrintSSForm 
         Caption         =   "Print Social Securit Contribution Form"
         Visible         =   0   'False
      End
      Begin VB.Menu mnuNonSSDash 
         Caption         =   "-"
         Visible         =   0   'False
      End
      Begin VB.Menu mnuNonSSS 
         Caption         =   "Print Non Social Security Sheet"
         Visible         =   0   'False
      End
   End
End
Attribute VB_Name = "frmTempSocialSecurity"
...
Private Sub cmdPrint_Click()
    ...
    If cmdSave.Visible Then
        If MsgBox("Social Security Sheet Must Be Saved Before You Can Print " & vbNewLine & _
...
Private Sub cmdSave_Click()
    ...
    con.Execute "Delete From TempSSMonthly Where Month(dt)=" & Month(Dated) & " and Year(dt)=" & year(Dated) & Cond
     
    With LV
        For i = 1 To .ListItems.Count
            If .ListItems(i).Checked Then
                con.Execute "Insert Into TempSSMonthly(EmpID,DT,EmpStatus,Salary," & _
...
Private Sub FillList()
    ...
    With rs
        .Open "Select * From  VTempSocialSecurity Where Month(DT)=" & (cmbMonth.ListIndex + 1) & _
        " and Year(DT)=" & Val(cmbYear) & Cond, con, adOpenForwardOnly, adLockReadOnly
            ...
            For i = 0 To .RecordCount - 1
                ...
                ITM.SubItems(9) = Format(Val(![SSAmt] & ""), "0.00")
    ...
    If LV.ListItems.Count = 0 Then
        If MsgBox("Social Security for the Selected Month has not been Calculated" & _
    ...
    With rs
        If .RecordCount > 0 Then
            ...
            Do Until .EOF
                ...
                ITM.SubItems(7) = Val(![SDays] & "")
                ITM.SubItems(8) = Format(Val(![SalAmt] & ""), "0.00")
                ITM.SubItems(9) = Format(Val(![SocialAmt] & ""), "0.00")
                .MoveNext
            Loop
...
Private Sub mnuNonSSS_Click()
    
    Screen.MousePointer = vbHourglass
    
    Dim rpt As CRAXDDRT.Report
    Set rpt = rptApp.OpenReport(rptPayrollPath & "\rptNonSocialSecurity.rpt")
...
'    rpt.SQLQueryString = "Select * From VEmp Where EmpID In(Select EmpID From MonthlySalaries " & strCond & ") AND EmpID Not In(Select EmpID From SSMonthly " & strCond & ")"
    rpt.FormulaFields(2).Text = "'" & cmbMonth & " - " & cmbYear & "'"
    
    f.ShowReport "", rpt, "Select * From VEmp Where EmpID In(Select EmpID From MonthlySalaries " & strCond & ") AND EmpID Not In(Select EmpID From SSMonthly " & strCond & ")"
...
Private Sub muuPrintSSSheet_Click()
    ...
    Dim rpt As CRAXDDRT.Report
    Set rpt = rptApp.OpenReport(rptPayrollPath & "\rptTempSocialSecurity.rpt")
    Dim f As New frmPrevRpt
    Dim SelFormula As String
    SelFormula = "Month({VSocialSecurity.DT})=" & cmbMonth.List(cmbMonth.ListIndex, 1) & _
    " and Year({VSocialSecurity.DT})=" & Val(cmbYear)
