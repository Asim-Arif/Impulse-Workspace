...
Begin VB.Form frmGuarantorList 
   Caption         =   "CV List"
   ClientHeight    =   8445
   ClientLeft      =   1110
   ClientTop       =   345
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbField 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frmGuarantorList.frx":0000
         Left            =   60
         List            =   "frmGuarantorList.frx":0010
   ...
   Begin VB.Frame FraAdvSearch 
      ...
      Begin VB.ComboBox cmbCriteria 
         ...
         Height          =   390
         Index           =   3
         ItemData        =   "frmGuarantorList.frx":0032
         Left            =   5415
         List            =   "frmGuarantorList.frx":003C
         Style           =   2  'Dropdown List
         TabIndex        =   27
         Top             =   3465
         Width           =   2055
      ...
      Begin VB.ComboBox cmbCriteria 
         ...
         Height          =   390
         Index           =   2
         ItemData        =   "frmGuarantorList.frx":0049
         Left            =   5430
         List            =   "frmGuarantorList.frx":0053
         Style           =   2  'Dropdown List
         TabIndex        =   26
         Top             =   420
         Width           =   2055
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbGender 
            ...
            EndProperty
            Height          =   390
            ItemData        =   "frmGuarantorList.frx":0060
            Left            =   1080
            List            =   "frmGuarantorList.frx":006D
            TabIndex        =   24
            Text            =   "Combo1"
            Top             =   300
            Width           =   4065
      ...
      Begin VB.ComboBox cmbCriteria 
         ...
         Height          =   390
         Index           =   1
         ItemData        =   "frmGuarantorList.frx":0089
         Left            =   105
         List            =   "frmGuarantorList.frx":0093
         Style           =   2  'Dropdown List
         TabIndex        =   22
         Top             =   5160
         Width           =   2055
      ...
      Begin VB.ComboBox cmbCriteria 
         ...
         Height          =   390
         Index           =   0
         ItemData        =   "frmGuarantorList.frx":00A0
         Left            =   105
         List            =   "frmGuarantorList.frx":00AA
         Style           =   2  'Dropdown List
         TabIndex        =   15
         Top             =   1260
         Width           =   2055
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox cmbAge 
            ...
            EndProperty
            Height          =   390
            ItemData        =   "frmGuarantorList.frx":00B7
            Left            =   750
            List            =   "frmGuarantorList.frx":00C7
            Style           =   2  'Dropdown List
            TabIndex        =   11
            Top             =   300
            Width           =   2055
   ...
   End
End
Attribute VB_Name = "frmGuarantorList"
...
'        If getDBPassword("EditEmployee") Then
            Set f = New frmNewGuarantor
            Load f
            Call f.EditGuarantor(Val(LV.SelectedItem.key))
'        End If
    End If
    'Call RefreshList
...
Public Sub RefreshList(Optional strCondition As String)
    ...
    With rs
        .Open "SELECT * FROM GuarantorList_Imported " & strCondition, con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
            Set ITM = LV.ListItems.add(, ![intGuarantorId] & "'", "  • " & LV.ListItems.count + 1)
        
             ITM.ListSubItems.add(, , !strFullName).ToolTipText = !strFullName
              
             ITM.ListSubItems.add(, , ![strFatherName] & "").ToolTipText = ![strFatherName] & ""
             ITM.ListSubItems.add(, , ![strNICNo] & "").ForeColor = TheColor
             ITM.ListSubItems.add(, , ![strCast] & "").ForeColor = TheColor
             ITM.ListSubItems.add(, , ![strPhoneNo] & "").ForeColor = TheColor
             ITM.ListSubItems.add(, , ![strCellNo] & "").ForeColor = TheColor
             ITM.ListSubItems.add(, , ![strAddress] & "").ForeColor = TheColor
...
Private Sub mnuPrintList_Click()
    ...
    Dim rpt As CRAXDDRT.Report
    Set rpt = rptApp.OpenReport(rptPayrollPath & "\Guarantors.rpt")
    Dim f As New frmPrevRpt
    f.ShowReport "", rpt
