...
Begin VB.Form frmFine 
   ...
   Begin VB.ComboBox cmbType 
      Height          =   315
      ItemData        =   "frmFine.frx":0000
      Left            =   6810
      List            =   "frmFine.frx":000A
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFine.frx":001B
            Key             =   "Present"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFine.frx":0079
            Key             =   "Absent"
         EndProperty
      EndProperty
   End
   Begin MSForms.Label Label2 
      ...
      Caption         =   "  Department                         Employee :                             Date :                                        Type :"
      Size            =   "15240;423"
      BorderColor     =   16512
      BorderStyle     =   1
      FontName        =   "Tahoma"
...
Set rpt = rpt.OpenSubreport(rptPayrollPath & "\rptFineBonusPayslip.rpt")
...
For Each FormulaField In FormulaFields
    ...
    ElseIf FormulaField.Name = "{@Amount}" Then
        FormulaField.Text = Val(LV.SelectedItem.SubItems(1))
    ElseIf FormulaField.Name = "{@Fine}" Then
        FormulaField.Text = "'" & cmbType & " Slip'"
    End If
Next
...
mnuNew.Caption = "New " & cmbType
mnuUpdate.Caption = "Update This  " & cmbType
mnuDelete.Caption = "Delete This  " & cmbType
...
Private Sub FillList()
    ...
    SQL = "Select * from EmpFine Where EmpID='" & cmbEmp.ID & "' AND MONTH(FineDate)=" & _
        DT.Month & " AND YEAR(FineDate)=" & DT.year & " AND Type='" & cmbType & "'"
    theName = "Name"
    ...
    If KeyAscii = 13 Then
        ...
        Else
            con.Execute "INSERT INTO EmpFine(EmpID,FineDate,Type,Amount,Description) VALUES('" & _
                        cmbEmp.ID & "','" & DT.value & "','" & cmbType.Tag & "'," & txtAmt & ",'" & txtDesc & "')"
        End If
            Call FillList
        txtAmt = ""
        txtDesc = ""
