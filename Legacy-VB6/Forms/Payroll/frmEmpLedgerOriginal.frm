...
Begin VB.Form frmEmpLedgerOriginal 
   ClientHeight    =   8715
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   12000
   ...
   Begin vbalIml6.vbalImageList ilsIcons 
      ...
      _ExtentY        =   953
      Size            =   4592
      Images          =   "frmEmpLedgerOriginal.frx":0000
      Version         =   131072
      KeyCount        =   4
      Keys            =   "ÿÿÿ"
   End
   ...
   Begin VB.Label lbl 
      ...
      Caption         =   $"frmEmpLedgerOriginal.frx":1210
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmEmpLedgerOriginal"
...
Private Function TakeAtt(EmployeeID As String, AttDate As Date, AttTime As Date) As Boolean
    ...
    With rs
        .Open "Select DeptID,EmpID,ExemptSettings,Active From Employees Where EmployeeID=" & Val(EmployeeID), con, adOpenForwardOnly, adLockReadOnly
        If .EOF = False Then
            strEmpID = !EmpId & ""
            strDeptID = !DeptID & ""
