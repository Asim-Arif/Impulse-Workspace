...
Begin VB.Form frmIssdMaterialList 
   BorderStyle     =   0  'None
   ClientHeight    =   7695
   ClientLeft      =   15
   ClientTop       =   -90
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmIssdMaterialList.frx":0000
         Left            =   75
         List            =   "frmIssdMaterialList.frx":0016
   ...
   End
End
Attribute VB_Name = "frmIssdMaterialList"
...
'    End If
    ...
    With rs
        SQL = "Select * From IssItemsSimple " & DTRange & " Order By DT,IssNo"
        ...
        Do Until .EOF
            ...
            ITM.ListSubItems.add , , !Department
            ITM.ListSubItems.add , , !AttnPerson
            .MoveNext
        Loop
        .Close
    End With
