...
Begin VB.Form frmQMSDocuments 
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmQMSDocuments.frx":0000
         Left            =   4440
         List            =   "frmQMSDocuments.frx":0019
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00AFBDCB&
         BackStyle       =   0  'Transparent
         Caption         =   $"frmQMSDocuments.frx":0078
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSDocuments.frx":0112
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmQMSDocuments.frx":02CE
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmQMSDocuments"
...
Private Sub cmdPrintDistListNewlyUpdated_Click()
    ...
    f.ShowReport "{QMS_Documents.LastApprovedEntryDT}=#" & myDTFrom & "# TO #" & myDTTo & "#", rpt
...
Private Sub cmdPrintDistributionListSelected_Click()
    ...
    '--------------------------------------------------------------------------
    Dim f As New frmPrevRpt
    f.ShowReport "{QMS_Documents.EntryID} IN[" & strEntryIDs & "]", rpt
...
'    End If
    ...
    With rs
        ...
        .Open "SELECT * FROM VQMS_Documents " & strCondition & " ORDER BY IssueDT", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
...
Private Sub LV_DblClick()
    ...
    If LV.SelectedItem.SubItems(6) = "Attached" Then
        Call ShowTechDrawing("QMS_Documents", "AttachmentPDF", " WHERE EntryID=" & Val(LV.SelectedItem.Tag), LV.SelectedItem.Text, CD1)
    Else
...
'        Exit Sub
'    End If
    Load frmQMSDocument_AE
    frmQMSDocument_AE.AddNew
End Sub
...
Private Sub mnuChangeRequest_Click()
    ...
    Dim f As New frmQMSDocument_ChangeRequest
    Load f
...
'    End If
    ...
    Dim f As New frmQMSDocument_AE
...
Private Sub mnuViewHistory_Click()
    Dim f As New frmQMSDocument_History
    Load f
