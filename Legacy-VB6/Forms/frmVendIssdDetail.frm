...
Begin VB.Form d 
   ...
   Begin VB.Frame FLV 
      ...
      Begin MSForms.CommandButton cmdPrint 
         ...
         Size            =   "2514;635"
         Picture         =   "frmVendIssdDetail.frx":0000
         Accelerator     =   80
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
      ...
      Begin MSForms.CommandButton cmdClose 
         ...
         PicturePosition =   327683
         Size            =   "2514;635"
         Picture         =   "frmVendIssdDetail.frx":0112
         Accelerator     =   67
         FontName        =   "Tahoma"
         FontEffects     =   1073741825
         FontHeight      =   165
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssdDetail.frx":0224
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendIssdDetail.frx":03E0
            Key             =   "Up"
         EndProperty
      EndProperty
   End
...
Private Sub chkZero_Click()
    Call ShowDetail(OrderNo, ItemCode, ProcessID, False)
End Sub
...
Private Sub LV_DblClick()
    If LV.SelectedItem.Tag = "" Then Exit Sub
    Dim f As New frmVendIssdDetailS
    Call f.ShowDetail(ItemCode, ProcessID)
End Sub
...
End Sub
Public Sub ShowDetail(sOrderNo As String, sItemCode As String, lProcessID As Long, Optional ShowForm As Boolean = True)
    ...
    Sql = "Select VenderName,Process,IssQty,RcvdQty,RemQty,VendID From VFOrdItemsIssDetail Where OrderNo='" & OrderNo & "' and ItemCode='" & ItemCode & "' and ProcessID=" & ProcessID
    If Not ShowZero Then
        Sql = Sql & " and RemQty>0 "
    End If
    Sql = Sql '& " Order By EntryID"
    ...
    With rs
        ...
        Do Until .EOF
            ...
            itm.Tag = ![VendID] & ""
            itm.ListSubItems.Add(, , ![VenderName] & "").Bold = True
            itm.ListSubItems.Add(, , ![IssQty] & "").ForeColor = RGB(0, 100, 255)
            lblIssd = Val(lblIssd) + Val(![IssQty] & "")
            
            itm.ListSubItems.Add(, , ![RcvdQty] & "").ForeColor = RGB(255, 100, 0)
            lblRcvd = Val(lblRcvd) + Val(![RcvdQty] & "")
            
            itm.ListSubItems.Add(, , ![RemQty] & "").ForeColor = RGB(50, 200, 100)
            itm.ListSubItems(4).Bold = True
            lblBal = Val(lblBal) + Val(![RemQty] & "")
            
            'ITM.SubItems(5) = Format(![Dt] & "", "dd-MMM-yyyy")
            'ITM.SubItems(6) = ![RecieptID] & ""
            .MoveNext
        Loop
        .Close
    End With
