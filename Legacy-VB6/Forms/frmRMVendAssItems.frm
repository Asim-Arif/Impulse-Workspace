...
Begin VB.Form frmRMVendAssItems 
   ClientHeight    =   6570
   ClientLeft      =   1110
   ClientTop       =   60
   ClientWidth     =   10095
   ...
   Begin VB.Frame fupdate 
      ...
      Begin MSForms.CommandButton cmdCheckAll 
         ...
         Size            =   "2646;661"
         Picture         =   "frmRMVendAssItems.frx":0000
         Accelerator     =   104
         FontName        =   "Tahoma"
   ...
   Begin VB.CommandButton cmdUnAssign 
      Height          =   240
      Left            =   9585
      Picture         =   "frmRMVendAssItems.frx":015A
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRMVendAssItems.frx":025C
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRMVendAssItems.frx":0418
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   2
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRMVendAssItems.frx":05D4
            Key             =   "Active"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRMVendAssItems.frx":0A28
            Key             =   "Inactive"
         EndProperty
      EndProperty
   End
   ...
   Begin MSForms.CommandButton cmdAssign 
      ...
      PicturePosition =   327683
      Size            =   "1984;661"
      Picture         =   "frmRMVendAssItems.frx":0E7C
      Accelerator     =   65
      FontName        =   "Tahoma"
      FontEffects     =   1073741825
      FontHeight      =   165
   ...
   Begin MSForms.Label Label2 
      ...
      Width           =   8175
      BackColor       =   11517387
      Caption         =   "  Vendor                                                Raw Material                           Raw Material Name"
      Size            =   "14420;423"
      BorderColor     =   16512
      BorderStyle     =   1
      FontName        =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmRMVendAssItems"
...
Private Sub cmbCust_matched()
    ...
    cmbItem.ClearVals
    Call cmbItem.AddVals(con, "RMID1", "RM", "RMID", " Where RMID Not In(Select RMID From RMVendAssItems Where VendID=" & cmbCust.ID & ")")
    
    cmbItemName.ClearVals
    Call cmbItemName.AddVals(con, "RMName", "RM", "RMID", " Where RMID Not In(Select RMID From RMVendAssItems Where VendID=" & cmbCust.ID & ")")
    
    'cmbCust.Tag = Val(con.Execute("Select PhaseID From Venders Where VendID=" & cmbCust.ID).Fields(0).value & "")
    With rs
        .Open "Select EntryID,RMID,RMID1,RMName,VendRate,Rate,AvgRate From VRMVendAssItems Where VendID=" & cmbCust.ID, con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        Do Until .EOF
            Set itm = LV.ListItems.Add(, ![EntryID] & "'", ![RMID1])
            itm.SubItems(1) = ![RMName] & ""
            'ITM.SubItems(2) = ![Type] & ""
            'ITM.SubItems(3) = ![Description] & ""
            itm.SubItems(2) = ![VendRate] & ""
            itm.SubItems(3) = ![Rate] & ""
            itm.SubItems(4) = ![AvgRate] & ""
            .MoveNext
        Loop
        .Close
    End With
...
Private Sub cmdAssign_Click()
    ...
    With cmd
        ...
        .CommandText = "SP_RMVendAssItem"
        .Parameters("@VendID").value = cmbCust.ID
        .Parameters("@RMID").value = cmbItem.ID 'cmbNick.List(cmbNick.ListIndex, 1)
        .Execute Saved
    End With
...
Private Sub cmdCheckAll_Click()
    ...
    With cmd
        ...
        .Parameters("@RMID").value = "0" 'cmbCountry.ID
...
Private Sub cmdClearAll_Click()
    ...
    If MsgBox("Are You Sure To UnAssign All Items?", vbQuestion + vbYesNo) = vbNo Then Exit Sub
        con.Execute "Delete From RMVendAssItems Where VendID=" & cmbCust.ID, iAffect
        If iAffect > 0 Then
            Call cmbCust_matched
        End If
...
Private Sub cmdUnAssign_Click()
    ...
    con.Execute "Delete From RMVendAssItems Where EntryID=" & Val(LV.SelectedItem.Key), iAffect
    If iAffect > 0 Then
        Call cmbCust_matched
...
Private Sub txtRate_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        Dim iAffect As Integer
        con.Execute "Update RMVendAssItems Set Rate=" & Val(txtRate) & " Where EntryID=" & Val(LV.SelectedItem.Key), iAffect
        If iAffect = 1 Then
