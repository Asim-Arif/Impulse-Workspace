...
Begin VB.Form frmShippingAgents 
   ClientHeight    =   6795
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   10365
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmShippingAgents.frx":0000
            Key             =   "Down"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmShippingAgents.frx":01BC
            Key             =   "Up"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   2
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmShippingAgents.frx":0378
            Key             =   "Active"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmShippingAgents.frx":07CC
            Key             =   "Inactive"
         EndProperty
      EndProperty
   End
   ...
   Begin MSForms.CommandButton cmdClose 
      ...
      PicturePosition =   327683
      Size            =   "2752;688"
      Picture         =   "frmShippingAgents.frx":0C20
      Accelerator     =   67
      FontName        =   "Tahoma"
      FontEffects     =   1073741825
      FontHeight      =   165
   ...
   End
End
Attribute VB_Name = "frmShippingAgents"
...
Public Sub mnuAdd_Click()
   ...
   Load frmNewShippingAgent
   
   frmNewShippingAgent.Show 1
...
Private Sub mnuEdit_Click()
    ...
    Load frmNewShippingAgent
    Call frmNewShippingAgent.EditAgent(Val((LV.SelectedItem.key)))
...
Private Sub RefreshList(Optional Cond As String)
    ...
    With rs
        ...
        .Open "Select * From ShippingAgents" & ActiveCondition, con, adOpenForwardOnly, adLockReadOnly
