   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipList.frx":0000
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipList.frx":0454
            Key             =   "ORD"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipList.frx":08AC
            Key             =   "UNLOCK"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipList.frx":1636
            Key             =   "CAT1"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipList.frx":1A8A
            Key             =   "ITMIN"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipList.frx":1EDE
            Key             =   "LOCK"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipList.frx":2C68
            Key             =   "CAT"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipList.frx":30BC
            Key             =   "OK"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipList.frx":3514
            Key             =   "TYPE"
         EndProperty
      EndProperty
   End
...
Private Sub Form_Load()
    ...
    Call cmbItem.AddVals(con, "TipName", "Tips", "EntryID", " ORDER BY EntryID")
...
Private Sub MnuEditItem_Click()
    ...
    If LV.SelectedItem.Bold Then
        Load frmTipCatagoryAE
        Call frmTipCatagoryAE.EditCat(Val(LV.SelectedItem.key))
    Else
        Load frmTipAE
        Call frmTipAE.EditItem(Val(LV.SelectedItem.key))
    End If
...
'    f.Show
    ...
    With rs
        .Open "SELECT COUNT(*) FROM Tip_Master", con, adOpenForwardOnly, adLockReadOnly
        If .EOF Then
            iTotalMasters = 0
        Else
        ...
        iIndex = 0
        .Close
        .Open "SELECT * FROM VTips ORDER BY RefID", con, adOpenForwardOnly, adLockReadOnly
        LV.ListItems.Clear
        For i = 0 To .RecordCount - 1
            bAdded = False
            ...
            lColor = vbBlack
            Set ITM = LV.ListItems.add(, Val(!EntryID & "") & "'", !TipName & "")
            ITM.ListSubItems.add , , !TipDetail & ""
