...
Begin VB.Form frmProductionOrderItemList_Old 
   ClientHeight    =   9885
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   14385
   ...
   Begin VB.Frame FAcc 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbfield 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmProductionOrderItemList_Old.frx":0000
            Left            =   60
            List            =   "frmProductionOrderItemList_Old.frx":000D
      ...
      Begin VB.ComboBox cmbRange 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmProductionOrderItemList_Old.frx":0030
         Left            =   3150
         List            =   "frmProductionOrderItemList_Old.frx":0043
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   330
         Width           =   1725
      ...
      Begin VB.Label Label1 
         Appearance      =   0  'Flat
         BackColor       =   &H00AFBDCB&
         Caption         =   $"frmProductionOrderItemList_Old.frx":0088
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label Label1 
         Appearance      =   0  'Flat
         BackColor       =   &H00AFBDCB&
         Caption         =   $"frmProductionOrderItemList_Old.frx":011D
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmProductionOrderItemList_Old"
...
Private Sub PrintList(Optional bWithValue As Boolean = False, Optional bSPPlanning As Boolean = False)
...
'    End If
    ...
    con_ServerSide.Execute "INSERT INTO RunningLots_Temp(ItemCode,LotNo,OrderNo,Description,Qty,ProcessID,VendID,ReWorkLot,R2InDT,PolishingItemSNO,SNo,DT,MaxSNo) SELECT ItemCode,LotNo,OrderNo,Description,Qty,ProcessID,VendID,ReWorkLot,R2InDT,PolishingItemSNO,SNo,DT,MaxSNo FROM VRunningLots_Simple WITH (NoLock)"
