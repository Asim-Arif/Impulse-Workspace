...
Begin VB.Form frmNewCustomPListM_Original 
   ClientHeight    =   9375
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   11820
   ...
   EndProperty
   Icon            =   "frmNewCustomPListM_Original.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame FAll 
      ...
      Begin VB.CommandButton cmdAddItem 
         ...
         Height          =   555
         Left            =   11100
         Picture         =   "frmNewCustomPListM_Original.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdNextCrtn 
         ...
         Height          =   525
         Left            =   75
         Picture         =   "frmNewCustomPListM_Original.frx":0974
         TabIndex        =   28
         Top             =   1455
         UseMaskColor    =   -1  'True
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   285
         Left            =   11115
         Picture         =   "frmNewCustomPListM_Original.frx":0EA6
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   $"frmNewCustomPListM_Original.frx":13D8
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmNewCustomPListM_Original"
...
Private Sub cmbCustomInvoice_Click()
    ...
    cmbItem.ClearVals
    cmbItem.AddVals con, "'{' + ItemID + '} ' + ItemDescription", "VrptCustomInvoiceDetail", "MAX(CustomInvoiceItemsEntryID)", " WHERE CustomInvoice='" & cmbCustomInvoice.Text & "' GROUP BY ItemID,ItemDescription ORDER BY ItemID"
