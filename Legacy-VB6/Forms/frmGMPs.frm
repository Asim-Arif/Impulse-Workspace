...
Begin VB.Form frmGMPs 
   ...
   Begin VB.PictureBox PicEdit 
      ...
      Begin VB.ComboBox cmbCrDr 
         ...
         ForeColor       =   &H00800000&
         Height          =   315
         ItemData        =   "frmGMPs.frx":0000
         Left            =   5250
         List            =   "frmGMPs.frx":000A
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGMPs.frx":0016
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGMPs.frx":046A
            Key             =   "ORD"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGMPs.frx":08C2
            Key             =   "PARIN"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGMPs.frx":0D16
            Key             =   "ITMIN"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGMPs.frx":116A
            Key             =   "CAT"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGMPs.frx":15BE
            Key             =   "OK"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmGMPs.frx":1A16
            Key             =   "TYPE"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu mnupop 
      ...
      Begin VB.Menu mnuNewItem 
         Caption         =   "&Add New Steel Purchase"
      End
      ...
      Begin VB.Menu mnuEditItem 
         Caption         =   "&Edit Steel Purchase"
      End
      Begin VB.Menu dActive 
         Caption         =   "-"
      End
      Begin VB.Menu mnuEditDates 
         Caption         =   "Edit Dates"
      End
      Begin VB.Menu dashEditDates 
         Caption         =   "-"
      End
      Begin VB.Menu mnuActive 
         Caption         =   "Hide This Entry"
      End
      Begin VB.Menu dd 
         Caption         =   "-"
      End
      ...
      Begin VB.Menu mnuPrint2 
         Caption         =   "&Material Sale Invoice"
      End
      Begin VB.Menu mnuPrint3 
         Caption         =   "Steel &Chemical Composition"
      End
      Begin VB.Menu mnuPrint4 
         Caption         =   "&Request For Test Report"
      End
      Begin VB.Menu mnuPrint5 
         Caption         =   "&Analytical Test Report"
      End
   End
End
Attribute VB_Name = "frmGMPs"
...
Private Sub FillItems()
    ...
    If Not ShowAll Then Cnd = " Where Hidden<>1" Else Cnd = ""
    
    LV.ListItems.Clear
    
    With rs
        .CursorLocation = adUseClient
        .Open "Select * From VFSteelPurchOrd " & Cnd, con, adOpenForwardOnly, adLockReadOnly
        
        For i = 0 To .RecordCount - 1
            
            Set ITM = LV.ListItems.add(, ![PInvoice] & "g", ![PInvoice])
            ITM.SubItems(1) = ![CustCode] & ""
            ITM.SubItems(2) = ![Country] & ""
            ITM.SubItems(3) = ![SteelVendName] & ""
            ITM.SubItems(4) = ![TestLabName] & ""
            ITM.SubItems(5) = Val(![ExtraPer] & "")
            ...
            If ![Hidden] = 0 Then ITM.Tag = "Active" Else ITM.Tag = "Inactive"
...
Private Sub LV_DblClick()
    ...
    Load frmRequisition
    Call frmRequisition.EditOrder((LV.SelectedItem.Text))
    Exit Sub
    ...
    ElseIf LV.SelectedItem.SmallIcon = "ITM" Then
        Load frmGages
        Call frmGages.EditGage((Val(LV.SelectedItem)))
    End If
...
Private Sub mnuDel_Click()
    ...
    If MsgBox("Are You Sure To Delete This ?", vbQuestion + vbYesNo) = vbYes Then
        con.Execute "Delete From FSteelPurchaseOrder Where PInvoice='" & LV.SelectedItem.Text & "'"
    End If
    Exit Sub
err:
...
Private Sub mnuEditDates_Click()
    Dim f As New frmEditDHRDates
    Call f.EditDates(LV.SelectedItem.Text)
End Sub
...
Private Sub mnuPrint2_Click()
    ...
    Set rpt = rptApp.OpenReport(RptPath & "\rptPurchOrdForSteel1.rpt") '
    frmPrevRpt.ShowReport "{VFOrderSteelWeight.PInvoice}='" & LV.SelectedItem.Text & "' ", rpt
...
Private Sub mnuPrint3_Click()
    ...
    'rptPurchOrdForSteel.FormulaFields(2).Text = "'" & strFromTo & "'"
    Dim rpt As craxddrt.Report
    Set rpt = rptApp.OpenReport(RptPath & "\rptMaterialTest.rpt") '
    frmPrevRpt.ShowReport "{FPInvoice.PInvoice}='" & LV.SelectedItem.Text & "' ", rpt
...
Private Sub mnuPrint4_Click()
    ...
    'rptPurchOrdForSteel.FormulaFields(2).Text = "'" & strFromTo & "'"
    Dim rpt As craxddrt.Report
    Set rpt = rptApp.OpenReport(RptPath & "\rptLabTestReq.rpt") '
    frmPrevRpt.ShowReport "{VFPchOrdTest.PInvoice}='" & LV.SelectedItem.Text & "' ", rpt
...
Private Sub mnuPrint5_Click()
    ...
    'rptPurchOrdForSteel.FormulaFields(2).Text = "'" & strFromTo & "'"
    Dim rpt As craxddrt.Report
    Set rpt = rptApp.OpenReport(RptPath & "\rptMaterialTest1.rpt") '
    frmPrevRpt.ShowReport "{VFPchOrdTest.PInvoice}='" & LV.SelectedItem.Text & "' ", rpt
...
Private Sub mnuPrint_Click()
    ...
    frmPrevRpt.ShowReport "{VFSteelPurchOrd.PInvoice}='" & LV.SelectedItem.Text & "' ", rpt
...
Private Sub CheckMenu()
    ...
    If LV.ListItems.count = 0 Then
        ...
        mnuPrint2.Enabled = False
        mnuPrint3.Enabled = False
        mnuPrint4.Enabled = False
        mnuPrint5.Enabled = False

        mnuNewCat.Enabled = True
    Else
        mnuNewItem.Enabled = True
        mnuEditItem.Caption = IIf(LV.SelectedItem.SmallIcon Like "ITM*", "&Edit Steel Purchase", "&Edit Steel Purchase")
        mnuDel.Enabled = True
        ...
        If LV.SelectedItem.Tag = "Inactive" Then
            ...
            mnuActive.Caption = "&Unhide This Entry."
        Else
            mnuActive.Caption = "&Hide This Entry."
        End If
        mnuActive.Tag = LV.SelectedItem.Tag
        mnuPrint.Enabled = True
        mnuPrint4.Enabled = True
        mnuPrint2.Enabled = True
        mnuPrint3.Enabled = True
        mnuPrint5.Enabled = True
...
Private Function MakeAccountInActive() As Boolean
    ...
    With LV.SelectedItem
        ...
        'If Val(.ListSubItems(6)) > 0 Then
         ...
         'Else
            If MsgBox("Are You Sure to Hide This Entry ?", vbYesNo + vbQuestion) = vbNo Then Exit Function
        ' End If
           
           
           
           
        con.Execute "Update FSteelPurchaseOrder Set Hidden=1 Where PInvoice='" & Trim(.Text) & "'"
...
Private Function MakeAccountActive() As Boolean
    ...
    With LV.SelectedItem
        con.Execute "Update FSteelPurchaseOrder Set Hidden=0 Where PInvoice='" & Trim(.Text) & "'"
