...
{
    public class SocialSecurityRowModel
    {
    ...
    public class SocialSecurityFilterDto
    {
    ...
    public class SocialSecuritySheetModel
    {
        public int Month { get; set; }
        public int Year { get; set; }
        public string? DeptID { get; set; }
        public bool IsSaved { get; set; }
        public List<SocialSecurityRowModel> Rows { get; set; } = new();
        ...
        public decimal TotalSSAmt => Rows?.Where(r => r.IsSelected).Sum(r => r.SSAmt) ?? 0;
    }

    public class SaveSocialSecurityDto
    {
        public int Month { get; set; }
        public int Year { get; set; }
        public string? DeptID { get; set; }
